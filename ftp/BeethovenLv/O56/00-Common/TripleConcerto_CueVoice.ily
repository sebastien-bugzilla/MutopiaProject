...
cueVoiceViolinIMvtI = \relative c' {
	...
	\voiceOne a8[ r16 c,]( c'4) \oneVoice s2
	s1*2
	% bar 432 - 440
...
cueVoiceViolinIIMvtI = \relative c {
	...
	d2. e4\trill(
	fis d b a)
	gis2(-\offset X-offset -1 _\crescmarkup \once \stemUp b4.. a16)
	s1*138
	% bar 393 - 397
...
cueVoiceViolinIIMvtIII = \relative c {
	...
	s2.*13
	% bar 89 - 92
	\ottavaBracket #"8va" #'upright \tuplet 6/4 4 {e''16\startTextSpan_\crescmarkup-\tweak X-offset #-4 ^\markup {\column { \lower #1.5 "Vln." "conc"}} d c b c d e d c b c d e d c b c d
	...
	\grace {c16( d)} e4( c4. b8)
	a([ f')] b,( g'4) g8
	\voiceOne g4(\f c,8) r \oneVoice s4
	s2.*37
	% bar 282 - 285
	\ottavaBracket #"8va" #'upright \tuplet 6/4 4 {a'16_\crescmarkup-\tweak X-offset #-3.5 ^\markup {\column {\lower #1.5 "Vln." "conc"}}\startTextSpan g f e f g a g f e f g a g f e f g
	a g f e f g a g f e f g} a8 c\sf\stopTextSpan
	g,,8\f \ottavaBracket #"8va" #'upright g''4 \sf\startTextSpan e8[ c a]\stopTextSpan
	\voiceOne g'[ e c a] \oneVoice s4
	s2.*47
	% bar 333 - 336
	g'4. g16 g
	g4. g16 g
	\tuplet 3/2 4 {g8 g g g g g
	\voiceOne g g g } \oneVoice s4
	s2*69
	% bar 406 - 412
	...
	s2*22
	% bar 435 - 443
	\tuplet 3/2 4 {b,8(\p^\markup {Pf.} c cis d ees e
	f fis g gis a ais)}
	b4\trill \once \stemUp b,\trill
	b,\trill \once \stemUp b'\trill
	\stemUp g'2~-\tweak extra-offset #'(0 . -2) \startTrillSpan
	g~
	g~
	\afterGrace g\fermata^\stopTrillSpan {fis16 g} \stemNeutral
...
cueVoiceViolaMvtI = \relative c {
	...
	a'8[^\markup {Pf} r16 c,]( c'4~ c8)[ r16 c,]( c'4~
	c8)[ r16 c,]( c'4~ c8)[ r16 c,]( c'4~
	c16) c g e c g' e c \stemUp g e' c g \stemNeutral e c' g e
	s1*48
	% bar 489 - 492
...
cueVoiceViolaMvtII = \relative c {
	s4.*36
	% bar 37 - 39
	c'''8.\p-\offset X-offset -4.5 ^\markup {\column {\lower #1.5 "Vln." "conc."}} c16~ c32[ b64( c)] b([ c) b( c)]
	ees8. des16( bes! g)
	aes\trill bes\trill c8~\noBeam \tuplet 3/2 4 {c32([ a bes]} ees32. g,64)
	s4.*11
	% bar 51 - 53
	\tuplet 3/2 16 {g,,,32[(-\offset X-offset -3 ^\markup {\column {\lower #1.5 "Vlc." "conc."}} b) d] g[ b d]} \voiceOne g g g g g8\noBeam
	g32 g g g g g g g \tuplet 3/2 16 {g[ g g] g[ g g]
...
cueVoiceViolaMvtIII = \relative c {
	...
	s2.*13
	% bar 89 - 92
	\ottavaBracket #"8va" #'upright \tuplet 6/4 4 {e''16_\crescmarkup-\tweak extra-offset #'(0 . -3) ^\markup {Vln.conc}\startTextSpan d c b c d e d c b c d e d c b c d
	e d c b c d e d c b c d} e8 g\sf\stopTextSpan
	d,\f \ottavaBracket #"8va" #'upright d'4\startTextSpan b8 g e\stopTextSpan
	d'[ b g e] d8.( e32 fis)
	s2.*21
	...
	s2.*37
	% bar 282 - 285
	\ottavaBracket #"8va" #'upright \tuplet 6/4 4 {a'16_\crescmarkup-\tweak extra-offset #'(0 . -3.3) ^\markup {Vln.conc}\startTextSpan g f e f g \once \tupletUp a g f e f g a g f e f g
	a g f e f g a g f e f g} a8 c\sf\stopTextSpan
	g,,8\f \ottavaBracket #"8va" #'upright g''4\sf\startTextSpan e8[ c a] \stopTextSpan
	\voiceOne g'[ e c a] \oneVoice s4
	s2.*47
	...
	b4\trill b,\trill
	b,\trill b'\trill
	g'2~-\tweak extra-offset #'(0 . -2.5) \startTrillSpan
	g~
	g~
	\afterGrace g\fermata^\stopTrillSpan {fis16 g}
	\shape #'((0 . -0.2)(0 . -0.4)(0 . -0.4)(0 . -0.2)) Slur g4.(_\dolce a16 b c8 d)
}
%###############################################################################
...
cueVoiceBassiMvtI = \relative c {
	...
	s1*60
	% bar 264 - 267
	\tuplet 3/2 4 {a8^\markup {Vlc.conc.} gis fis \once \tupletUp fis e dis a' gis fis a gis fis
	a_\crescmarkup gis fis \once \tupletUp a gis fis a gis fis a gis fis}
	...
	e8 r r8. e16 e8 r r8. e16
	f8 r r8. f16 f8 r r8. f16
	\voiceOne e8.[ g16 g8. g16] s2
}
cueVoiceBassiMvtII = \relative c {
	s4.*36
	% bar 37 - 39
	aes''16\p(^\markup {Vlc.conc} ees8 c16 aes a)
	bes des8 g bes16
	aes\trill[ bes\trill] c8~ \tuplet 3/2 4 {\stemUp c32[ a( bes]} ees32. g,64) \stemNeutral
	s4.*11
	% bar 51 - 53
	\tuplet 3/2 16 {g,,32[(^\markup {Vlc.conc.} b) d] g[ b d]} g g g g g8\noBeam
	g32[ g g g] g[ g g g] \tupletUp \tuplet 3/2 16 {g[ g g] g[ g g]
	g[_\crescmarkup g g] g[ g g]} g64 g g g g g g g \tuplet 3/2 32 {g[ g g] g[ g g] g[ g g] g[ g g]}
}
cueVoiceBassiMvtIII = \relative c {
	...
	s2.*13
	% bar 89 - 92
	\tuplet 6/4 4 {e16_\crescmarkup^\markup {Vlc.conc} f g a g f \once \tupletUp e f g a g f e f g a g f 
	e f g a g f \once \tupletUp e f g a g f} e8 cis,\sf
	d\f d''4 b8 g e
	d[ b g e] d8.( e32 fis)
	s2.*21
	% bar 114 - 118
	g''8[^\markup {Vlc.conc} r16 e]( g8[) r16 fis]( g8[) r16 fis](
	g8)[ r16 fis]( g8)[ r16 fis]( g8)[ r16 fis](
	\tuplet 6/4 4 {g16)( fis g fis g fis) g( fis g fis g fis) g( fis g fis g fis)}
	\grace {fis16( g)} g2.\trill~
	\afterGrace g {fis16}
	...
	\grace {c16 d} e4( c4. b8)
	a([ f']) b,( g'4) g8
	\voiceOne g4(-\tweak extra-offset #'(0 . 5) \f c,8) r \oneVoice s4
	s2.*37
	% bar 282 - 285
	...
	s2*70
	% bar 406 - 412
	r4 \tuplet 3/2 4 {\voiceOne g,8\f-\offset X-offset #-5 ^\markup {Vln.conc.} a b
	c b c a b c
	d c d b c d 
	e d e c d e 
	\oneVoice f e f g f g
	a g a b a b
	c b c d c d }
	s2*22
	% bar 435 - 443
	...
	\tuplet 3/2 4 {g,8\p( aes a bes b c
	cis d ees e f) f}
	f2~-\tweak extra-offset #'(-0.5 . -0.8) \startTrillSpan
	\afterGrace f\fermata {e16 f^\stopTrillSpan}
	g4.(_\dolce a16 b c8 d)
}
