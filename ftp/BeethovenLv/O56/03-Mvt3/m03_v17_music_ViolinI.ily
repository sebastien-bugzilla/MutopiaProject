...
% Bars 6 to 10
	...
	\once \stemUp b8_\semprepp r fis r r4
...
% Bars 26 to 30
	...
	\mmrPos #-4 R \mark #4 \no
% Bars 31 to 35
	r4 <g d' b' f'>\ff-\offset X-offset -1.3 ^\arco^\fermata r
	\ni \voiceTwo R2.
	R \no \oneVoice 
	g'8-.(\pp g-. g-. g-. g-. g-.)
	g\cresc g g g g g
% Bars 36 to 40
	...
	a( f') b,(\noBeam g'4) g8
% Bars 41 to 45
	g4(\sf c,8) r <g, g' d' b'>-\offset X-offset #0.5 \sf r
	<g' e' c'>\ff c r e r a,
	r c r f, r a
	r d, r f' b,16 c d e 
...
% Bars 141 to 145
	...
	r <b d> <a d>
	<b d> r r
	\ni \voiceTwo \mmrPos #-6 \tweak extra-offset #'(-2 . 0) R2.
% Bars 146 to 150
	\mmrPos #-7 \tweak extra-offset #'(-2 . 0) R
	\mmrPos #-7 \tweak extra-offset #'(-2 . 0) R
	R \oneVoice \no \mark \default
	\grace {s8.} r4 <g d' b' f'>-\tweak X-offset #-3.2 \ff\fermata-\offset X-offset -1.3 ^\arco r
	\ni \voiceTwo R2.
% Bars 151 to 155
	R \oneVoice \no
	g'8(-.\pp g-. g-. g-. g-. g-.)
...
% Bars 171 to 175
	...
	e8^\pizz r r4 r
	<g, g'>8 r r4 q8 r
	q r r4 r8 \tuplet 3/2 8 {g'16(\f-\offset X-offset #-3 ^\arco a b)}
	c8 r r4 r
% Bars 176 to 180
	g8^\pizz\p r r4 r
	<g b>8 r r4 <g a>8 r
...
% Bars 191 to 195
	...
	<b, e>8\p^\pizz r r4 r
	<c e>8 r r4 <c d>8 r
	<c e>8 r r4 r8 \tuplet 3/2 8 {e16(\f-\offset X-offset -1.5 ^\arco fis gis)}
	a8 r r4 r
% Bars 196 to 200
	<a, g'!>8\p^\pizz r r4 r
	<a f'>8 r r4 <a g'>8 r
...
% Bars 241 to 245
	...
	R
	R \no \oneVoice 
	\voiceTwo r4 r \oneVoice \acciaccatura fis'8 g\ff^\tutti \acciaccatura fis g
	g4.( a16 b c8 d)
% Bars 246 to 250
	e4( c4.\sf b8)
...
% Bars 281 to 285
	...
	R
	R \no 
	r4 r r8 \oneVoice f'-\offset X-offset -1.5 ^\arco \mark \default
% Bars 286 to 290
...
% Bars 331 to 335
	f r r4 r
	<<{\oneVoice r4 r r8 \breathSign \breathe \voiceTwo  r} \\ {\ni \fermataCentered \no} \\ {\InCueContext s2 s8 g'16 g \OutCueContext}>> \bar "||"
	\time 2/4 \ni \voiceTwo R2
	R
	R \no
% Bars 336 to 340
	r4 r8 f,-\offset X-offset #-5 _\arco-\offset X-offset 0.5 _\semprepp \oneVoice 
	e e r g
	g g r g
	a a r a
	g g r f
...
% Bars 436 to 440
	...
	R \no \oneVoice \mark \default
% Bars 441 to 445
	<g, f'>8-\offset X-offset 0.5 ^\pizz r r4
	\ni \mmrPos #-4 R2_\fermata \bar "||"
	\time 3/4 \mmrPos #-4 R2. \no
	<g e' e'>8\f^\arco r <g e' c'> r r4
	\ni \mmrPos #-4 R2. \no
% Bars 446 to 450
	<g d' b' b'>8-\tweak extra-offset #'(0.5 . 0.8) \f r <g d' b' g'> r r4
	\ni \mmrPos #-4 R2. \no
