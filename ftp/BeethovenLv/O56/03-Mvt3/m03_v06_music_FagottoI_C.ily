...
% Bars 241 to 245
	...
	g4.( a16 b c8 d)
% Bars 246 to 250
	e4( c4.-\tweak extra-offset #'(-1.5 . -3.5) \sf b8)
	a( f'~ f) f16( e) e( d) d( c)
	c( b) b( a) a( g) fis( g) fis( g) fis( g)
	g4.( a16 b c8 d)
	\grace {c16[( d]} e4) c4.(-\tweak X-offset #-1 \sf b8)
% Bars 251 to 255
	a( f') b,(\noBeam g'4) g8
...
% Bars 376 to 380
	...
	r8 bes4-\tweak X-offset #0.8 \pp bes8
	r a4 a8
	r a4 a8
	r b!4 b8
% Bars 381 to 385
...
% Bars 411 to 415
	...
	\mark \default
	c2-\tweak X-offset #0.5 \fp~
	c~
	c~
% Bars 416 to 420
	c
	b~-\tweak X-offset #0.5 \fp
	b~
	b~
	b
% Bars 421 to 425
