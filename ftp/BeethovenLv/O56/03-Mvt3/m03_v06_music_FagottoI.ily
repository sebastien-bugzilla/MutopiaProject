...
% Bars 11 to 15
	...
	\mmrPos #-6 R
% Bars 16 to 20
	<< \mmrPos #-6 R {s2 s4^\tutti} >> \no \oneVoice \clef bass
...
% Bars 76 to 80
	...
	\ni << \mmrPos #-4 R2. {s8 \clef treble s8 s2} >>
	\mmrPos #-7 R2. \no \clef bass
	g8\pp-. d-. g-. d-. g-. d-. 
% Bars 81 to 85
	a' d, a' d, a' d, 
...
% Bars 241 to 245
	...
	\mmrPos #-4 R
	\mmrPos #-4 R \no
	r2 \clef bass \acciaccatura fis,8 g\ff^\tutti \acciaccatura fis g
	g4.( a16 b c8 d)
% Bars 246 to 250
	e4( c4.\sf b8)
	a( f'~ f) f16( e) e( d) d( c)
...
% Bars 271 to 275
	\ni << \mmrPos #-6 R2. {s8 \clef tenor s s2} >>
	\mmrPos #-4 R2. \clef bass \no
	c8\pp-. g-. c-. g-. c-. g-. 
	d'-. g,-. d'-. g,-. d'-. g,-. 
	d'-. g,-. b-. g-. b-. g-. 
% Bars 276 to 280
