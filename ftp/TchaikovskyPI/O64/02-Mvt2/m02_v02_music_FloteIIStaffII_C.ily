...
%###############################################################################
musicFloteIIStaffIIMvtII = \relative c {
	\clef treble
	\key b \minor
%	\transposition a
% Bars 1 to 5
...
%% Bars 51 to 55
	\mark \default % eis8)\! r r r4 r8 \tuplet 2/3 4. {gis(\mf ais b d)} \mark \default
...
%	b4.)\ff\> d,4( g8) fis2.\!(
%	g8) r r r4 r8 r2.
	r4 r8 \omitAdue d'4.\p\< d\> a'\!
	a\< d, d\> a'\!
% Bars 61 to 65
	a8\p a a   a a a  a r r r4 r8
	b b b  b b b  b r r r4 r8 \changeStaffName \flIII
	R1.*3
...
% Bars 76 to 80
	...
	R1
	R1 % dis'4.\mf\< e8( gis\! fis)\> e8-- dis--\!
	R1*3
	
% Bars 81 to 85
	
	R1 \mark \default % f4.\mf\< ges8( bes\! aes) ges--\> f--\! \mark \default
	R1*2
...
%	b4. b4 b8 b4. gis8-- a-- b-- 
	\mark \default % b4. b4 b8 b b4 b b8~ \mark \default
	R1.*13
%	b8 b4 b b8~ b b4 b b8~
%	b b4 b b8~ b b4 b b8~
...
%	fis,4.\fff( g4) g8 g4.( gis4) gis8
	\mark #11 % \tuplet 2/3 4. {gis8( a) a a a( ais) ais ais} \mark #11
% Bars 151 to 155
	R1.*5
