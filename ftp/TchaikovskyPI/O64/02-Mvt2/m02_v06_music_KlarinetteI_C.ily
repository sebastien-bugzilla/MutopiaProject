...
% Bars 56 to 60
	\dynEO #'(0 . 1) d\fff d d   f, f aes  bes\> bes bes   bes bes bes\!
...
% Bars 76 to 80
	...
	\partCombineApart r2 e8_\mf e4 e8(
	b)[ b(_\<] dis e)\! \once \partCombineAutomatic r fis,(\noBeam a) a \partCombineAutomatic
	R1
	\partCombineApart e'8_\mf e4 e8( dis) dis4 dis8~
% Bars 81 to 85
...
% Bars 116 to 120
	\timeSignature 4/4 \scaleDurations 3/2 {
		bes16(-\offset X-offset -3 \mf a bes g) g'4~ g16(\< a bes b c4~
	...
	\timeSignature 4/4 \scaleDurations 3/2 {
		d,16-\tweak X-offset -3 \mf( e) fis--\< g-- a-- bes-- b-- c--\! c( bes a c bes8) r16 d,-\tweak X-offset -3.5 \mf(
% Bars 121 to 125
...
% Bars 126 to 130
		r16 b(-\tweak extra-offset #'(-4 . 1) _\mfcresc c b) r c( d c) r d( e d) r e( f e)
		r f(\f g f) r f( g f) r f( d e) \tuplet 3/2 4 {f8(_\fcantabile e) d--}
	}
	\timeSignature 12/8 f4.(-> e2.) \beamOffset #'(-0.5 . -0.7) c8(\< d) e--\!
	g4.(\> f2.)\< f8-- g-- a--\!
...
% Bars 146 to 150
		a-\tweak X-offset -3.5 \ff a a a   a a a a  g g g g  a a bes bes
		f f d d   d d f f  e_\crescmarkup e e e   e e e e
...
% Bars 161 to 165
	...
	d4.( f8) aes4.( d8)
	d,4. f8 d4 f8( aes)
	\tuplet 3/2 4 {des8-\tweak X-offset -2 \fff des des   des des des} des->[ des->] des-> des->
	f,-> f-> r4 r f\mf(
% Bars 166 to 170
	ees-> des) r des(\p
	c-> bes) r f(\pp\<
...
% Bars 176 to 180
	...
	\stemUp c \partCombineAutomatic r r r4 r8 bes,2.-\tweak X-offset -3 \pp(
	c8) r r r4 r8 bes2.(
	c8) r r r4 r8 r2.
	R1.*2
% Bars 181 to 184
	...
	\timeSignature 4/4 \scaleDurations 3/2 {
		r4 r8 f,(-\tweak X-offset -2 \ppp\< a[ c f a])\!
	}
