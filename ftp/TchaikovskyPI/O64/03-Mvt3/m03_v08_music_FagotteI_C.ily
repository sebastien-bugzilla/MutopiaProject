...
%###############################################################################
musicFagotteIMvtIII = \relative c {
	\clef bass
	\key a \major
%	\transposition a
...
% Bars 61 to 65
	b gis'4 a,) fis'8(~
	fis g,4 e' fis,8~
	fis) \partCombineApart \once \stemDown d'4( f, \once \stemDown cis'8~
	cis b e,) b'(_\pcresc d cis) \partCombineAutomatic
	ais4.-> b8( d cis)
% Bars 66 to 70
	ais4.-> b8( d cis)
	ais4.-> b8( cis d)
...
% Bars 91 to 95
	...
	b8) r cis4->~ cis8 r
	R2.
	r4 e,->( e'8) r \mark \default
% Bars 96 to 100
	R2.*2
	
	r4 r \clef tenor fisis16\p( gis fisis gis
	a gis dis cis bis8) r r4 \clef bass
	fisis16(\mf gis fisis gis a gis e dis cis8) r
% Bars 101 to 105
	R2.
	r4 r \clef tenor fisis'16(\p gis fisis gis 
	a gis dis cis bis8) r r4 \clef bass \mark \default
	fisis16(\mf gis fisis gis a gis e cis) cis4->\mf(
	b8) r r4 r
% Bars 106 to 110
	r4 r cis->\mf(
	b8) r r4 r
	r r ais->(\mf
	gis8) r r4 \clef tenor fisis''\mf->(
	gis8)[ gis,-.] \clef bass gis-. dis-. \partCombineApart ais4->(
% Bars 111 to 115
