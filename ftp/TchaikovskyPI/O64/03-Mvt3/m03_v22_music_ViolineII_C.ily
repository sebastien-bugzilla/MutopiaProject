...
% Bars 6 to 10
	...
	r b r
	r <b d> r
	r ais8(->-\offset X-offset -3 \p^\arco b cis d)
	R2.*2
% Bars 11 to 15
	\mark \default
	...
	fis4( e2)
	fis4.\< gis8( a fis)\!
	\hairpinShorten #'(0.8 . 0) \after 2.*5/6 \! b2.\>
% Bars 16 to 20
	dis,4.\p\< e8( fis gis)\!
	b4(\> a2\!)
...
% Bars 36 to 40
	R2. \mark \default
	r4 a,(-\offset X-offset -2 \p^\arco e'8) r
	r4 a,( e'8) r
	r4 b( fis'8) r
	r4 b,( e8) r
% Bars 41 to 45
...
% Bars 56 to 60
	...
	gis,8\mf-\offset X-offset -6 ^\pizz r r4 r
% Bars 61 to 65
	r a r
	ais r b
	r b r
...
% Bars 71 to 75
	fis' b, e
	<a, e' a> <a e' cis' a'>-\offset X-offset -3 \ff r
	cis\p(^\arco d2~
	d4) r r
	R2.*2
% Bars 76 to 80
...
% Bars 96 to 100
	r4 r bis,(\pp
	cis8) r r4 <<{
		cis'8(-\offset X-offset -4 ^\div e)
		fis4->~ fis8 r r4
		r gis,->-\offset X-offset -2 ^\pp~ gis8 \oneVoice r
	} \\ {
		cis,8(-\offset X-offset -2.5 \pp e
...
% Bars 116 to 120
	...
	R2.
	r8 e,\mf a e' r e,
	a e' <<{a-\offset X-offset -4 ^\div[ e']} \\ {a,[ e]}>> r4
% Bars 121 to 125
	r8 e, a e' r e,
	<<{a[ e' a e']} \\ {a,,[ e' a e]}>> r4
...
% Bars 131 to 135
	...
	<a fis'>4---\offset X-offset -1.5 \mf a2~
% Bars 136 to 140
	a r4
	R2.*2
	
	<a fis'>4---\offset X-offset -2 \mf a2~
	a r4
% Bars 141 to 145
	R2. \mark \default
	<gis e'>8\f-\offset X-offset -6 ^\pizz r r4 r
	R2.*2
	
	r4 cis4-.^\arco(-\offset X-offset -2 \p cis-.)
% Bars 146 to 150
	cis-.( cis-. cis-.)
	dis(-. a-. a8-.) r
	e'4-.( e-. e-.)
...
% Bars 151 to 155
	...
	cis'4._\dolce b8( a gis)
	fis4( e2)
	fis4.-\tweak rotation #'(-3 1 0) \< gis8( a fis)\!
% Bars 156 to 160
	\hairpinShorten #'(1 . 0) \after 2.*5/6 \! b2.\>
	dis,4.\p\< e8( fis gis)\!
	b4(\> a2)\!
	cis,4.\p dis8( fis gis
	e) r r4 r
...
% Bars 201 to 205
	gis,8\mf-\offset X-offset -7 ^\pizz r r4 r
	r a r
	ais r b
	r b r
	d gis, r
% Bars 206 to 210
	...
	gis8-\offset X-offset 1 \f r r4 r
	r a r
% Bars 211 to 215
	ais e' b
	fis' b, e
...
% Bars 216 to 220
	cis4.\< d8( cis e)
	\after 2.*5/6 \! d2.
	dis4.-\offset X-offset -1.5 \mf\< e8( dis fis \mark \default
	e-.)\! r f2\f~
	f4 <g, g'>-- c--
% Bars 221 to 225
...
% Bars 261 to 265
	...
	cis4 b-> cis
	b-> cis b->
	cis <b' f'>-\offset X-offset 0.5 \ff <cis e>
	<b f'> <cis e> <b f'>
% Bar 266
