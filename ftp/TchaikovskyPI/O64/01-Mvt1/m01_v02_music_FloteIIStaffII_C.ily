...
% Bars 71 to 75
	...
	b( cis d e eis fis fis,8) \partCombineApart g( gis
	a) \partCombineAutomatic d16(\f e fis g a8) r r
	r fis,16(\mp g a b c8) r r
% Bars 76 to 80
	r4 d16(\ff cis c b a gis g fis)
...
%% Bars 291 to 295
%	a'4 d,8 a'4 d,8
	\mark \default % r a16( bes b cis d8) r r
	R2.*20
...
%	fis4.\ff\> e8( dis cis\!
%% Bars 396 to 400
	\mark \default % gis') r r r4 r8 \mark \default
	R2.*30
% Bars 401 to 405
...
%	r r e(~_\menof e dis cis)
	\mark \default % r r cisis\mp(~ cisis dis4) \mark \default
	R2.*5
...
%	b'4 e,8 b'4 e,8
%	r4 r8 r r b~\ff
	\mark \default % b4. e\< \mark \default
	R2.*12
%	b'4\fff e,8 b'4 e,8
%	b'4 e,8 b'4 e,8
%% Bars 461 to 465
...
%	gis4 b,8 gis'4 b,8
%	e4 gis,8 e'4 gis,8
	\mark \default % b4 e,8 b'4 e,8 \mark \default
% Bars 471 to 475
	R2.*14
% Bars 476 to 480
