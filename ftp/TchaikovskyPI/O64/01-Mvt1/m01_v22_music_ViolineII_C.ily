...
% Bars 61 to 65
	...
	a(\> g) fis\!( e4) c8(\<
	g'8[)\!-. r16 g g8]~ g8[\> r16 fis fis8]\!~
	fis8[ r16 e e8] r g(-.-\offset X-offset -1 \mf gis-.) \mark \default
% Bars 66 to 70
	a4.->~ a8 c,4\mf\>~
	c8 <c d>4~ q8\p r r
	g8[-\offset X-offset 1 \f-. r16 g' g8]~ g a(\< b\!
...
% Bars 71 to 75
	...
	c8 <c d>4~ q8\p r r
% Bars 76 to 80
	g8[-.-\offset X-offset 1.5 \f r16 g' g8]~ g a(\< b\!
	c\ff\> b a\! g)\f g(\mf-. gis)-. 
	a4.->~ a8 c,4\mf~
	c8\> <c d>4~ q8\p r r
	b'8[-.\f r16 b b8]~ b cis(\< d\!
...
% Bars 116 to 120
	fis4.\sfp\<~ \markEO #'(0 . 0.5) fis4_\moltoespr gis8(-\offset X-offset -1 ^\mfmarkup
	g!4.) fis4( ais8)\!
	b4.\f\> cis,\!
	\after 2.*5/6 \! cis2.\p\<
...
% Bars 121 to 125
	...
	\after 2.*5/6 \! <ais fis'>2.-\offset X-offset 0.5 \mp\<
% Bars 126 to 130
	<b fis'>4.\sff\>~ q4 <b g'>8\!
	\after 2.*5/6 \! <ais fis'>2.-\offset X-offset 1 \mp\<
	<a'! d>\ff
	<bes d>
	<a d>4. <bes d>
% Bars 131 to 135
...
% Bars 141 to 145
	...
	R2.
	r4 r8 a\pp d a'
	r4 r8 <cis,, e>4.-\offset X-offset 1 \pp^\arco
	r4 r8 <b d>4.
% Bars 146 to 150
	r4 r8 cis4.
	r4 r8 b4.
...
% Bars 151 to 155
	<e b'>\p
	r4 r8 <e a e'>\ff-\offset X-offset -6 ^\pizz r r
	r cis e a cis e
	<d, d'> r r r4 r8
	R2.
% Bars 156 to 160
...
% Bars 166 to 170
	...
	r8 a(\mf\< gis) g( a e)
	d'( d, d') \dynEO #'(-0.5 . 0.5) d(\sff-\tweak extra-offset #'(0 . 0.5) \> gis, g)\!
...
% Bars 181 to 185
	...
	r^\div <fis fis'>4-\offset X-offset 0.5 _\pcresc <e e'>4( <d d'>8)
...
% Bars 196 to 200
	...
	<a, a'>4\fff d8 q4 d8
	q4 d8 q4 d8
	r fis,8:16-\offset X-offset -2 _\fcresc g: a: b: cis: 
% Bars 201 to 205
...
% Bars 261 to 265
	...
	<f f'>16(-\offset X-offset -1 ^\div <g g'> <aes aes'> <bes bes'> <b b'>8) r <<{b16( cis d e
...
% Bars 271 to 275
	aes4.(\> ges)
	f ees4( d8)\!
	bes4.-\offset X-offset -1.5 \mf~ bes4\< c8(
	d4.) ees4( f8)\!
	aes4.(\> ges)
% Bars 276 to 280
	f ees4( d8
...
% Bars 291 to 296
	...
	r4 r8 <<{a'16( b! cis d e f) \mark \default
		...
		a,16( b! cis d e f)
		<g, g'>4-\offset X-offset 1 \ff q8 bes16( cis d e f g)
...
% Bars 371 to 375
	d: cis: b: dis: cis: bis: 
	e: dis: cis: gis8 r r
	gis,4.\sfp\<~ \markEO #'(0 . 3.2) gis4_\moltoespr ais8(-\offset X-offset -1.3 ^\mfmarkup
	a!4.) gis4( bis8)\!
	cis4.\f\> <dis, a'>\!
% Bars 376 to 380
	\after 2.*5/6 \! dis2.\p\<
	...
	\after 2.*5/6 \! bis2.\mp\<
% Bars 381 to 385
	<cis gis'>4.-\offset X-offset -1.3 \sff\>~ q4 <fis a>8\!
	\after 2.*5/6 \! <dis bis'>2.\mp\<
	<cis gis'>4.-\offset X-offset -1.5 \sff\>~ q4 <fis a>8\!
	\after 2.*5/6 \! <dis bis'>2.\mp\<
	<b'! e>\ff
% Bars 386 to 390
	<c! e>
...
% Bars 396 to 400
	...
	r8 b,\pp e gis r r
% Bars 401 to 405
	r4 r8 <fis dis'>4.-\offset X-offset -7 ^\arco\ppp
	r4 r8 <cis gis'>4.
	r4 r8 <dis b'>4.
	r4 r8 <cis a'>4.
	R2.
% Bars 406 to 410
	...
	R2.
	q\p
	r4 r8 <fis fis'>8-\offset X-offset 1 \ff-\offset X-offset -6 ^\pizz r r
	r dis fis b dis fis
% Bars 411 to 415
	<b, e> r r r4 r8
	R2.
	r8 \markEO #'(-6 . -1.5) b(\mf\<^\arco ais) a( b fis)
	e'( e, e')\! e(-\offset X-offset -1 \sff\> ais, b)\!
	R2.*2
% Bars 416 to 420
...
% Bars 441 to 445
	...
	r gis4\f fis e8~
	e e4 fis( gis8)
	r <fis fis'>4_\pcrescmolto-\offset X-offset -4 ^\div <gis gis'> <a a'>8~
% Bars 446 to 450
	q q4 <ais ais'> <b b'>8~
...
% Bars 456 to 460
	b'4 e,8 b'4 e,8
	r gis,8:16-\offset X-offset -1 _\fcresc a: b: cis: dis: 
