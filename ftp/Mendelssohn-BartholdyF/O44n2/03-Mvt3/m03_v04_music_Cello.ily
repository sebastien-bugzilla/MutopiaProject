...
% mesures 1 à 5
	...
	g2 b4\< g\!
% mesures 6 à 10
	d2(-\offset X-offset #-1.5 \f g4) r
	<cis e>1\p
	d2 gis,\<
	a4\! a( b c!)
	d2.-\offset X-offset #0.4 _\dimmarkup r4
% mesures 11 à 15
	R1*1
	gis,2( c4._\crescmarkup gis8)
	a2. a4
	b4\f g c,2^\dimmarkup
	<cis' e>1\p
% mesures 16 à 20
	d2 gis,
...
% mesures 26 à 30
	...
	cis,( d b g) a4. a8
	a b(-> a) gis-. r gis(^>-\offset X-offset #0.5 _\crescmarkup a) b-.
	r b\< b b b4\f e
% mesures 31 à 35
	r8 cis,16(\p a' d, a' e a fis) a( g a fis a fis d'
	g,) d'(-\offset X-offset #-0.5 _\crescmarkup a d b d a a') g4(\f fis)_\dimmarkup
	e( dis) e( g,)
	a1~\p
...
% mesures 36 à 40
	d,1~
	d4 g a8-. a-.( a-. a-.)
	d2.\f \hairpinShorten #'(-1 . -1) d8-.(\< d-.)\!
	e8.\>([ fis16) b8(-. g-.)]\! a-. a-.(_\dimmarkup a-. a-.)
	d,4\p r cis r
% mesures 41 à 45
	\once \stemUp d r a r
	c!-\offset X-offset #-1.5 _\crescmarkup( b a g)
	\once \stemUp d'( c b a)
	f'(\f e) d( c)
	c' r r2
% mesures 46 à 50
	...
	e2 a4( c,)
	b( d\< g4. b8)\!
	d4(\sf c) b2-\offset X-offset #-2 _\dimmarkup
% mesures 51 à 55
	a2\p a4 a
	a2( << b) {\hairpinShorten #'(-1 . -1) s8\< s s s\!} >>
	c4( a) g( fis)
	g2.-\offset X-offset #-1.5 \sf r4\fermata \clef bass
	c,,!2\p b4_\crescmarkup a
% mesures 56 à 60
	\dynEO #'(-1 . -9) fis4^\f~ fis8 r r2
	g'1\p~
	g4 c, d2
...
% mesures 61 à 65
	...
	r e( fis) g-. \dynEO #'(-1 . -9) e^\f d cis4
	\dynEO #'(-1 . -1.5) c!8(^\p fis,) g16( d' a d b) d( b g' c, g' d g
	e)_\crescmarkup g( f g e g d g) c,4(\f b)
	a( gis) a(_\dimmarkup c)
% mesures 66 à 70
	d2 g,4 r \mark \default
	r g'8-.(\p g-.) a8.([ b16) e,8(-. cis-.)]
	d d-.( d-. d-.) g r \dynEO #'(-1 . 2) g'(-.\f g-.)
	fis8.->([ e16) d8-.( d-.)] d cis(-.\> d-. e-.)\!
	r cis(-.\p d-. e-.) c(-. b-. a-. dis,-.)
% mesures 71 à 75
	e4 r \hairpinShorten #'(0 . 1.3) cis,2\<~
	\hairpinShorten #'(-1.3 . 0) cis\> \dynEO #'(0 . 1) d\p
	g4 r \hairpinShorten #'(-0.5 . -0.5) cis2\<~
	\hairpinShorten #'(-0.5 . -0.5) cis\> d\p
	g,1~_\crescmarkup
% mesures 76 à 80
	g
	c,2\f d_\dimmarkup
