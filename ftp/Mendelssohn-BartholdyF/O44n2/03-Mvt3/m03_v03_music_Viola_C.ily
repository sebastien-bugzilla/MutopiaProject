...
% mesures 31 à 35
	a2.\p~ a8 d
	d4.-\offset X-offset #0.5 _\crescmarkup a8 cis4(\f a)_\dimmarkup
	g( fis) b( e,)
	fis1\p
...
% mesures 46 à 50
	...
	d2. r4
	g2 b4\< g\!
	d4.-\offset X-offset #-1 \f( dis8) e( fis_\dimmarkup g e)
% mesures 51 à 55
	cis1\p
	d2 << gis {s8\< s s s\!} >>
	a4 c,! d d
	cis2.\sf r4\fermata
	<e g>2.\p-\offset X-offset #14 _\crescmarkup <e g>4
% mesures 56 à 60
	<c' d>\f r r a'\p~
...
% mesures 66 à 70
	...
	g4. g8 g8.([ fis16) e8(-. a,-.)]
	b[ b-.( c-. fis,-.)] g r \dynEO #'(-0.5 . 1) g'\f(-. g-.)
	g2~ g8 g(-.\> g-. g-.)\!
