...
% mesures 66 à 70
		...
		cis2 r4 a
		c!2 r
		r4 g16( a b_\crescmarkup g d' c b a) g( a b g
...
% mesures 86 à 90
		...
		a,4.(\p a8-.) d2~
% mesures 91 à 95
		d8 b( g a b g d \acciaccatura fis16 e8
...
% mesures 96 à 100
	...
	\alternative {
		{
			g( d b c d b g a)
			b2( \acciaccatura d16 c4.\espressivo b8)
			b1~
			b2 r4 b(\p
% mesures 101 à 105
			e g b e)
...
% mesures 251 à 255
	...
	dis( e) fis( g)
	gis( a) ais( e')
	e2\f dis-+ \mark \default
	e8 r e,16( fis g e b' a g fis) e( fis g e
% mesures 256 à 260
...
% mesures 271 à 275
	...
	e g c e
	g2) r4 b,,(
	e8 g_\crescmarkup cis e) fis4 r8 b,,8(
	e gis b e) e4 r8 b,8(
% mesures 276 à 280
	fis' a c e) dis4 b(
	e\< g b e)
