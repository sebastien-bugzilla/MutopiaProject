...
musicViolaIIMvtIV = \relative c' {
	...
	\key f \minor
	\repeat volta 2 {
		\partial 2 \dynEO #'(0 . 1) f8\f f f f
% mesures 1 à 5
		g4 c,8 g'8 g g
		e( f) f-. ees4 des8
		c4 g'8 g g g
...
% mesures 61 à 65
		d,2.~
		d8 r r r4 r8
		\hairpinShorten #'(0 . 1.3) e4.(\< << f) {\hairpinShorten #'(-1.3 . 0) s8\> s s\!} >>
		e8\! r r r4 r8
		\hairpinShorten #'(0 . 1.3) e4.(\< << f) {\hairpinShorten #'(-1.3 . 0) s8\> s s\!}>>
% mesures 66 à 70
		<< e2.\( ( {s8\< s s s\> s s\!} >>
		\hairpinShorten #'(0 . 1.3) f4.\<) << e\) {\hairpinShorten #'(-1.3 . 0) s8\> s s\!} >>
		f4.( a)
		g4( f8 e4 c8)
		d4.( a')
% mesures 71 à 75
...
% mesures 81 à 85
	...
	R2.
% mesures 86 à 88
	r4 c'8-\offset X-offset 1 \p\< c( b) b-.
	b( bes) bes-. bes(\! a!) a-.
