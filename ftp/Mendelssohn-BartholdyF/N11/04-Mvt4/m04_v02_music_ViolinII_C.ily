...
% mesures 61 à 65
		...
		bes2.~
		bes8 r r r4 r8
		\shape #'((0 . -1.5)(0 . -0.8)(0 . -0.8)(0 . 0)) PhrasingSlur bes2.~\(
% mesures 66 à 70
		<< bes2.( {\hairpinShorten #'(0.5 . 0) s8\< s s s\> s s\!} >>
		\hairpinShorten #'(0 . 1.3) a4.)\< << \once \stemUp bes\) {\hairpinShorten #'(-1.3 . 0) s8\> s s\!} >> 
		a4.( c)
		bes4( a8 g4 e8)
		f4.( c)
% mesures 71 à 75
