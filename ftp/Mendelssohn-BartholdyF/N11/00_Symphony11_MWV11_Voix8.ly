%Fichier : /media/Documents/Partitions/lilypond/15-MendelssohnSymphony11/00_Symphony11_MWV11_Voix8.ly
...
\book{
	...
	\score {
		{
			\new RhythmicStaff << \globalMvtUn \MvtUnVoixHuit >>
		}
		\header {
			breakbefore = ##t
			piece = \markup {
	...
	\score {
		{
			\new RhythmicStaff << \globalMvtDeux \MvtDeuxVoixHuit >>
		}
		\header {
%			breakbefore = ##t
			piece = \markup {
	...
	\score {
		{
			\new RhythmicStaff << \globalMvtTrois \MvtTroisVoixHuit >>
		}
		\header {
%			breakbefore = ##t
			piece = \markup {
	...
	\score {
		{
			\new RhythmicStaff << \globalMvtQuatre \MvtQuatreVoixHuit >>
		}
		\header {
%			breakbefore = ##t
			piece = \markup {
	...
	\score {
		{
			\new RhythmicStaff << \globalMvtCinq \MvtCinqVoixHuit >>
		}
		\header {
%			breakbefore = ##t
			piece = \markup {
