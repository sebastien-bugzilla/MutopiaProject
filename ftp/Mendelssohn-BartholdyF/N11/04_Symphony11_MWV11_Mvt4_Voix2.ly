%Fichier : /media/Documents/Partitions/lilypond/15-MendelssohnSymphony11/04_Symphony11_MWV11_Mvt4_Voix2.ly
...
% mesures 46 à 50
	...
	\repeat volta 2 { \key f \major \tempo "Trio"
	    r8 r4 r8
	    a'4.(\p bes)
	    a4. r4 r8
	    R2.
...
% mesures 86 à 88
	aes( g) r r4 r8
	R2.
	r4 \bar "||" \key f \minor \once \override Score.RehearsalMark.self-alignment-X = #RIGHT \mark "Menuetto da capo"
}
