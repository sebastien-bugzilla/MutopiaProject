%Fichier : /media/Documents/Partitions/lilypond/16-SchubertSymph8/00_SchubertSymphonie8_03_Clarinetti_A.ly
...
\book{
	...
	\score {
		\new Staff << 
		    ...
		    \new Voice {
		        ...
		        \nameClarinettiI \MvtUnClarinettiAI
		    }
		>>
		\header {
			breakbefore = ##t
	...
	\score {
		\new Staff << 
		    ...
		    \new Voice {
		        ...
		        \nameClarinettiI \MvtDeuxClarinettiAI 
		    }
		>>
		\header {
			breakbefore = ##f
	...
	\score {
		\new Staff << 
		    ...
		    \new Voice {
		        \globalMvtUn \commonOptions \commonPartOptions 
		        \nameClarinettiII \MvtUnClarinettiAII
		    }
		>>
		\header {
			breakbefore = ##t
	...
	\score {
		\new Staff << 
		    ...
		    \new Voice {
		        \globalMvtDeux \commonOptions \commonPartOptions 
		        \nameClarinettiII \MvtDeuxClarinettiAII 
		    }
		>>
		\header {
			breakbefore = ##f
