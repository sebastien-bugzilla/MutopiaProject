%Fichier : /media/Documents/Partitions/lilypond/16-SchubertSymph8/00_SchubertSymphonie8_01_Flauti3.ly
	...
	\score {
		\new Staff << 
		    ...
		    \new Voice {
		        ...
		        \nameVioloncelloV \MvtUnVioloncello
		    }
		>>
		\header {
			breakbefore = ##t
	...
	\score {
		\new Staff << 
		    ...
		    \new Voice {
		        ...
		        \nameVioloncelloV \MvtDeuxVioloncello
		    }
		>>
		\header {
			breakbefore = ##f
