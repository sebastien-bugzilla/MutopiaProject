%Fichier : /media/Documents/Partitions/lilypond/10-Quatuor_14/02_DvorakQuatuor_14_Mvt2_Voix3.ly
...
% mesure 6 à 10
	    ...
	    <f, aes> r <e g>
	    <f aes>\! r <e g>
	    <c aes'>2->\ff \set doubleSlurs = ##t <c aes'>4(->
	    <c aes'>) \set doubleSlurs = ##f <c bes'>4.(-> <c aes'>8)-. 
% mesure 11 à 15
	    <e g>2.->(
	    f2) r4 \mark \default
	}
...
% mesure 46 à 50
	...
	aes-. f-. aes-.
% mesure 51 à 55
	<ees aes>2\ff\< \set doubleSlurs = ##t <ees aes>4(
	<ees aes>) <ees aes>4. <ees aes>8
	<ees g>2.(\f
	<ees aes>2) r4 \set doubleSlurs = ##f \mark \default
	ges'4\f-. f-. ges-.
% mesure 56 à 60
	f-. ges-. f-.
	ges-.\> f-. ges-.
...
% mesure 71 à 75
	...
	des,8( f) r4 f,8( des')
	r4 f,8( bes) r4
	<ees, aes>2\f \set doubleSlurs = ##t <ees aes>4(
% mesure 76 à 80
	<ees aes>) <ees aes>4. <ees aes>8 \set doubleSlurs = ##f
	<ees g>2.(
...
% mesure 101 à 105
	c\f\< c c c c c\!
	<c c'>_\crescmarkup <c c'> <c c'> <c c'> <c c'> <c c'> 
...
% mesure 106 à 110
	f) g-. aes-.
	f r r
	f'2\ff\>\fermata r4\!\fermata \mark \default \break 
	\repeat volta 2 { 
	    des4-.(\pp des2--
	    des4 des2--
% mesure 111 à 115
...
% mesure 206 à 210
	...
	<g! a>2.
% mesure 211 à 215
	aes!4 \times 2/3 {des,,8 des des} \times 2/3 {des des des}
	\times 2/3 {<des beses'> <des beses'> <des beses'>} \times 2/3 {<des beses'> <des beses'> <des beses'>} \times 2/3 {<des beses'> <des beses'> <des beses'>} 
	<des aes'>8 r r4 r
	<e g!>2._\pdimin~
	<e g>2.~
% mesure 216 à 220
...
% mesure 231 à 235
	...
	<f aes>4\pp^\intempo r r
	<a fis'>^\pizz r r
	<gis eis'> r r
% mesure 236 à 240
	<a fis'> r r
	<g! e'!>_\pocoapococrescmarkup r r
	<a fis'> r r
	<a fis'>\< r r
	<b g'!> r\! r
% mesure 241 à 245
...
% mesure 296 à 300
	<ees aes>) <ees aes>4. <ees aes>8
	<ees g>2.(\f
	<ees aes>2) r4 \set doubleSlurs = ##f
	ges'4\f-. f-. ges-.
	f-. ges-. f-.
% mesure 301 à 305
	ges-.\> f-. ges-.
