...
% mesure 16 à 20
	...
	bes,!2(\pp a4 g)
	fis(-> g a8 bes c bes)
	\hairpinShorten #'(0 . -4.5) bes4(\< g) c,( g)\!
	fis->\fz( g\> a8 bes c bes)\!
% mesure 21 à 25
	a4_\ppocoapococresc~( a16 g a bes) c8( a f' c)
	d4.(\< c16 bes)\! g4.\mf( g8--)
	a4\<(~ a16 g a bes) c8( f a f)\!
	f4\<( \beamOffset #'(-0.3 . -0.3) e8 d f-\tweak extra-offset #'(0 . 2.5) _\crescmarkup e) \shape #'((0 . -0.5)(0 . -0.3)(0 . -0.3)(0 . 0)) Slur c'8.( bes16)\!
...
% mesure 26 à 30
	...
	c'1_\tranquillo
	<<{c} \\ {\hairpinShorten #'(0 . -2) s4\< s\! s\> s8 s\!}>>
% mesure 31 à 35
	c1\pp
	\hairpinShorten #'(0 . -5) e4(\< dis)\! e4.(\> c8)\!
	f4(\pp e d! c)
	\hairpinShorten #'(0 . -8) g2(\< bes)\!
...
% mesure 51 à 55
	...
	<< aes1 {s4\pp\< s s s8 s\!} >>
	<< des,1 {s4\f\> s s s8 s\!} >>
	<< aes'1 {s4\pp\< s s s8 s\!} >>
% mesure 56 à 60
	<< <des, aes'>1 {s4\f\> s s s8 s\!} >>
	aes'4(\< aes') ges2\!
	f1
...
% mesure 61 à 65
	...
	\tupletDown c'8_\pocoapocodim c c c8 c c c8 c c c8 c c } \tupletNeutral 
	c4( bes a\> bes)
% mesure 66 à 70
	c( bes a bes)\!
	c1\p\>_(
	<< { \voiceTwo c,\!-\offset X-offset #2.5 _\dimmarkup) } \new Voice {\voiceOne r2 bes'4( g)\pp} >> \oneVoice
	f8^\pizz[ c'] a'[ f] f,[ f'] c'[ a]
	e, e' c e e, e' c e
% mesure 71 à 75
	<c, g'>[ e'] bes'[ g] bes[ e,] c g16 c,
	c'8 g c, e'16 c f,8\noBeam c''16 <f, a> q q q q
	\beamOffset #'(-0.3 . 1) q8\< f, \beamOffset #'(-0.3 . 1) <f' a> f,16 f \beamOffset #'(-0.3 . 1) <f' a>8 f,16 e\! d a' <d a'> <d a'>
	d8 <g, f'>16 <g f'> \beamOffset #'(-0.3 . 0.3) g'8 g,16 b d g, g g g' g, g' g,
	a8 a' \tuplet 3/2 {c a e} a,_\dimmarkup[ d] dis[ dis]
% mesure 76 à 80
	e\p[ e] e[ e,] a\noBeam a'16 a a,8 r \mark \default
	bes'!4^\arco\pp( a g2)
	fis4->(\> g)\! a8( bes c bes)
	bes4( \hairpinShorten #'(0 . -5) g\<) c,( g)\!
