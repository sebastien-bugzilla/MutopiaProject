%Fichier : /media/Documents/Partitions/lilypond/10-Quatuor_14/02_DvorakQuatuor_14_Mvt2_Voix1.ly
...
% mesure 71 à 75
	...
	ges2 f4~
	f ees des8 bes
	<ees, ees'>2\f <ees ees'>4~
% mesure 76 à 80
	<ees ees'> <ees ees'>2
	<ees ees'>2.~
	<ees ees'>8 c'(\< aes c ees aes) \bar "||" \mark \default
	c8(\f f) r f f,4->~
	f g-. aes-.
% mesure 81 à 85
	g8( c) r c c,4->~
...
% mesure 106 à 110
	f g-. aes-.
	f r r
	f,2\ff\fermata\> r4\fermata^\fine\! \mark \default \break 
	\repeat volta 2 {
	    aes2_\ppdolce( aes4--~
	    aes bes c)
% mesure 111 à 115
...
% mesure 231 à 235
	...
	des)(-+
% mesure 236 à 240
	cis)-+-\tweak #'X-offset #'3  ^\markup {\natural}
	cis(_\pocoapococrescmarkup-+-\tweak #'X-offset #'3 ^\markup {\natural}
	d)-+-\tweak #'X-offset #'3 ^\markup {\natural}
	dis(\<-+-\tweak #'X-offset #'3 ^\markup {\natural}
	e)-+~
% mesure 241 à 245
	e4\! r r
	g8(\mf c) r c-.\< c,4
