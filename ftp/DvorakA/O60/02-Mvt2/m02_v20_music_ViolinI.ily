...
% Bars 31 to 35
	f8 r r4
	f,8->\ff d->_\pesante bes16-. c-. d-. ees-.
	f8-> fis-> g-> d->
	\slashedGrace bes,8 \once \stemUp <g' d'>4-> <g, d' bes' g'>->\arpeggio \bar "||" \mark \default
	<d' a' fis'>->\arpeggio r
% Bars 36 to 40
	R2
...
% Bars 81 to 85
	f'2)~
	f8( bes, c4
	bes8) bes16(\< a) a( g) g( e)\!
	g(\f f) bes4\fz d,8(
	f bes,_\dimmarkup d a
% Bars 86 to 90
	bes)\p r r4
	R2*2
	\mark \default
...
% Bars 91 to 95
	...
	<d, bes' f'>8\fz r r \hairpinShorten #'(-0.5 . -0.5) f'(-\offset X-offset -1 \p\<
% Bars 96 to 100
	bes16\f f bes8) r \hairpinShorten #'(-0.5 . -0.5) f(-\offset X-offset -1 \p\<
...
% Bars 166 to 170
	...
	\mark \default
	\ni \voiceTwo R2 \no
	r8 \oneVoice \shape #'((0 . 0)(0 . 0.5)(0 . 0.5)(0 . 0)) Slur d,(\p\< ees e\!
% Bars 171 to 175
	f)\f r r4
	r8 d(\p\< ees e\!
	f)\f r r4
...
% Bars 176 to 180
	...
	<d,, d' d'>8-\offset X-offset 0.5 \ff-. r g''-^-. r
	e-^-. r r4
	R2*10
% Bars 181 to 185
