...
% Bars 46 to 50
	...
	r16 ees(\p d-\tweak rotation #'(-5 1 0) \> ces aes f ees\! aes,)
	ees8 r r4
	r16 ees''(\pp d ces aes f ees aes,)
% Bars 51 to 55
	ees8\noBeam ees'\p\< ees ees\!
	\hairpinShorten #'(-0.3 . -0.3) cis2\f\>
	d4\p d
	d\> ees8 ees
	d\pp r r4
% Bars 56 to 60
...
% Bars 81 to 85
	...
	r8 \hairpinShorten #'(-0.3 . -0.3) c4.\mf\<
	f,8\f[ f'] f,[ f']
