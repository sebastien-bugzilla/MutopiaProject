...
% Bars 46 to 50
		...
		d,4-\offset X-offset #4.5 _\ffgrandiosoD r r
		r r a-.
% Bars 51 to 55
		fis2-^ r4
		r r a-.
...
% Bars 91 to 95
		...
		e2( dis8 cis)
		b4 r r
		\tuplet 3/2 4 {e,,8(-\offset X-offset -2 \f\< fis e)} e'2->\!
% Bars 96 to 100
		...
		d4 r r
% Bars 101 to 105
		\tuplet 3/2 4 {\tupletYOff #2 d8(-\offset X-offset -2 \fz e\< d} d'4)\! e,8-. eis-.
		fis-. r r4 r
		fis8-.\f r r4 r
...
% Bars 106 to 110
		...
		R2. \mark \default
		\break fis'4-\offset X-offset -1.5 ^\div(-\offset X-offset 4 _\pespressD cis'\< e\!)
		d4.( cis8\< b4)
		a4( g'8)\! r g4-.\>
% Bars 111 to 115
		fis2( e8 d)\!
...
% Bars 151 to 155
		b,4-. a'8( fis) g-. a-.
		a,4-. r a'-^-\tweak X-offset #-1.5 _\ffmarc
		a-^ fis8-^ g-^ a4-^
		r r a-^
		a8( fis) g-. a-. dis,4-^
% Bars 156 to 160
		...
		fis8( d!) e-. fis-. b,4-^~
		b g'8( e) fis-. g-. 
		g,2-\tweak X-offset #-2 _\crescmarkup fis4->
		fis'-> fis-> fis->
% Bars 161 to 165
...
% Bars 181 to 185
			...
			a,8(-\offset X-offset -2 \pp fis g a~ a4) 
			R2.
			r4 r a8(\pp d 
			e4 a,8 e' g4
% Bars 186 to 190
...
% Bars 311 to 315
	...
	e'2-^ a,4-.
	g'!-! e-! cis-! 
	<<{a8:16 g: e: cis: a: a':} \\ {a8-! g-! e-! cis-! a-! a'-!}>> \mark \default
	d,4-. r a(\pp
% Bars 316 to 320
	d2) r4
	r r a(
...
% Bars 366 to 370
	...
	r a^\arco-. a-.
	a r r
	\shape #'((0 . 0)(0 . 0)(0 . -0.5)(0 . -1)) Slur g'2.(\pp
	d
% Bars 371 to 375
	bes
	f)
...
% Bars 391 to 395
	...
	f4 r r
	\tuplet 3/2 4 {\tupletYOff #3 f8(-\offset X-offset -1 \fz\< g f} f'4)\! g,8-. gis-.
	a-. r r4 r
% Bars 396 to 400
...
% Bars 476 to 480
	...
	R2.
% Bars 481 to 485
	d4.->-\offset X-offset #0.5 \ff bes8-. cis!-. d-.
	d4.-> bes8-. cis!-. d-.
	d-. bes-. cis-. d-. g,-. a-. 
	bes e, fis g cis, d
	d2.:16
