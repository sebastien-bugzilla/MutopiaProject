...
% Bars 396 to 400
	...
	R2. \mark \default
% Bars 401 to 405
	\clef tenor <<{a'4( e' g)} \\ {a,-\tweak X-offset #0.8 _\pespress e' e}>>
	<d f>4.( <a e'>8\< <f d'>4)
	c'( <g' bes>8)\! r <g bes> r
	<f a>2(\> <c g'>8 <a f'!>)\!
...
% Bars 406 to 415
	...
	<e cis'!>( <f d'> <g e'>)
	<<{
		\shape #'((0 . 0)(0 . -0.5)(0 . -0.5)(0 . 0)) Slur f'4.( ees8 d4)
		\shape #'((0 . -0.5)(0 . -1)(0 . -1)(0 . -0.5)) Slur c( d c
		b d cis!
		d)
	} \\ {
		gis,2.\<~
...
% Bars 496 to 500
	...
	b-! cis-! d-! b-! cis-! d-! 
	R2.
	r4 d-\tweak X-offset #-1 _\ffpesante->-. cis->-.
	b->-. g->-. e->-. 
% Bars 501 to 505
	d->-. b'->-. a->-. 
