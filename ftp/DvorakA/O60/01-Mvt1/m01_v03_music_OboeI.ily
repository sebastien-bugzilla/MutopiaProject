...
% Bars 246 to 250
	...
	<< ais,2.( {\hairpinShorten #'(-0.5 . -1) s8\p\< s s s s \hairpinShorten #'(1 . 0) s\>}>> 
% Bars 251 to 255
	\once \stemUp b4)\! r r
	c8(\p b) r4 r
	a8( g) r4 r
...
% Bars 256 to 260
	...
	<< bis2.( {\hairpinShorten #'(-0.3 . -0.8) s8-\tweak X-offset #-2 \pp\< s s s s \hairpinShorten #'(0.8 . 0) s\>} >>
% Bars 261 to 265
	cis4)\! r r
	d8(\p cis) r4 r 
	b8( a) r4 r
	cis2.(\< \rehearsalESH #'(0 . 0) \mark \default
	b4)\f r r
% Bars 266 to 270
	R2.*4
...
% Bars 391 to 395
	...
	e,-.) r r4 r
% Bars 396 to 400
	cis!8-._\dimmarkup r r4 r
	a8-.\p r r4  r
	R2.*2
	
	e'4\pp r a, \mark \default
% Bars 401 to 405
	R2.
	f4(\p\< a d)
	c2.~\!
