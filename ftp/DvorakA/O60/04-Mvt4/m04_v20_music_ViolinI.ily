...
% Bars 16 to 20
	...
	cis4 r r2
% Bars 21 to 25
	e,8\mf\<-! e'-! dis-! cis-! b-! cis-! a-! b-!\!
	gis4 r r2
	b8\f\<-! b'-! a-! gis-! fis-! gis-! e-! fis-!\!
	d4 r r2
	a'8\ff g fis g a f d a'
% Bars 26 to 30
	g f e f g e cis! g'
	fis! e d e f d b f'
	e4 c8-. d-. ees2->
...
% Bars 71 to 75
	...
	fis4\p-. c-. fis2->
% Bars 76 to 80
	gis4 gis8(\< a b\! a\> gis g)\!
	\acciaccatura fis8 b1\p~
	b~_\dimmarkup
	b~
	b4 r r2
% Bars 81 to 85
	...
	\acciaccatura e,8 e'4\fp \tuplet 3/2 4 {e8(_\crescmarkup d cis-.)} cis4-> \tuplet 3/2 4 {cis8( b a-.)}
% Bars 86 to 90
	a4 r r2
	\acciaccatura e8 e'4\fz \tuplet 3/2 4 {e8( d cis-.)} cis4-> \tuplet 3/2 4 {cis8( b a-.)}
	a4 r r2
	\acciaccatura a8 a'4\f \tuplet 3/2 4 {a8( g) fis-. e( d) cis-. cis( b) a-.
	g( fis) e-. e( d) cis-. cis( b) a-. g( fis) e-.}
% Bars 91 to 95
	\acciaccatura a8 a'2->\ff \acciaccatura a,8 a'2->
...
% Bars 101 to 105
	\acciaccatura e8 e'4\fp \tuplet 3/2 4 {e8(_\crescmarkup d cis-.)} cis4-> \tuplet 3/2 4 {cis8( b a-.)}
	a4 r r2
	\acciaccatura e8 e'4\fz \tuplet 3/2 4 {e8( d cis-.)} cis4-> \tuplet 3/2 4 {cis8( b a-.)}
	a4 r r2
	\acciaccatura a8 a'4\f \tuplet 3/2 4 {a8( g) fis-. e( d) cis-. cis( b) a-.
...
% Bars 136 to 140
	r g-. fis-. d-.
	e-. r <e,, b' gis'>-. r
	e''4-> \tuplet 3/2 4 {e8( d cis)} d4-> \tuplet 3/2 4 {d8( cis b)}
	a4-. e-. a2->
	b4-. e,-. b'2->
% Bars 141 to 145
	cis4-. e,-. cis'2->
...
% Bars 221 to 225
	q2. r4
	R1
	r2 r4 \tuplet 3/2 4 {<g, g'>8( <a a'> <b b'>}
	<c c'>2.) \tuplet 3/2 4 {c'8( d e}
	f2.) \tuplet 3/2 4 {f,8( g a}
% Bars 226 to 230
...
% Bars 271 to 275
	R1
	r2 r4 r8 d'\f
	b a gis e <e, b' gis'>4\arpeggio r
	r2 r4 r8 e''\f
	cis b a e <e, cis' a'>4\arpeggio r
% Bars 276 to 280
	r2 r4 r8 cis''\f
	ais gis fis cis fis2->\ff
	gis-> ais->
	<b, b'>-> <b b'>->
	q-> q4..-> b'16
% Bars 281 to 285
	...
	fis-> gis->
	a-> a4..-> c16
	a8-. g-. f-. c-. f4-. \tuplet 3/2 4 {c'8-. c-. c-.
	c c c  c c c  c c c  c c c
% Bars 286 to 290
	c\< c c  cis cis cis d d d dis dis dis\!}
	e4 r <a, a'>2:16\ff
	\startMeasureCount \tremoloPosition #1 q1:
	\tremoloPosition #1 q:
	\tremoloPosition #1 q:
% Bars 291 to 295
	\tremoloPosition #1 q:
	\tremoloPosition #1 q:
	\tremoloPosition #1 q: \stopMeasureCount
	f'2->_\ffpesante e->
	d-> a->
% Bars 296 to 300
	d2.-> d4
...
% Bars 301 to 305
	c2 d
	\slashedGrace f,,8 <c' a'>1
	<e, c' g'>2-> <d a' f'>-> \mark \default
	\slashedGrace <a e'>8 <cis'! e>1\ff\>~
	q~
% Bars 306 to 310
	q4\p r r2
	R1
	r4 r8 e(\pp cis b a e
	g4) r8 b( e,4) r8 fis(
	b,4) r r2
% Bars 311 to 315
	R1*3
...
% Bars 321 to 325
	...
	d4( cis8 b e4 a,
	b gis a b)
	c( \stemDown b8 a \stemNeutral d4 e8 fis
% Bars 326 to 330
	d1~
	d4) r r2
	R1*2
...
% Bars 336 to 340
	g8(\< g' fis e d e c d)\!
	b4 r r2
	d,8->\mf\< d' cis! b a b g a\!
	fis4 r r2
	a8->\f a' gis fis e fis d e
% Bars 341 to 345
	cis1\fp
	d\fp
	e\fp(
...
% Bars 371 to 375
	a4-. e-. a2->
	b4-. f-. b2->
	cis4 cis8(\< d e\! d\> cis c)\!
	\acciaccatura b8 e1\p~
	e~
% Bars 376 to 380
	e~
	e4 r r2
...
% Bars 426 to 430
	...
	e: f:
	f: fis:
	\tremoloPosition #2 gis1:\ff
% Bars 431 to 435
	\tremoloPosition #2 gis:
	a,4: a': g!2:
	g8: e: cis: a: g: e: e':-> cis:
	a: g: e: cis: cis':-> a: g: e:
	cis: a: g':-> e: cis: a: g: e:
% Bars 436 to 440
	cis: a: a':-> g: e: cis: a: a':->
...
% Bars 466 to 470
	g a g a b c b c
	d e d e fis g fis e
	dis e dis e fis g fis e
	fis g fis g a b a gis
	a b a gis a b a gis
% Bars 471 to 475
