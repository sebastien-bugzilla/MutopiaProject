...
% Bars 1 to 5
	...
	fis( e fis g8 a)
% Bars 6 to 10
	b4( \once \stemUp d2 cis4)
	\once \stemUp d( cis8 b cis4 b)
	a( fis d e)
	a1~
	a
% Bars 11 to 15
...
% Bars 16 to 20
	...
	cis4. cis8 cis4( b)
	\beamOffset #'(0.5 . 0) a8( a' gis fis e fis d e)
	cis4. cis8 cis4( b)
...
% Bars 81 to 85
	...
	R1
% Bars 86 to 90
	e'4\fp \tuplet 3/2 4 {e8(_\crescmarkup d cis-.)} cis4-> \tuplet 3/2 4 {cis8( b a-.)}
	a4 r r2
...
% Bars 201 to 205
	...
	e4) b-. e2\fz~ 
% Bars 206 to 210
	e8 r r4 r \tuplet 3/2 4 {g,,8(-\offset X-offset -1.5 \f\< a b)\!}
	c4-.\ff g-. c2->
...
% Bars 341 to 345
	...
	d\fp
	e\fp(
	fis4-.-\offset X-offset -1.5 \f) ais,2.->~
	ais4 cis->( d e
% Bars 346 to 350
	d) gis,2.->~
	gis4 b(-> c \once \stemUp d 
	c) fis,2.->~
	fis4 f2.->(
	e4) r e''-.\f d-.
% Bars 351 to 355
...
% Bars 411 to 415
	...
	\hairpinShorten #'(-0.3 . -1) fis,2\mf\< a\!~
...
% Bars 446 to 450
	...
	b r r dis
% Bars 451 to 455
	e r r e\f-\offset X-offset -1 ^\arco
	a2-> cis,->
	fis,-> gis->
	a-> d->
	cis-> e->
