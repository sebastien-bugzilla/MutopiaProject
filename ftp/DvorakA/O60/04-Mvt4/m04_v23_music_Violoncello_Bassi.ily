...
% Bars 241 to 245
	...
	f4.-> f8 f4 ees
	f\p r r2
	bes,4---\tweak X-offset #-2 \pp d,8 f bes4-- bes8 d
% Bars 246 to 250
	f4-- d8 bes f4-- d8 f
...
% Bars 256 to 260
	r2-\tweak extra-offset #'(4.5 . 1.5) \f r4 f''-.
	d-. c-. bes-. r
	r2 r4 a-.
	f-. e-. d-. r 
	r2 f'4_\ffz d-.
...
% Bars 416 to 420
	fis( a) g2
	fis4-. fis-. e2->
	d16( \tweak rotation #'(10 0 0) \< e fis g a b cis d)\! dis2:16-\tweak X-offset #0.5 \ff
	dis1:
	dis2: e4( fis8 g)
% Bars 421 to 425
	a4-. a,-. g'2->
...
% Bars 446 to 450
	...
	b r r dis
% Bars 451 to 455
	e r r e\f-\tweak X-offset #-1 ^\arco
	a2-> cis,->
	fis,-> gis->
	a-> d->
	cis-> e->
