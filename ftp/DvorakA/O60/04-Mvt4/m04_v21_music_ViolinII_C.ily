...
% Bars 56 to 60
	...
	d) d(\fz cis b~
% Bars 61 to 65
	b8) b(-> a gis~ gis) d'->( cis b~
	b) b->( a gis~ gis) gis(->\< fis e~
	e) gis(-> fis e~ e) e->( d cis\!
...
% Bars 71 to 75
	...
	r4 \tuplet 3/2 4 {e,8(-\tweak X-offset #-3 \mf fis gis)} r4 \tuplet 3/2 4 {fis8( gis a)}
...
% Bars 111 to 115
	e4\fz a-. fis\fz d-.
	cis\fz a-. e'\fz gis,-. \mark \default
	a r r2
	R1*3
...
% Bars 126 to 130
	a2: fis4: gis:
	\tuplet 3/2 4 {a4.:8 fis':} \tuplet 6/4 2 {e2.:}
	\tuplet 3/2 4 {d4.: fis:} \tuplet 6/4 2 {e2.:}
	\tuplet 3/2 4 {e4.:} \tuplet 6/4 2 {d2.:} \tuplet 3/2 4 {cis4.:}
	cis8 cis4-> b-> a-> gis8->~
% Bars 131 to 135
	gis fis4-> eis-> fis-> eis8~
	eis fis4-> gis-> a-> bis8->~
	bis4 r r r8 cis8\fz~
	cis r r4 r r8 b!8\fz~
	b r r4 bes-. r
% Bars 136 to 140
	r <a, a'>-. q-. q-.
	<e cis' a'>-. r <e b' gis'>-. r
	cis''4-> \tuplet 3/2 4 {cis8( b a)} b4-> \tuplet 3/2 4 {b8( a gis)}
	a4-. r e,:16 cis:
	b2: e:
% Bars 141 to 145
	e: e4: cis:
...
% Bars 171 to 175
	...
	b,4 r r cis'8 dis
	e-> b a b g b e, fis
	b,4 r r \dynEO #'(0.5 . 1) c'~\fz
% Bars 176 to 180
	c2. \dynEO #'(0.5 . 1) c4\fz~
	c2. \dynEO #'(0.5 . 1) des4\fz~
	des2. \dynEO #'(0.5 . 1) cis!4\fz~
	cis2. \dynEO #'(0 . 1.8) a'4->\ff
	a-> \tuplet 3/2 4 {a8( gis fis)} d4-> \tuplet 3/2 4 {d8( cis b)}
% Bars 181 to 185
	a4-. r r8 a-. gis-. fis-.
	eis4.-> fis8 gis cis, dis eis
	fis4 r r gis'(\p
	fis cis a fis
	cis) r a'2\pp~
% Bars 186 to 190
	...
	a \mark \default
% Bars 191 to 195
	a4--\p \tuplet 3/2 4 {a8( g fis)} g4-- \tuplet 3/2 4 {g8( fis e)}
	d4-. a-. d2
	e4-. a,-. e'2
	fis4-. d-. fis2~
	fis8 r r4 r2
% Bars 196 to 200
	r4 fis8-.\f gis-. ais-. cis-. ais-. gis-. 
	fis4-. cis-. fis2->~
	fis4 r r2
	r2 r4 \tuplet 3/2 4 {fis'8(\f\< gis ais\!}
	b4) fis-. b2\fz~
% Bars 201 to 205
	b8 r r4 r \tuplet 3/2 4 {fis8(\f\< gis ais\!}
	b4) fis-. b2\fz~
	b8 r e,\f-! fis-! g-! a-! fis-! g-! 
	e r r4 r2
	r4 g8-!\f a-! b-! c-! a-! b-! 
% Bars 206 to 210
	g4 r r2
...
% Bars 211 to 215
	...
	e2( e')
	b2-> g4-. e-.
	a2-> a4-. fis-. \mark \default
% Bars 216 to 220
	e'\fz r r2
	r r4 \tuplet 3/2 4 {<e e'>8-\tweak X-offset #-1 \ff\<( <fis fis'> <gis gis'>}
	<a a'>4-\tweak extra-offset #'(0 . 0.5) \fz) e'-. <a, a'>2->~
	q2. r4
	R1
% Bars 221 to 225
	r2 r4 \tuplet 3/2 4 {<d, d'>8(\< <e e'> <fis fis'>}
	<g g'>4-\tweak extra-offset #'(0 . 0.5) \fz) d'-. <g, g'>2->~
	q2. r4
	c,8 c bes' bes aes aes g g
	f f ees' ees des des c c
% Bars 226 to 230
	bes bes aes aes ges ges f f
	ees ees des' des ces ces bes bes
	c16\ff ees, ees ees ees2.:16
	ees2: ees:
	ees: ees:
% Bars 231 to 235
	ees: ees:
...
% Bars 251 to 255
	...
	ees2 r4 ees4-.\!
% Bars 256 to 260
	\tuplet 3/2 2 {d\f d d  d d d
	d d d \tupletYOff #3.0  d d d
	d d d d d d
	d d d \tupletYOff #3.0 d d f'\ff-.}
	d\fz c-. b!-\tweak X-offset #0.2 \fz a-.
% Bars 261 to 265
	gis\fz f-. e\fz d-.
	e'\fz d-. cis!-\tweak X-offset #0.2 \fz bes-.
	a\fz g!-. f\fz e-.
	d'\fz c-. a\fz fis!-.
	d\fz c-. a-\tweak X-offset #0.5 \fz a'-.
% Bars 266 to 270
	bes\fz r r2
	R1
	a4\f r r2
...
% Bars 286 to 290
	...
	<e, b' gis'>4 r <e cis' a'>-\offset X-offset 0.5 \ff r
	r4 r8 e''-. cis-. b-. a-. e-.
	a4 r8 e' cis b a e
	a4 r8 a f e d a
% Bars 291 to 295
...
% Bars 336 to 340
	g8( g' fis e d e c d)
	b_\mfcresc-> b' a g fis! g e fis
	d4 r r2
	fis8\f-> fis' e d cis d b cis
	a4 r r2
% Bars 341 to 345
	cis,8_\fsempre cis' b a gis a fis gis
	d d' cis b a b g! a
	e e' d cis b cis a b
	fis4-.\f cis'->( d e
	d) ais2.->~
...
% Bars 396 to 400
	cis4 r r2
	cis'4-> \tuplet 3/2 4 {cis8(-\tweak X-offset #-2.8 _\crescmarkup b a-.)} a4 \tuplet 3/2 4 {a8( e cis-.)}
	fis4 r r2
	fis'4->\mf \tuplet 3/2 4 {fis8( e d-.)} d4 \tuplet 3/2 4 {d8( a fis-.)}
	fis4 r r2
% Bars 401 to 405
...
% Bars 416 to 420
	a( c) b2
	a16(\< a, b cis! \tuplet 3/2 4 {d8 e fis} g16 a b cis d e fis g)\!
	fis4 r a2\ff~
	a4 g8( a g4 fis)
	fis( a) g2
% Bars 421 to 425
...
% Bars 451 to 455
	b-. r r8 b e d
	cis a gis fis eis fis dis eis
	fis e! d! cis b d cis b
	cis e a gis fis a d fis
	e cis b a gis b fis gis
% Bars 456 to 460
	a cis e a, cis e a, cis
	fis a, cis fis g! e cis g
	fis g a g fis a g a
	fis g e fis d b' g a
	fis g fis g a b a b
% Bars 461 to 465
...
% Bars 466 to 470
	g-> g r4 r <c e>8-> q
	<b d>-> q r4 r c8-> c
	fis,-> fis r4 r dis'8 cis
	dis e dis e fis g fis eis
	fis gis fis eis fis gis fis eis
% Bars 471 to 475
