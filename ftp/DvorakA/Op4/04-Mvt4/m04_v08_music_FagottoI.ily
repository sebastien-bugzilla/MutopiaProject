...
% Bars 101 to 105
	...
	bes-> a->
	g-> c->
	\textMark "Vi-" \tuplet 3/2 2 {f4\ff e d c d e
% Bars 106 to 110
	f e d c d e
	f a c f f c
	f, a c f f c
...
% Bars 116 to 120
	...
	bes-> f->
	g c
	a g \offset X-offset -2.2 \textEndMark "-de" \mark \default
% Bars 121 to 125
	d'2.\ff c4-.
	f-. d2->( c4)
	f-. d2( f4)
...
% Bars 131 to 135
	...
	e(\! f)\<
% Bars 136 to 140
	<< \hairpinShorten #'(-0.5 . -2) des1->\fz\> {s4 s s s\!}>>
	\hairpinShorten #'(1 . 0) bes2\< << bes->~ {s4 s\!}>>
	<< bes1~\> {s4 s s s\!}>>
	bes1~\p\>
	<< bes {s4 s s s\!}>>
% Bars 141 to 145
	...
	aes1~
	aes4 f des bes)
	bes2.( aes4-\alterBroken shorten-pair #'(() (0 . 1.5)) \<
% Bars 146 to 150
	g aes des f)\!
	bes2.( aes4)
	g(\< aes des f)\!
	\startMeasureCount << aes,1_\fpdim~ {s2 s}>>
	aes1~
% Bars 151 to 155
	aes~
	aes~
...
% Bars 436 to 440
	...
	fis~
	fis~
	fis \resetMarkSpace \mark \default
	b,4-\offset X-offset #-1 \f fis dis''4.-> cis8-.
% Bars 441 to 445
	b4.-> g!8-. fis4.-> e8-.
	dis4.-> c!8-. b4 r
	b4 b'8( b,) b'( b,) r b
