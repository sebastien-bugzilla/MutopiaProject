...
% Bars 41 to 45
	...
	d4 r r2
% Bars 46 to 50
	\dynEO #'(-3.7 . 2) cis,8([\pp d)] bes'!( a) d,4 r
	R1
	cis8[(\p d]) bes'( a) d,4 r
	r2 r4 \dynEO #'(-3.7 . 2.8) cis8(\pp d)
...
% Bars 206 to 210
	ges-. r f-. r
	ees8 ees bes'-\offset X-offset 0.5 \ppp bes ees, bes' ees, bes'
...
% Bars 211 to 215
	...
	ees,4. ees'8 ees4 r
	ees,4. ees'8 ees4 r
	aes,8-. aes-. ees'-. ees-. aes,-. ees'-. aes,-. ees'-. 
% Bars 216 to 220
...
% Bars 221 to 225
	aes,4.\pp aes'8 aes4 r
	aes,4. aes'8 aes4 r
	fis,8\pp fis cis' cis fis, cis' fis, cis'
...
% Bars 471 to 475
	...
	bes: bes:}
% Bars 476 to 480
	\dynEO #'(0 . 2) e'2\ff-^~ e8 bis( dis-> cis)
	cis2~ cis8 gis( b-> ais)
	ais2~ ais8 e( gis-> fis)
	fis2->~ fis8 cis( e-> dis)
...
% Bars 491 to 495
	...
	a!-> bes-> a-> g-> 
% Bars 496 to 500
	\tuplet 3/2 2 {\dynEO #'(-0.8 . 1.8) d4\ff d d  d d d
	a a a  a a a
	d d d  d d d
	a a a  a a a}
	c2 b
...
% Bars 546 to 550
	ges: ges:
	ges: ges:}
	f4 r \tuplet 3/2 2 {\dynEO #'(-0.5 . 2) f''4\ff-> f-> ees->
	d-> d d c-> c c
	bes-> bes bes  g-> g g
% Bars 551 to 555
	f-> f f  f'-> f f
