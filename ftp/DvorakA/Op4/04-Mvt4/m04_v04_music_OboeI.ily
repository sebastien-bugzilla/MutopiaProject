...
% Bars 101 to 105
	...
	e2-> e->
	g-> fis->
	<<{\InCueContext \noteShift #-0.8 g a} \\ {g-> g}>>
	\textMark "Vi-" a2.\ff~ a8 g-.
% Bars 106 to 110
	a2.~ a8 g-.
	a4. g8 g4. f8
	f4. g8 g4. a8
...
% Bars 166 to 170
	...
	e2-> e->
% Bars 171 to 175
	d4. d8 \tuplet 3/2 2 {\once \tupletUp d4\<-. e-. f-.\!}
	f2(\> e4)\! r
	R1
	r2 r4 g16(\< a bes c)\! \mark \default
	d1\ff
% Bars 176 to 180
	cis2( b4. fis8)
	a1->~
...
% Bars 376 to 380
	...
	bes4-.) g2-^ \tuplet 3/2 4 {aes8( g aes)}
	a!1\fz(
	<< bes~ {s4\< s s-\offset X-offset 1.8 _\dimmarkup s\!}>>
% Bars 381 to 385
	bes4) a(\> c4. bes8)
	<< bes1~ {s8 s s s\! s4 s}>>
	bes4 a(\p\> c4. bes8)\!
...
% Bars 411 to 415
	b\!
	e,2\f dis4. e8
	e2. \tuplet 5/4 4 {b16( cis dis e! fis)}
	g4.-> f!8 e4-> d!->
	e2..-> e8
% Bars 416 to 420
	a2-> gis4.-> a8
	a2. \tuplet 5/4 4 {e16(\< fis gis a b)\!}
	c4.\fz bes!8-. a4-. g!-.
	a2.-> a16(\f\< bes b c)\!
	cis4->\ff gis-> a-> b->
% Bars 421 to 425
