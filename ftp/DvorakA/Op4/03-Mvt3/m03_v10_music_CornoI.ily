...
% Bars 71 to 75
	...
	\ni \mmrPos #4 R2. \no
% Bars 76 to 80
	\voiceOne r4 r \oneVoice f'(\p
	g a\< bes)
	\markEO #'(0 . 1.5) c8._\fmarkup c16 c2(~\!
	c4\brack\p\> ees des)
	c(\! d! ees)\p
% Bars 81 to 85
	<< c2. {\hairpinShorten #'(0.5 . -1) s4\> s s\!}>>
	g2\pp g8. g16
	g2 g8. g16
...
% Bars 86 to 90
	c4 r r8 f,
	<< c'2.~ {\hairpinShorten #'(-0.5 . -2) s4\fp\> s s\!}>>
	c4 r r8 f,\p
	c'2.\<~
	c2~ c8 f,\!
% Bars 91 to 95
...
% Bars 136 to 140
	...
	R2.
	\tuplet 3/2 4 {bes,8\f \hairpinShorten #'(-0.5 . 0) d\< f} bes2\!
% Bars 141 to 145
	R2.*3
...
% Bars 151 to 155
	\mmrLength #17 \mmrnDown R2.*28^\mutaine \transposition e
% Bars 156 to 160
...
% Bars 226 to 230
	<< \hairpinShorten #'(-0.5 . -1.5) ees2.\p\< {s4 s s\!}>>
	R2.*7
% Bars 231 to 235
	
	
	
	<< \hairpinShorten #'(-0.5 . -1.5) ges2.-^\fz\<~ {s4 s s\!}>>
	ges4 r r
% Bars 236 to 240
	b,!2\p~ b8 fis
	fis r r4 r
...
% Bars 306 to 310
	...
	c2-\offset X-offset 0.5 \fp c4->~-\offset X-offset 0.5 \fpdimD
	c c2->\>
	c2-> c4\p~
	c8 r r4 r
% Bars 311 to 315
...
% Bars 351 to 355
	...
	c2.\fp~
	c4 r r8 f,
	<< \hairpinShorten #'(-0.5 . -1.5) c'2.\fp\>~ {s4 s s\!}>>
% Bars 356 to 360
	c4 r r8 f,\p
	c'2.\<~
	c2~ c8 f,\!
...
% Bars 441 to 445
	<< \hairpinShorten #'(-0.5 . -1.5) c'2.-\offset X-offset -1.5 \fpp\> {s4 s s\!}>>
	R2.*5
% Bars 446 to 450
