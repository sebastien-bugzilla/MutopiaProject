...
%	\transposition a
% Bars 1 to 5
	r4 r8 d'''4.\pp r4 r8 d4.
	r4 r8 c4. r4 r8 c4.
	r4 r8 bes4._\crescmarkup r4 r8 bes4.
	r4 r8 a4.\< r4 r8 a4.\!
	r4 r8 ees'4.\mf r4 r8 d4.
% Bars 6 to 10
	r4 r8 c4.\> r4 r8 d4.\!
	r4 r8 g,4.\p r4 r8 c4.
	r4 r8 ees4.\pp r4 r8 d4.~
	d8 r r r4 r8 r2.
	R1.*3
% Bars 11 to 15
	
	
	r4 r8 r4 \hairpinShorten #'(0 . -5) c8(\p\< \hairpinShorten #'(5 . 0) ees4.\> d8)\! r r
	r4 r8 r4 g,8(\< bes4. a!8)\! r r
	g4.(\p a)\< bes( d4 c8)\!
% Bars 16 to 20
	bes4 r8 r4 r8 r4 r8 r4 r8
	R1.*6
% Bars 21 to 25
	
	\mark \default
	r4 r8 \dynEO #'(0 . 2) f'4.\pp r4 r8 e4.
...
% Bars 31 to 35
	...
	r4 r8 d''16(\p a d c bes a bes8) r r c16( g c bes a g
	a8) r r bes16( f bes a g f g8) r r a16(\< e a g fis c')\!
	bes2.(\f ees4.~_\crescmarkup ees4~ ees16 d)
% Bars 36 to 40
	c4.\<~ c4 bes16(\! a d4) r8 r4 r8 \mark \default
	r4 r16 d\pp d4. r4 r16 d d4.
	r4 r16 c c4. r4 r16 c c4.
	r4 r16 bes bes4. r4 r16 bes\< << bes4. {s8 s s\!}>>
	r4 r16 ees\< ees4. r4 r16 ees ees4.\!
% Bars 41 to 45
	r4 r16 ees\mf ees4. r4 r16 d d4.
	r4 r16 c\> c4. r4 r16\! des_\dimmarkup des4.
	r4 r16 c\p c4. r4 r16\> aes aes4.\!
	r4 r16 des\pp des4. r4 r16 c c4.
	f,(\p\< bes aes~\!~ aes8\> e8. f16)
% Bars 46 to 50
	f4.\!~ f8 r r r4 r8 f4 f8
	bes4.(\< ees) des\!~ des8\> a!8.( bes16)\!
	bes4.\brack\p~ bes8 r r r4 r8 bes4\p bes8
	ges'4.(\< f8 ees bes des4. c4\> c8)
	des4.(\! c8 bes f aes4. g!4 g8)
% Bars 51 to 55
	f4.( g)\< aes( c4\> bes8)\!
	aes4.(\< des) c( \markEO #'(0 . 1.7) g'4_\fzmarkup f8)\!
...
% Bars 56 to 60
	...
	r4 r16 \hairpinShorten #'(-0.3 . -1) ees'-\offset X-offset -1 \p\< ees4.\! r4 r16 \hairpinShorten #'(-0.3 . -1) d!-\offset X-offset -1 \p\< d4.\!
	r4 r16 des des4. r4 r16 bes bes4.
% Bars 61 to 65
	r4 r8 des4.\pp~^\solo des8 a!8.( bes16 bes4.)
	r4 r8 c16(\p-. c-. e-. e-. g-. g)-. r4 r8 c,16(-. c-. e-. e-. g-. g)-. 
	r4 r8 a,16(-. a-. cis-. cis-. e-. e)-. r4 r8 a,16(-. a-. cis-. cis-. e-. e)-.
	R1.
...
% Bars 71 to 75
	...
	\markEO #'(0 . 2) g4._\fbrackf~ g8 r g gis4.~ gis8 r gis \mark \default
	\dynEO #'(0 . 2) a8\f r r r4\fermata r8 r4 r8 f,4.(\pp
...
% Bars 76 to 80
	...
	f4.( g~ g8 a bes c4.)
% Bars 81 to 85
	\hairpinShorten #'(0 . -8.5) c2.(\pp\< d4. bes)\!
	\dynEO #'(0 . 1) g'2.->\fz( f4.\> ees\!)
...
% Bars 86 to 90
	...
	\dynEO #'(0 . 2) d1.\f \mark \default
	\dynEO #'(0 . 2) ees8\ff r r r4 r8 r2.
	R1.*2
% Bars 91 to 95
...
% Bars 96 to 100
	...
	ees!( bes')
% Bars 101 to 105
	d,!8 r r r4 r8 d r r r4\fermata r8 \mark \default
	r2. bes4.\p~ bes8 fis8.( g16)
	g4 r8 r4 r8 r2.
	R1.*3
...
% Bars 126 to 130
	...
	r2. \dynEO #'(0 . 2) g8->\ff fis-> g-> fis-> g-> fis->
	R1.
% Bars 131 to 135
	\textMark "Vi-" r4 r16 d\pp d4. r4 r16 d d4.
	r4 r16 c c4. r4 r16 c c4.
	r4 r16 bes bes4. r4 r16 bes bes4.
	r4 r16 a a4. r4 r16 a\< << a4. {s8 s s\!}>>
	\dynEO #'(0 . 2) e'8\ff r r r4 r8 bes4.\pp r4 r8 \textEndMark "-de"
% Bars 136 to 140
	R1.*2
	
	r2. bes4.\pp\<(~ bes8 fis8. g16)\!
	\dynEO #'(0 . 2) ees'!8\ff r r r4 r8 d8 r r r4 r8 \mark \default
	\tweak X-offset #-0.5 \textMark "Vi-" R1.
% Bars 141 to 145
	r2. r4 r8 c16-.\brack\pp bes-. a8-. g-.
	r2. \dynEO #'(0 . 2) d'16(\pp-. c-. bes8-. a)-. r4 r8
	\dynEO #'(0 . 1) d16\f c bes8 a c16 bes a8 g c16 bes a8 g bes16 a g8 fis
	r4 r8 r r gis16. a32 a16 r r8 gis16. a32 a16 r r8 gis16. a32
	\dynEO #'(0 . 2) a2.->\ff \dynEO #'(0 . 2) d-^\fz \textEndMark "-de"
% Bars 146 to 150
	d8\p r r r4 r8 r2.
	g,4.(\p\< c\! bes\> ees8 fis,8. g16)\!
	g4 r8 r4 r8 r2.
	r4 r8 ees'4.( << d2.~ {s8\< s s  s s s\!}>>
