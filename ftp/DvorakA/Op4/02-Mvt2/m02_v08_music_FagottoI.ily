...
% Bars 16 to 20
	R1.
	<< {b2.\fz c } {s4.\fz\> s s s\!}>>
	<< {bes!2.\pp bes} {s4.\< s s s\!}>>
	<< { bes2. cis } {s8\< s s s s\! s  s\f s s\> s s s\!}>>
	bes4.( a bes2.)
% Bars 21 to 25
	bes4.(\p b c a8 bes c)
...
% Bars 31 to 35
	e2.( d)
	c!( bes
	a8) r r d16( a d c bes a bes8) r r c16( g c bes a g
...
% Bars 41 to 45
	...
	<< {f\p( bes,) } {s4. s\> s\! s}>>
	c'2.~ c4.~ c8 r r
	f,4.(\p\< bes aes\!~ aes8\> e8. f16)\!
% Bars 46 to 50
	f4.~ f8 r r r4 r8 f4 f8
	bes4.(\< ees) des\!~ des8\> a!8.( bes16)\!
	bes4.\p~ bes8 r r r2.
	R1.
	des4.\p( c8 bes f aes4. g4 g8)
% Bars 51 to 55
	f4.( g)\< aes( c4\> bes8)\!
...
% Bars 61 to 65
	...
	R1.
	r4 r8 e'4.\p(~ e8 bis8. cis16 cis4.)
	d1.\pp~
% Bars 66 to 70
	d
	f\pp~
...
% Bars 86 to 90
	g\mf g des' des c c\< bes bes aes aes g g  aes aes des! des c c  des des c c bes bes\!
...
% Bars 106 to 110
	...
	f,(\< << a {s8 s s\!}>> bes4.\> << g) {s8 s s\!}>>
	b2.(\p c)
% Bars 111 to 115
	f4.( cis\< d bes!)\!
	<< bes1.->\f {s4. s s\> s8 s s\! }>>
	d4.(\p c\< << bes2.) {s4. s\!}>>
	bes4.( b c\> ees8 d c)\!
	bes!2.(\p\> b4. c)\!
% Bars 116 to 120
	f2.\p~ f
	a,4. bes(\brack\p\> c des)\!
	c2.(\pp bes4. c)
	bes( c~ c2.)
	bes2.(\< << d {s8\> s s s s s\!}>>
% Bars 121 to 125
	...
	R1.
% Bars 126 to 130
	r4 r8 \clef tenor g4.(\brack\p~ g8\> dis8. e16) e4.\! \clef bass
	r4 r8 c16(\pp-. c-. e-. e-. g-. g)-. r4 r8 c,,16(-. c-. e-. e-. g-. g)-. 
	r4 r8 des4.(\p~ des8 a!8. bes16 bes4.)
...
% Bars 131 to 135
	...
	<< cis'2.( {s8\fp\> s s s s s\pp}>> d2.~
% Bars 136 to 140
	d8) r r r4 r8 r2.
	R1.*2
	
	des,8\ff r r r4 r8 d r r r4 r8 \mark \default
	r2. ees8-.\pp d-. c-. d16-. c-. bes8-. a-.
% Bars 141 to 145
	...
	e4.->\ff a-> d,2.-^\fz
% Bars 146 to 150
	g,8\p r r r4 r8 g'4.(\p\< c\!
	bes\> ees8 fis,8. g16)\! g4 r8 r4 r8
	bes4.(\p a bes a)
