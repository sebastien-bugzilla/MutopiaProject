...
% Bars 1 to 5
	...
	c( fis, c' fis,~ fis c'~  c fis, c' fis,~ fis c'~  c fis, c' fis,~ fis c'~_\brackM\crescmarkup  c fis, c' fis,~ fis c')
...
% Bars 16 to 20
	...
	r8 d16(\mf\> f d f) r8 d16( f d f) r8 c16( ees c \markEO #'(2 . 3) ees)_\dimmarkup r8 c16( g' c, g')\!
	r8 \dynEO #'(-2 . 0.5) aes,16(\pp f' aes, f') r8 cis16( g' cis, g') r8 d16(\< aes' d, aes') r8 f16( d f bes)\!
...
% Bars 21 to 25
	...
	c4\fz\> r8 r4 r16 \markEO #'(0 . 2) c_\pmarkup a4\! r8 r4 r16 a\pp
	bes4 r8 r4 r8 r2.
% Bars 26 to 30
	ees2.(\pp bes')
	ees( d)
	c \shape #'((0 . 1)(0 . -0.8)(0 . -0.8)(0 . 0.5)) Slur bes4.(~ bes8 a16 g f a,
	bes4) r8 r4 r8 r2.
...
% Bars 71 to 75
	r4 r8 r16 <bes d>8-\offset X-offset -3 \mf\< q q16 r4 r8 r16 <c ees>8 q q16\!
	\dynEO #'(-2 . 1) <g ees'>4.\f r4 r16. ees''32 <gis,, d'>4.-> r4 r16. d'32 \mark \default
...
% Bars 81 to 85
	c4.\pp \hairpinShorten #'(0 . -3) a'4.\<~ a16 d g,4~ g16 aes f4\!
	ees4.(_\crescmarkup c'~ c4\mf\> bes8~ bes4 a!8)\!
	f16_\pdimD\>-. f-. g-. g-. f-. f-. g-. g-. f-. f-. g-. f-. ees-. ees-. f-. f-. ees-. ees-. f-. f-. ees-. ees-. f-. ees-.\!
...
% Bars 86 to 90
	...
	\dynEO #'(0 . 1) ees!\ff r r r4 r8 r4 r8 \dynEO #'(-2.5 . 1) ees,,16-.\pp ees( aes) aes( c) c-.
...
% Bars 106 to 110
	...
	r8 \shape #'((0 . 0)(0 . 0.5)(0 . 0.5)(0 . 0)) Slur bes,16(\< f' bes, f' r8 a,16 f' a, f' r8 bes,16 f' bes, f'\! r8 cis16-\offset X-offset -1 \mf-\tweak extra-offset #'(0 . 0.5) \> a' e cis)\!
	r8 d16(\p f d f r8 d16_\brackM\dimmarkup f d f r8 c!16 ees! c ees r8 c16\pp g' c, g')
% Bars 111 to 115
	r8 \shape #'((0 . 0)(0 . 0.5)(0 . 0.5)(0 . 0)) Slur aes,16( f' aes, f' r8 cis16 aes' cis, aes' r8 d,16 aes' d, aes' r8 f16 d f bes)
	r8 \shape #'((0 . 0)(0 . 0.5)(0 . 0.5)(0 . 0)) Slur ees,16( bes ees bes r8 ees16 bes ees bes r8 e16 bes e bes r8\> e16 bes e bes)\!
	r8 \shape #'((0 . 0)(0 . 0.5)(0 . 0.5)(0 . 0)) Slur f'16(\p d f d r8 a'16\< f a f r8 bes16 f bes f\! r8 ges16 bes, ges' bes,)
	r8 bes'16( f bes f r8 g!16 d g d r8 g16\> ees g ees g c f, bes a ees)\!
	r8 d16(\p f d f r8 d16 f\> d f r8 b,16  d b d\! \dynEO #'(0 . 3) ees\pp g ees c g c)
% Bars 116 to 120
