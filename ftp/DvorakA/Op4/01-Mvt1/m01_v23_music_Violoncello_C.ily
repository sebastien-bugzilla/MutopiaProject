...
% Bars 76 to 80
		...
		f(\mf e) r e[(\<
		g-> f)] r f([
		\markEO #'(0 . 2) bes->_\fmarkup a)] r a\!
% Bars 81 to 85
		c(\f\> ees c bes)\!
...
% Bars 101 to 105
		...
		ees-. d16( ees c8) r
		\dynEO #'(0 . 2) ees4->\ff c16[( d c r32 bes-.])
		a4-> g16[( a g r32 f-.])
...
% Bars 146 to 150
		...
		g g'4\fz( c,8)\<
		g \markEO #'(0 . 2) g'4_\fzmarkup( c,8)
% Bars 151 to 155
		g \markEO #'(0 . 2) g'4_\fzmarkup( c,8)\!
		bes4\p bes
...
% Bars 156 to 160
		...
		ees!2-\offset X-offset -3 _\fmarc->
% Bars 161 to 165
		\dynEO #'(0 . 2) ees'4.->\fz c16( d)
		ees4-> c->
		ees c
		ees,2
		ees'4. c16( d)
% Bars 166 to 170
		ees4-> c->
		ees-> c->
		\dynEO #'(0 . 2) ees\ff \acciaccatura {c16 d} ees4 
...
% Bars 236 to 240
		\alternative {
			\volta 1 {
				c8 r r4
				r g,16(-\offset X-offset -2 \pp f g a)
			}
			\volta 2 {
				c'8\repeatTie r r4
				r r8 f,,16(\pp g
...
% Bars 461 to 465
	...
	ees4-> c16[( d c\< r32 bes-.])
	a16( bes a g) \tuplet 3/2 4 {a8( g f)\!}
	\dynEO #'(0 . 2) \acciaccatura e''\ff f4 \acciaccatura cis8 d4
...
% Bars 561 to 565
	...
	f,2\ff~
	f
	\dynEO #'(0 . 2) f''16->\ff e f e d-> c d c
	bes-> a bes a g-> f g f
% Bars 566 to 570
	c'4(\p a
	f d) \mark \default
...
% Bars 611 to 615
	aes2-\offset X-offset -1.5 _\fbrackfconmoltaforza
	aes'4. f16 g
	aes4-> f->
	aes-> f->
	aes,2
