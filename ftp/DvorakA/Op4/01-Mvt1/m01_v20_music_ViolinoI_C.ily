...
% Bars 26 to 30
	\dynEO #'(0 . 2) fis2\ff\fermata \mark \default
	\dynEO #'(0 . 2) g4->\ff f!16[( g f r32 ees-.)]
...
% Bars 46 to 50
	...
	<< des {s8 s s s\!}>>
% Bars 51 to 55
	\dynEO #'(0 . 1) f8.->\f ees16-. ees8.-> f16-.
	f8 r r8. des,16\p
	des8.-> c16 c8.-> des16
	des8 r r4
	\dynEO #'(0 . 1) e'8.\f d16 d8. e16
% Bars 56 to 60
	e8 r r8. c,16\p
	c8.\> b16 b8. c16
	c8. b16 b8. c16\!
...
% Bars 76 to 80
		c8-.) a-. g-. f(\<
		f'4.->) ees8-.\!
		\tuplet 3/2 4 {d8(-\offset X-offset -0.5 \mf c a')} a4\<~
		a4. bes16( c\!
		d8 c-.)\f g4->
% Bars 81 to 85
		g->\> g->\!
...
% Bars 96 to 100
		...
		\dynEO #'(0 . 1) g!4->\ff f16[( g f r32 ees!-.)]
		ees4-> d16[( ees d r32 c-.)]
% Bars 101 to 105
		c4-> bes16[( c bes r32 a-.)]
		a4-> g16[( a g r32 f-.])
...
% Bars 106 to 110
		...
		\dynEO #'(0 . 2) aes16\ff aes bes bes  aes aes aes aes
		aes aes g g  f f g g
		aes aes g g  f f f f
		f f g g  f f aes aes \mark \default
% Bars 111 to 115
		\dynEO #'(0 . 2) g->\ff f g f  e-> d e d
		c-> b c b  a-> g a g
		<g, c e>8 r <e c' g'> r
		<g e' c'> r <e c' g'> r
		g4(\p e
...
% Bars 166 to 170
		f4: g:
		f8: g: a: g:
		\dynEO #'(0 . 1) fis4\ff \acciaccatura {dis16 e} fis4
...
% Bars 221 to 225
		...
		e2:16
		e4: e16 e fis fis
		\dynEO #'(0 . 2) g!(\ff fis e fis) g8.-> g16
		g2
% Bars 226 to 230
...
% Bars 291 to 295
	...
	\dynEO #'(-2.5 . 1) g16\mf-. c-.\< d-. c-. c_\crescmarkup-. e-. f-. e-. 
	e-. g-. a-. g-. g-. c-. d-. c-. 
% Bars 296 to 300
	c,-. e-. f-. e-. e-. g-. a-. g-. 
...
% Bars 376 to 380
	...
	\dynEO #'(0 . 1) d4:16\fz d16 d ees! ees
	\dynEO #'(0 . 1) d4:16\fz d16 d ees ees
...
% Bars 431 to 435
	...
	c) a\< g f
	f'4.-> ees8-.\!
	\once \tupletUp \tuplet 3/2 4 {d(\mf c a')} a4~
% Bars 436 to 440
	a4.\< bes16( c\!
	d8)-.\f\> c-. g4->\!
	g->\fz\> g->\!
...
% Bars 456 to 460
	\dynEO #'(0 . 2) g!4->\f f!16([ g f r32 ees!-.])
	ees4-> d16([ ees d r32 c-.])
	c4-> bes16[( c bes r32 a-.])
	a4 g16[( a g r32 f-.])
	f8.-> a16-. a8-. g-.
% Bars 461 to 465
	...
	\dynEO #'(0 . 2) \acciaccatura g8\ff aes4 \acciaccatura e8 f4
...
% Bars 491 to 495
	...
	des'4. c8
	des) r r c-.
	\once \tupletUp \tuplet 3/2 4 {bes(\< aes f')} f4~
	f\! r
% Bars 496 to 500
...
% Bars 516 to 520
	...
	bes8 r r4
	bes8 r r4
	<< \hairpinShorten #'(0 . -7) <a,,! a'!>2:16\fz\>^\arco {s8 s s s\!}>>
% Bars 521 to 525
	q2:\p
	q:\<
	<< q: {s8 s s s\!}>>
	\markEO #'(0 . 0) q2:_\fzpocoapococrescendo
	q8 f''4\< d32( e f g\!
% Bars 526 to 530
...
% Bars 556 to 560
	fis: e16: e: cis': cis:
	cis2:16
	\ottava #1 \tuplet 3/2 4 {\dynEO #'(0 . 2) des8->\ff( c! des) des(-> c des) 
	des(-> c des) des(-> c des) 
	des(-> c des) des(-> c des) 
% Bars 561 to 565
	des(-> c des) des(-> c des)}
...
% Bars 711 to 715
	...
	d4:16 g:\fz
	g: f16 f d d
	d4:16 \markEO #'(0 . 1) bes':_\ffbrackf
	bes2:
% Bars 716 to 720
	bes:
	bes:
