...
% Bars 61 to 65
	...
	\repeat volta 2 {
		\tempoXoffset #0.5 r8 <bes d>4\pp <bes ees>8
		r bes4 bes8
		r ees( c ees)
% Bars 66 to 70
		ees( d) bes'4\<~
...
% Bars 86 to 90
		...
		q4..->\fz q16
% Bars 91 to 95
		fis'4\ff \beamOffset #'(-0.5 . -0.5) e16([ fis e r32 d-.)]
...
% Bars 96 to 100
		...
		ees4-> \beamOffset #'(-0.5 . -0.5) d16[( ees d r32 c-.])
% Bars 101 to 105
		c4-> bes16[( c bes r32 a-.])
		a4-> g16[( a g r32 f-.])
...
% Bars 116 to 120
		...
		R2
% Bars 121 to 125
		\acciaccatura {g,16-\offset X-offset 1 \pp a bes c} des2
		R2
		r8 bes4->~ bes8-.
		r des4->~\< des8-.
		r e4->~ e8-.\!
...
% Bars 151 to 155
		\repeat tremolo 4 {e,( bes')\!}
		d,4(\p g,)
		g'4.( f8)^\brackM\pocoapococresc
		d4. g,16( a
		bes4.) r8
% Bars 156 to 160
		\hairpinShorten #'(-0.5 . -0.5) e4(\p\< c)\!
		a'4.(-> g8-.)
		e4.->\< c32( d e f)
		g8-. \tuplet 3/2 8 {g16( a b} c8-.)\! \tuplet 3/2 8 {c16( d e} \markXoffset #-0.2 \markWhiteout \mark \default
		<a, f'>2:16\f)
% Bars 161 to 165
		q:
		c'4: ees:
...
% Bars 246 to 250
	...
	b16( d b d  b d b d)
	\tuplet 3/2 4 {\tupletUp b8(\< d b d b d) \tupletNeutral }
	b16( d b d  b d b d)\!
	c8\pp r r4
% Bars 251 to 255
	R2*7
% Bars 256 to 260
	...
	d16(\< f d f  d f d f)
% Bars 261 to 265
	\tuplet 3/2 4 {\tupletUp d8( f d f d f)\! \tupletNeutral }
	R2
	\startMeasureCount \tuplet 12/8 2 {<g,, d'>2.:16\pp
	q:
	q:
% Bars 266 to 270
	<< q: {s4. s_\crescmarkup}>>
...
% Bars 291 to 295
	...
	c,-. e-. f-. e\!-. e-. g-. a-. g-. 
	g-. c-. d-. c-. c-. e-. f-. e-. 
	g2->-\offset X-offset -2.8 _\fzbrackcresc
	e2->\fz
% Bars 296 to 300
	c->\fz
	g->\fz \mark \default
...
% Bars 336 to 340
	...
	r8 d16( e) r8 e16( f)
	bes,,8-\offset X-offset -2.3 \pp-. bes'-. bes,-. bes'-. 
	bes,-. bes-. bes'-. bes-. 
	bes,-. bes'-. bes,-. bes'-. 
% Bars 341 to 345
	bes,-. bes-. bes'-. bes-. 
...
% Bars 351 to 355
	ees ees4-> ees8~
	ees r r4
	r8 \hairpinShorten #'(-0.5 . -1) ees4_\fzdimD\> ees8~
	ees\! r r4
...
% Bars 391 to 395
	...
	f,8(\< g16 a \tuplet 6/4 4 {\once \tupletUp bes c d ees f g)\!}
	a4.->\f g8-.
	f4.-> g8-.
% Bars 396 to 400
	a-. bes-. c-. bes-. 
...
% Bars 431 to 435
	...
	r8 <a, f'>4\< q8
	r <f' a>4 q8\!
	\repeat tremolo 4 {\hairpinShorten #'(-0.5 . -1) c'16(\mf\< bes)\!}
% Bars 436 to 440
...
% Bars 461 to 465
	...
	d( c) \tuplet 6/4 4 {\once \tupletUp c16( d ees f fis g)\!}
...
% Bars 486 to 490
	c4.\p bes8->\fz
	aes4.\p ges8->\fz
	\startMeasureCount aes,4.\pp aes8~
	aes4. aes8~
	aes4. aes8~
% Bars 491 to 495
	aes4. aes8~
...
% Bars 521 to 525
	...
	<< <d, d'>2: {s8 s s s\!}>>
	<d' e>4:\< <d f>8: <d g>:\!
	a'8_\fzpocoapococresc a,~ a \tuplet 3/2 8 {a16( b cis)}
	d4 e(
% Bars 526 to 530
	f8) f4->\fz( e8)
	d4. e8~
...
% Bars 531 to 535
	...
	bes4.\p aes8->\fz
% Bars 536 to 540
	\startMeasureCount bes,4.\pp bes8~
	bes4. bes8~
	bes4. bes8~
	bes4. bes8~
	bes4.\pp bes8~
% Bars 541 to 545
	bes4. bes8~
	bes4. bes8~ \stopMeasureCount
	bes4. bes'8 \offset X-offset #-2.3 \textEndMark "-de" \mark \default
	ees8-.\pp d16( ees \tuplet 3/2 4 {\once \tupletUp ces8 bes_\pocoapococresc ces)}
	e!-. dis16( e \tuplet 3/2 4 {\once \tupletUp c!8 b c)}
% Bars 546 to 550
	f2(\<
	<< fis) {s8 s s s\!}>>
	g2(_\crescmarkup
...
% Bars 556 to 560
	...
	des->( c des) des->( c des) 
% Bars 561 to 565
	des->( c des) des->( c des)}  % d => des based on conductor
...
% Bars 606 to 610
	...
	d'4.(->\< c8-.)\!
	a4.\< f32( g a bes
	c8) \tuplet 3/2 8 {\once \tupletUp c16( d ees} d8) r\! \mark \default
% Bars 611 to 615
...
% Bars 626 to 630
	...
	f8 bes, \tuplet 6/4 4 {\once \tupletUp bes16(\< c d ees f g)\!}
...
% Bars 666 to 670
	...
	a)
% Bars 671 to 675
	\startMeasureCount \tuplet 3/2 4 {f'8(\pp d f d f d)
	f( d f d f d)
	f( d f d f d)
	f( d f d f d)
	f( d f d f d) \stopMeasureCount
% Bars 676 to 680
	d( bes d bes d bes)
	f'( d f d f d)
	bes'( f bes f bes f)}
