...
% Bars 11 to 15
	d~
	d\! \stopMeasureCount
	\dynEO #'(5 . 0) e\fermata-\offset X-offset -5 \ff
...
% Bars 61 to 65
	...
	\mark \default
	\repeat volta 2 {
		\mmrLength #14 \tempoXoffset -1 \mmrnDown R2*4
% Bars 66 to 70
...
% Bars 286 to 290
	ees2\p\<
	e8[(\! f ees) r16 des-.]
	<< c2 {\hairpinShorten #'(0 . -1) s8\> s s s\!}>>
	ees( des aes bes)
	c4.( b8\<
% Bars 291 to 295
	\tuplet 3/2 4 {\once \tupletUp a!8 g e'} e4-)
	c4.( b8)\!
	\tuplet 3/2 4 {a8(\f g e'} e4)
	\tuplet 3/2 4 {d8(-\offset X-offset -1.5 _\fcresc c g')} g4\brack\fz~
	g2~
% Bars 296 to 300
	g~
	g \mark \default
...
% Bars 391 to 395
	...
	f'8-. \shape #'((0 . 0)(0.5 . 0)(0 . 0.5)(0 . 0.5)) Slur g16( f f,8) r
% Bars 396 to 400
...
% Bars 436 to 440
	...
	r8 g->~ g16.[ g32 g16]\! r
	bes2(\fz\>
	<< ges {s8  s s s\!}>> \markWhiteout \mark \default
	f8) r f4->\f~
% Bars 441 to 445
	f\< ees8-.-> f-.->
	g r c,4->~
...
% Bars 466 to 470
	...
	aes~
% Bars 471 to 475
	aes \markWhiteout \mark \default
	g8) r r4
	R2*5
% Bars 476 to 480
	
	
	g,4_\fzpocoapoco_crescendo~ g8 \tuplet 3/2 8 {g16( a b}
	c4.)->\< d8-.\!
	ees4.\fz d8
% Bars 481 to 485
	c-.\< g'-. g-. f-.\!
...
% Bars 491 to 495
	aes-. f-. ees-. des-.
	r4 r8 \shape #'((-0.3 . 1)(0 . -1.3)(0 . -1.3)(0 . 0)) Slur des\p(
	des'4. c8
	des8) r r4
	R2
% Bars 496 to 500
	...
	r d
	r d 
	\textMark "Vi-" ees8-._\ppocoapococresc d16( ees ces8) r
% Bars 501 to 505
	e-. dis16( e c!8) r
	f-. e16( f des8) r
	fis-. eis16( fis d!8) r \mark \default
...
% Bars 536 to 540
	R2
	ees8-.\p d16( ees \tuplet 3/2 4 {c8 bes c}
	ees) r r c-.
	bes-. g-. f-. ees-.
	r4 r8 ees(\<
% Bars 541 to 545
	ees'4.\! d8
	ees) r r d(\p\<
	\tuplet 3/2 4 {\once \tupletUp c bes g'\!} g4~\> \markWhiteout \mark \default \offset X-offset -2.3 \textEndMark "-de"
	g8)\! r  ees4\pp
	r e
% Bars 546 to 550
	f8(\p e16 f des8) r
...
% Bars 571 to 575
	...
	\tupletUp ees ees ees^\calando  ees ees ees
	ees ees ees   ees ees ees \tupletNeutral }
	ees4 r
	ees\< r
% Bars 576 to 580
	ees r
...
% Bars 591 to 595
	...
	\mmrLength #13 \tempoXoffset -1 R2*12
% Bars 596 to 600
...
% Bars 671 to 675
	...
	f8) r r4
% Bars 676 to 680
	\mmrLength #12 \tempoXoffset -1.5 \mmrnDown R2*5
% Bars 681 to 685
	\ni \mmrPos #-4 R2
