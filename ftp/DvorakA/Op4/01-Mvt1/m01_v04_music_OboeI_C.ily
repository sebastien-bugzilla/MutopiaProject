...
% Bars 21 to 25
	...
	fis
% Bars 26 to 30
	\dynEO #'(0.5 . 1.3) gis\ff\fermata \mark \default
	g!4\f f!->~
	f8 r ees!4->~
	ees8 r d4->~
	d8 r c4->~
...
% Bars 76 to 80
		...
		r8 c8\p->~ c16.[ c32\< c16] r
		r8 ees!->~ ees16.[ ees32 ees16]\! r
		r8 g->~ g16.[ g32 g16] r
% Bars 81 to 85
		bes2\f\>
		ges(\!
		f8) r \partCombineApart f4_\mf~
		f ees8-.-> f-.->
		g r c,4->\<~
% Bars 86 to 90
		c\! d8->-. ees-.-> \partCombineAutomatic
...
% Bars 221 to 225
		e e e  e e e}
		\partCombineApart \stemDown \dynEO #'(0 . 1) \acciaccatura {e16_\ff fis gis} a4.( \omitFlag e!8) \partCombineAutomatic
		cis4 fis8.-> e16-.
		\partCombineApart \stemUp g!8.[( fis16) g8.( fis16)]
		g8.[( fis16) g8.( fis16)]
% Bars 226 to 230
		g8.[( fis16) g8.( fis16)]
		g8.[( fis16) g8.( fis16)] \partCombineAutomatic
		g8 r r4
		R2*7
% Bars 231 to 235
...
% Bars 291 to 295
	...
	\tuplet 3/2 4 {d8(_\fcresc c g')} g4_\brack\fz~
	g2~
% Bars 296 to 300
	g~
	g \partCombineAutomatic \mark \default
	e4(\f cis!)
	a'( e!8. fis16)
	e4( cis!8. d16)
% Bars 301 to 305
...
% Bars 326 to 330
	...
	R2 \mark \default
	\partCombineApart r8 \dynEO #'(-1.5 . -2) ees,\pp r c
% Bars 331 to 335
	r ees r c
	r ees r c
	r ees r c
...
% Bars 336 to 340
	...
	r e r cis
% Bars 341 to 345
	r e r cis \partCombineAutomatic
	R2*4
% Bars 346 to 350
	bes'!2(~\f\<
	bes4\! aes8) r
	\partCombineApart \dynEO #'(-1 . -1) ges16[(\f aes ges16. f32)] f8 r
	ees16[( f ees16. des32)] des8 r
	c16[( des c16. bes32)] bes8 r
% Bars 351 to 355
	aes16[( bes aes16. g!32)] g8 r
	r4 \dynEO #'(-0.9 . -1) g16(\f aes g f
	bes8) r r4
	r \dynEO #'(-1.8 . -2) g16(\mp aes g f
...
% Bars 386 to 390
	...
	bes'8\f r r4
	bes8 r r4 \mark #11
	\partCombineApart r f\fp~
% Bars 391 to 395
	f2~
	<< f~ {s8 s s s}>>
	f2 \partCombineAutomatic
	\aIIEO #'(-3 . -1) f8-.\f g16( f) \tuplet 3/2 4 {f,8( e f)}
	f'8-. g16( f f,8) r
% Bars 396 to 400
...
% Bars 406 to 410
	\partCombineApart ees8-.\p d16( ees \tuplet 3/2 4 {d8 cis d)}
	c!8-. b16( c \tuplet 3/2 4 {bes8 f bes)} \partCombineAutomatic
	R2*12
% Bars 411 to 415
...
% Bars 436 to 440
	...
	f8) \partCombineApart \stemUp r \dynEO #'(-2 . -3) f4->\f~
% Bars 441 to 445
	f ees8-.-> f-.->
	g r c,4->~
	c d8-.-> ees-.-> \partCombineAutomatic
...
% Bars 476 to 480
	...
	g,4_\fzpocoapococrescendoC~ g8 \tuplet 3/2 8 {g16( a b}
...
% Bars 481 to 485
	...
	c8-> \tuplet 3/2 8 {bes!16( aes g} aes8) r
% Bars 486 to 490
	aes8-> \tuplet 3/2 8 {g16( f e} f8) r
	f'8-> \tuplet 3/2 4 {ees!16( des c} des8) r
	R2
	\partCombineApart \dynEO #'(-1 . -0.5) des'8-.\p \shape #'((0 . 0)(0 . -0.3)(0 . -0.5)(0 . -0.3)) Slur c16( des \tuplet 3/2 4 {bes8 aes bes}
	des) r r bes-.
% Bars 491 to 495
	aes-. f-. ees-. des-.
	r4 r8 des\p(
...
% Bars 496 to 500
	...
	r d
	r d
	\partCombineApart ees8-.^\ppocoapococresc d16( ees ces8) r
% Bars 501 to 505
	e-. dis16( e c!8) r
	f-. e16( f des8) r
...
% Bars 536 to 540
	...
	ees) r r c-.
	bes-. g-. f-. ees-.
	r4 r8 \shape #'((0 . -0.5)(0.5 . 0)(-0.5 . -1)(0 . -2)) Slur ees(\<
% Bars 541 to 545
	ees'4.\! d8
	ees) r \partCombineAutomatic r d(\p\<
	\once \tupletUp \tuplet 3/2 4 {c bes g'\!} g4~\> \mark \default
	g8)\! r  ees4\pp
	r e
% Bars 546 to 550
	...
	ges8( f16 ges d!8) r
	g!-.\< fis16( g ees8) r
	aes-. g16( aes e8)\! r \partCombineAutomatic
...
% Bars 561 to 565
	...
	R2
% Bars 566 to 570
	\tuplet 3/2 4 {f8-\tweak X-offset -1.5 \mf f f  \tupletUp f\> f f
	f f f  f f f\! \tupletNeutral } \mark \default
	\grace {s8.} \tuplet 3/2 4 { f8\p f f \tupletUp f\> f f
	f f f  f f f\! \tupletNeutral
	\dynEO #'(-0.7 . 1.5) ges\pp ges ges  ges ges ges
% Bars 571 to 575
...
% Bars 606 to 610
	...
	\partCombineApart f2\f\<~
	<< f {s8 s s s\!}>> \partCombineAutomatic \mark \default
% Bars 611 to 615
	\dynEO #'(0 . 1) bes2\ff~
	bes8 f-. d-. f-.
...
% Bars 621 to 625
	...
	g!8\f r r4
	r r8. e16\ff
	\partCombineApart g4. f8 \partCombineAutomatic
% Bars 626 to 630
	ees!( e f fis)
	\partCombineApart g4.-> f!8 \partCombineAutomatic
	ees( e f f)
	f2->
	aes4.-> aes8
% Bars 631 to 635
...
% Bars 681 to 685
	...
	r4\fermata r
	e4->\f f->
	g \partCombineApart d'8. c16
% Bars 686 to 690
	bes4 a'8. g16 \partCombineAutomatic
	f2~
	f8 ees d c
	bes4 ees8. d16
...
% Bars 701 to 705
	...
	f-> a->
	f-> a->
	\dynEO #'(-0.5 . 0) c,\ff( bes)
% Bars 706 to 710
	\partCombineApart c ees~
	ees d8. c16
	c4( d) \partCombineAutomatic
	ees( d)
	ees g\fz~
% Bars 711 to 715
	g f8. d16
	d4 g\fz~
	g f8. d16
	d4 \partCombineApart \stemDown bes'->~
	bes2~
% Bars 716 to 720
	bes~
	bes~
	\stemUp bes8 \partCombineAutomatic r r4
	R2*4
