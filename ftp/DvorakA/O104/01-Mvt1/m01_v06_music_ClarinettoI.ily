...
% Bars 21 to 25
	g8 r r4 r2
	R1 \mark \default
	\tempoXoffset #1 r2 d4.\ff e16 f
	d4 r d4. e16 f
	d4 r r2
% Bars 26 to 30
	d8.\f\< f16 a2.\trill
	bes8\! r r4 bes4.->\f c16 d
	bes4. r8 bes4. c16 d
	bes8 r r4 r2
	R1*3
% Bars 31 to 35
...
% Bars 36 to 40
	...
	a8 r r4 \tuplet 6/4 2 {a2.:8\f
	a:\< a:
	g:\f g:\> 
	f:_\dimmarkup f:\! }
% Bars 41 to 45
	e8 r r4 r8 a,-.\mf b-. cis-.
	\acciaccatura e d\< cis-. d-. e-. \acciaccatura g f e-. f-. g-.
	a( b) b4.->( cis8) cis4~\!
	cis8( d e f) gis,4.(\> a8)\! \mark \default
	a4.(\mf-\tweak X-offset #0.8 ^\solo b16 cis a2)
% Bars 46 to 50
	a4.( g!16 e a2)
...
% Bars 181 to 185
	...
	r4 cis2.\f
	\tuplet 3/2 4 {fis,8\< a cis} \trillAccidental \sharptrillmark \afterGrace fis2.\!\trill {eis16([ fis)]}
% Bars 186 to 190
	bes!8 r r4 r2
	r8 e,!\fz r4 r2
	r8 e\fz r4 r2
...
% Bars 221 to 225
	fis~
	fis4\p r r2
	R1 \markXoffset #-0.2 \mark \default
	\mmrLength #25 \tempoXoffset #1 \mmrnDown R1*16
...
% Bars 291 to 295
	f!(_\dimD\> e f e)\!
	f( e\> ees d!8\! a)
	\once \stemUp bes4(\pp aes ges aes)
	\once \stemUp bes( aes ges aes)
	des,8 r r4 r2
% Bars 296 to 300
	R1*3
...
% Bars 326 to 330
	...
	r4 b,,2\fp( d4)
	d8( e f!2.)
	\once \tupletDown \tuplet 3/2 4 {fis8\mf d' d} d4 \tuplet 3/2 4 {cis8 cis cis} cis4
...
% Bars 341 to 345
	...
	\trillAccidental \naturaltrillmark a'1\ff\trill
	\trillAccidental \naturaltrillmark a\trill
	\trillAccidental \naturaltrillmark a\trill
	\trillAccidental \sharptrillmark b\trill
% Bars 346 to 350
	a4-. a-. r bes!-.
	r a-. b-. bes-.
	a-. r a-. r
