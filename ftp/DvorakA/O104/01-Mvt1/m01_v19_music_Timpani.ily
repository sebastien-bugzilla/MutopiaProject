...
% Bars 21 to 25
	fis8 r r4 r2
	R1 \mark \default
	\tempoXoffset #1 b2:32\f b4 r
	b2:32 b4 r
	b8-> b-> r4 r2
% Bars 26 to 30
	r4 b8-\tweak extra-offset #'(-1 . -7.5) ^\f b b4 b
	b2:32 b4 r
	b2:32 b4 r
	R1*16
...
% Bars 71 to 75
	...
	\mmrPos #-4 R
	\mmrPos #-4 R \no \mark \default
	\tempoXoffset #1 d4\f r8 d d d d r
% Bars 76 to 80
	d4 r8 d d d d r
	R1*2
	
	d8\f d d r d d d r
	d_\dimD\> d d r d d d r\!
% Bars 81 to 85
	d4\p r r2
	R1*4
...
% Bars 346 to 350
	b4-. b-. r b-.
	r b b b
	b4 fis8. fis16 b4 fis8. fis16 
	b4 fis8. fis16 b4 fis8. fis16 
	b4 r r \tuplet 3/2 4 {b8 b b}
% Bars 351 to 354
	b4 r r2
	R1
	b1:32\<
