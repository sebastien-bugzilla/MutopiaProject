...
% Bars 16 to 20
	...
	cis8 r \dynEO #'(0 . 1) g8(->\ff fis16) r g8(-> fis16) r g8(-> fis16) r 
...
% Bars 31 to 35
	...
	r4 ais\prall\mp r b\prall
	r fis\prall_\dimmarkup r b\prall
...
% Bars 56 to 60
	R1
	\mmrLength #26 \mmrnDown \tempoXoffset #-3 R1*18
% Bars 61 to 65
...
% Bars 76 to 80
	...
	\mmrPos #-2 R
	\mmrPos #-2 R \no
	r4 b'8\ff(\prall a) a r g(\prall fis)
	fis r e(_\dimmarkup\prall d) d r g,(\prall fis)
% Bars 81 to 85
	fis r r4 r2
	R1*5
% Bars 86 to 90
	
	\mmrLength #13 \mmrnDown R1*5
% Bars 91 to 95
...
% Bars 101 to 105
	...
	c8\fz r r4-\tweak X-offset #-4 ^\mutainflautopiccolo r2
	R1*7 
...
% Bars 156 to 160
	\markXoffset #-0.3 \mark \default
	R1*1 
	\mmrLength #18 \tempoXoffset #-2 R1*10
...
% Bars 236 to 240
	...
	\mmrPos #-4 R
	\mmrPos #-4 R \no
	gis2(~\p-\tweak X-offset #-4.5 ^\solo \tuplet 3/2 2 {gis4 ais b)}
% Bars 241 to 245
	b( ais2 e8 dis)
	dis4(\< gis) gis-- gis--\!
	gis2.( gis,8 ais)
	b4( dis2)_\dimmarkup dis4
...
% Bars 266 to 270
	...
	ais2.\> r4\!
% Bars 271 to 275
	\tempoXoffset #-2 \mmrLength #16 R1*10
% Bars 276 to 280
...
% Bars 281 to 285
	\tempoXoffset #-1.5 \mmrLength #14 R1*3
	
	\mark \default
	\tempoXoffset #1 R1*1
	\tempoXoffset #-3 \mmrLength #13 R1*10
% Bars 286 to 290
...
% Bars 316 to 320
	...
	\dynEO #'(0 . 1) ais8\fz r r4 r2
	r2 r4 r8\fermata ais8
	b4.\ff cis16 dis b2
	ais4. gis16 fis b2
% Bars 321 to 325
	b8 r ais r b r b r
	dis2 cis4-. ais-. \mark \default
	b8 r r4 r2
	R1*5
