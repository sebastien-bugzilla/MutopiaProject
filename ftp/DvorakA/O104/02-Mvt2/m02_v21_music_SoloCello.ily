...
% Bars 106 to 110
	<<{ 
		...
		s2.
		r4 g,\p_\pizz \footnote "(*)" #'(-1 . 0) \footnotePageX Stem <c, g'>_\arco 
		r g'_\pizz r
...
% Bars 116 to 120
	<<{
		...
		r4 d,\fz-\tweak extra-offset #'(0.5 . -6) ^\pizz r
...
% Bars 126 to 130
	...
	d(_\dimmarkup cis) c
	b2(\pp a4\fermata \markXoffset #-0.2 \mark \default
	g) r r 
...
% Bars 146 to 150
	...
	\shape #'((0 . 0)(0 . 0)(0 . -1)(0.5 . -3)) Tie g'2.\pp~ \clef treble
	g8 a( b\< c d4~\!
% Bars 151 to 155
