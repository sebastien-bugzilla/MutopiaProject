...
% Bars 26 to 30
	...
	\repeat tremolo 8 {\stemUp b(\fz\> d) \stemNeutral} e,32( gis e gis e gis b e)\!
	f8(\p e16) r f8( e16) r d8( d,)
	dis2( e4)_\dimmarkup
% Bars 31 to 35
	eis( fis! g)
	aes2(\pp a4)
	\hairpinShorten #'(0 . 0.5) <g b>2\dimD\>( \once \stemUp <b d>4)
	\once \stemUp c2.\ppp(\fermata \mark \default
	b4) r r
% Bars 36 to 40
	R2.*3
...
% Bars 41 to 45
	<bes d>4-> q-> fis->
	g4.-> r8 r4
	d2-\tweak X-offset #-3 \pp( \acciaccatura d8 g4~
	g) c,( \tuplet 5/4 4 {c'16 bes a g f)}
	ees4( \once \stemUp c' a)
% Bars 46 to 50
	\acciaccatura {d,16 g} bes2.
	bes8( g \hairpinShorten #'(0 . -2) ees4_\crescD\< \grace {g16 ees} c4\!)
	f2(_\dimD\> a8 f)\!
	f16 d'8 d16 d8 r r4 \mark \default
	<bes d>2.\pp
% Bars 51 to 55
	<bes ees>
	<<{<c ees>} \\ {bes}>> % based on manuscript
	<bes d>
	<bes des>
	<<{<bes des>} \\ {ges2( g4)}>>
% Bars 56 to 60
...
% Bars 81 to 85
	...
	\acciaccatura f!8 << a2.( {s4-\tweak X-offset #-2 \mf s\< s16 s\> s s} >>
	bes4\p) r r
	<< a2.( {s4\< s \hairpinShorten #'(0 . -1) s16\> s s s\!}>>
% Bars 86 to 90
	bes4)\p r r
	R2.*7
...
% Bars 116 to 120
	...
	\mmrnDown \tempoDown \tempoXoffset #-7 \tempoEO #'(7 . 9.2)  R2.*2
% Bars 121 to 125
...
% Bars 126 to 130
	...
	\tempoXoffset #1 <d g>16-.\ppp([ r q-.] r q-.[ r q-.] r q-.[ r q-.]) r
	<e g>-.([ r q-.] r q-.[ r q-.] r q-.[ r q-.]) r
% Bars 131 to 135
	<d g>-.([ r q-.] r q-.[ r q-.] r q-.[ r q-.]) r
	<e g>-.([ r q-.] r q-.[ r q-.] r q-.[ r q-.]) r
	<d g>-.([ r q-.] r^\crescmarkup q-.[ r q-.] r q-.[ r q-.]) r
	<e g>-.([ r q-.] r q-.[ r q-.] r <e gis>-.[ r q-.]) r
	<e a>2\mf r4_\fermata-\tweak X-offset #-2 ^\lunga
% Bars 136 to 140
	R2.*12
% Bars 141 to 145
...
% Bars 146 to 150
	...
	g16-\tweak X-offset #1 ^\pizz\pp d' d d g, d' d d g, d' d d
...
% Bars 156 to 160
	...
	r4^\arco g,2(\p\< 
% Bars 161 to 165
	\hairpinShorten #'(-0.5 . -1) \after 2.*5/6 \! <c, ees>2.)\fz\>
	<d g>2.\pp~
	q
	q2^\morendo q4~
	q q2
