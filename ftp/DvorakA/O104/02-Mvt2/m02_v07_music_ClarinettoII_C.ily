...
% Bars 86 to 90
	...
	d2.
% Bars 91 to 95
	\hairpinShorten #'(0.8 . 0.8) bes2.\< 
	\hairpinShorten #'(0.8 . 0.8) a!\>
...
% Bars 146 to 150
	...
	\afterGrace a2.-\tweak extra-offset #'(1.3 . 7) \sf-\tweak extra-offset #'(1.3 . 7) -\tweak shorten-pair #'(0 . 5) \>\fermata\trill( {gis16 a\!)} \mark \default
	bes8\pp r r4 r
	R2.*3
% Bars 151 to 155
