...
tempiPartMvtI = {
	...
	triangolo solocello  violinoII viola violoncello contrabasso) {
	...
	\tag #'(flautoI flautoII clarinettoII cornoIII trombaI violinoI) {
		\tempo \markup {
			\medium \italic \center-column {
...
%	}
	...
	cornoII timpani  solocello  viola violoncello 
	contrabasso) {
