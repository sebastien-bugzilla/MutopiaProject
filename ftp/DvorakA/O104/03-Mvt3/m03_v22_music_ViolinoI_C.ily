...
% Bars 16 to 20
	...
	\slashedGrace g'8 \markEO #'(0.3 . 2.5) g4->_\fzmarkupbrack e8-. c-.
	\slashedGrace g'8 \markEO #'(0.3 . 3) g4->_\fzmarkupbrack e8-. c-.
	\slashedGrace c'8 \markEO #'(0.3 . 3.5) c4->_\fzmarkupbrack g8-. e-.\!
% Bars 21 to 25
	\dynEO #'(0 . 1) fis'2:32\ff
	fis:
...
% Bars 36 to 40
	...
	r4 \tupletYoffset #2 \tuplet 5/4 4 {fis16(-\tweak X-offset #-2 \f -\tweak rotation #'(4 -1 0) \< b cis d fis)\!}
% Bars 41 to 45
...
% Bars 56 to 60
	...
	r8 a,,-\offset X-offset #-1.5 _\pmarcato^\pizz r d
	r fis r a
	r c r f
	r dis r b
% Bars 61 to 65
...
% Bars 206 to 210
	...
	a'2\fz~
	a
	\tuplet 3/2 4 {d,8\fz d a e'\fz e a,
% Bars 211 to 215
	fis'\fz fis a, g'\fz g a,}
	a'2\fz~
	a
	e8. b16 b8 r
	c8. b16 b8 r
...
% Bars 256 to 260
	...
	cis2\startTrillSpan
	cis4->\startTrillSpan dis->\startTrillSpan
	e8(\stopTrillSpan fis) a16( g fis e)
...
% Bars 346 to 350
	\bar "||" \key b \major
	\grace {s8} dis'4_\ptranquilloemoltoespressivo-\offset X-offset #-5 ^\solo--( dis~--
	dis8 e dis e)
	fis4( b
	fis b)
% Bars 351 to 355
...
% Bars 466 to 470
	...
	r4-\offset X-offset -1 ^\solo fis8.(\p\< fis'16)\!
	fis4.(\fz e8)
	dis4.(\> cis8)\!
% Bars 471 to 475
	cis8.( b16 b4_\dimD\>~
	b8 ais) ais8.(\prall gis16)\!
	fis4. r8
	R2*3
...
% Bars 496 to 500
	...
	\repeat tremolo 8 {cisis32(\pp\<^\arco^\moltocresc dis)}
...
% Bars 506 to 510
	...
	b2:32\ff
	R2
	fis,8-. b-. \tuplet 3/2 4 {cis16( dis cis)} b8-.
	fis-. b-. \tuplet 3/2 4 {cis16( dis cis)} b8-. 
% Bars 511 to 515
