...
%	\transposition a
% Bars 1 to 5
	\startMeasureCount fis8\pp r fis r
	fis r fis r 
	fis r fis r
	fis r fis r
	fis r fis r
...
% Bars 46 to 50
	...
	\startMeasureCount a,16(\pp d a' d,) a( d a' d,)
	a( d a' d,) a( d a' d,) 
% Bars 51 to 55
	a( d a' d,) a( d a' d,) 
	a( d a' d,) a( d a' d,) 
	...
	a( d a' d,) a( d a' d,) 
% Bars 56 to 60
	a( d a' d,) a( d a' d,) \stopMeasureCount
	fis2:16\pp  
	fis: 
	a: 
	a: 
...
% Bars 66 to 70
	...
	R2
	fis,2\p~
	\hairpinShorten #'(-0.5 . -0.5) fis_\dimD\>~
% Bars 71 to 75
	fis8\! r r4
	R2
	b4\pp r8 b
...
% Bars 101 to 105
	e, r r4
	R2
	\tuplet 3/2 4 {e8-\offset X-offset -1.3 \brack\fz e c g' g e
	c' c g e' e c}
	ais4 r
% Bars 106 to 110
	ais r
...
% Bars 121 to 125
	...
	g,[ cis b'] r
	fis,[ cis' ais'] r
	g,2^\arco-\offset X-offset -2 -\tweak extra-offset #'(0 . 1) _\dimmarkup(
% Bars 126 to 130
	fis\>
	g
	fis)\!
...
% Bars 136 to 140
	...
	\tempoXoffset #-1.5 \mmrLength #12 \mmrnDown R2*3
% Bars 141 to 145
	
	\mark \default
	\tempoXoffset #1 a,4\pp-\tweak X-offset #1 ^\pizz r
	a r
	a r8 a
% Bars 146 to 150
	a4 r8 a
...
% Bars 201 to 205
	...
	r4 r8 a'\ff-\tweak X-offset #-5 _\arco \mark \default
...
% Bars 261 to 265
	...
	q8\arpeggio r r4
	<b fis'>8-\tweak X-offset #-0.5 _\dimmarkup r r4\>
	q8 r r4\!
...
% Bars 266 to 270
	...
	b:
	b8 r r4
	\beamOffset #'(0.5 . -0.5) b8[(\pp d fis e])
% Bars 271 to 275
	d2~
	d~
	d4 cis!(
...
% Bars 376 to 380
	...
	R2 \mark \default
% Bars 381 to 385
	b,4\f-\tweak X-offset #1.8 ^\arco b
	a2
	gis
	g
	fis\fp~
...
% Bars 441 to 445
	dis\pp gis)
	dis( gis
	dis-\tweak extra-offset #'(1 . -7.5) ^\dimmarkup gis
	dis) gis~
	gis2\ppp~
% Bars 446 to 450
	gis4 e~
...
% Bars 496 to 500
	...
	\tempoXoffset #1.2 b2:32\pp\<-\tweak X-offset #1 ^\arco
	b:
	b:
	b:\!
% Bars 501 to 505
