...
%	\transposition a
% Bars 1 to 5
	c'8-\offset X-offset -1.5 \f^\pizz r c\brack\p r\fermata
...
% Bars 6 to 10
	...
	<g, g'> r g r\fermata
	c16(-\offset X-offset -2 \pp^\brackM\arco e c e c e c e)
	c( e c e bes f' bes, f')
% Bars 11 to 15
	c( f c f f aes f aes)
...
% Bars 21 to 25
	ees4(^\sulg f8 c)
	ees4( f8 c)
	ees4(-\offset X-offset 3 _\crescmarkup f8 c)
	aes\< f'(~ f16 ees des c)\!
...
% Bars 56 to 60
	...
	r g\> g g  g g g g\!
% Bars 61 to 65
	r \dynEO #'(-2.6 . 2) <g, e'>8\pp q16 r q8 q16 \once \unsetGrandStaffName \once \setStaffName "Vln.II"
...
% Bars 76 to 80
	<< {
		...
		s4\< c8~ c\!
		des4\brack\f << f, {\hairpinShorten #'(0 . -3) s8\> s\!}>> 
	}>>
	des'8( bes) aes( ges)
	f4 ees8[( bes'16. aes32-.)]
	aes4.(\< a8)\!
% Bars 81 to 85
	<d, bes'>16-\offset X-offset 0.8 \mf r r8 r c'32-. a-. f-. c-.
	bes'16->-\offset X-offset -1.5 _\crescendo r g'32-.\< ees-. bes-. g-. c16->\! r bes'32-. f-. d-. bes-.
...
% Bars 96 to 100
	...
	bes'32\brack\mf-\offset X-offset 3.5 _\crescendo f ees d c16. bes32 bes8-> c->
	d8->[ ees-> f-> <bes, bes'>->]
% Bars 101 to 105
	q2:32\f
	q:
...
% Bars 121 to 125
	...
	des16)-\offset X-offset 1 _\dimin r r8 r4
...
% Bars 136 to 140
	...
	R2
	\dynEO #'(-0.5 . 0) aes32\ff r r c' c4.\fermata
% Bars 141 to 145
...
% Bars 166 to 170
	...
	\dynEO #'(-2.3 . 2) <g, g' g'>16\f[ r q] r q[ r q] r
	q[ r q] r q[ r q] r
% Bars 171 to 175
	q[ r q] r q[ r q] r
	q[ r q] r q[ r q] r
