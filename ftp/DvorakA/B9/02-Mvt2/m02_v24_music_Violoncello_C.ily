...
%	\transposition a
% Bars 1 to 5
	aes8-\offset X-offset -1.5 \f^\pizz r aes\brack\p r\fermata
...
% Bars 11 to 15
		f( c f c f aes f aes)
		\shape #'((0 . 0)(0 . -0.3)(0 . -0.3)(0 . 0)) Slur bes(f bes f f d! f d)
...
% Bars 16
		...
		e16(-\offset X-offset -2 \pp c e c e c e c)
...
% Bars 21 to 25
	c4( f)
	c( f,)
	c'8. c16-\offset X-offset -2 _\crescmarkup f8( f,)
...
% Bars 71 to 76
	...
	des'
	<<{
		ees16(-\offset X-offset -6 ^\divisi ges ees ges des ges des ges)
...
% Bars 77 to 80
	aes'4(\f << a) {\hairpinShorten #'(0 . -3) s8\> s\!}>>
...
% Bars 86 to 90
	...
	g,-. bes-. f'( ees) ees,-. g-. c( bes) bes,\>-. ees-. aes( g) \stemDown g,-. bes-. f'( ees)\! \beamDampingRevert \stemNeutral
...
% Bars 96 to 100
	...
	f8 bes, f bes,
% Bars 101 to 105
	\beamDamping #5 bes'32-\offset X-offset -1 \f^\brackM\arco bes g g ees ees c' c bes bes ees ees c c g aes
	bes bes g g ees ees c' c bes bes ees, ees c c g aes
	bes a bes c d c d bes ees f g aes! bes c bes aes
	g ees f g aes bes c d ees d c bes c bes aes g
	f g f ees d c d bes ees-. g-. c( bes) f-. aes-. ees'( d)
% Bars 106 to 110
	g,-.-\offset X-offset -2 _\brackM\dimin bes-. f'( ees) ees,-. g-. c( bes) bes,-. ees-. aes( g) g,-. bes-. f'( ees) \beamDampingRevert
...
% Bars 186 to 190
	<<{
		...
		\shape #'((0 . 0)(0 . 0)(0 . 0.5)(0 . -1.5)) Slur d([ c b a]
% Bars 191 to 193
		g[ fis a g]
		fis[ e d g]
