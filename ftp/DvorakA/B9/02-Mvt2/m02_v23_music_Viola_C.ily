...
%	\transposition a
% Bars 1 to 5
	aes'8-\offset X-offset -1.5 \f^\pizz r aes\brack\p r\fermata
...
% Bars 6 to 10
	...
	g r g, r\fermata
	c16(^\arco-\offset X-offset -2 \pp g c g e g e g)
	c( g c g f bes f bes)
% Bars 11 to 15
	...
	<<{
		...
		\shape #'((0 . 0)(0 . 0.3)(0 . 0.3)(0 . 0)) Slur d,( bes' d, f f bes f bes)
		d( f d f d f bes, d)
	}>>
...
% Bars 21 to 25
	ees8([ aes16. c,32] c4)
	ees,8([ aes16. c,32)] c4
	c2(-\offset X-offset 3 _\crescmarkup
	f8)\< f4 f8\!
...
% Bars 66 to 70
	...
	bes8.(-\offset X-offset -4 ^\solo_\espressivo ces16 des4)
	bes8( aes16 ges ees'4)
% Bars 71 to 75
	f8[( bes16. aes32]) aes8( ges)
	des'4.(  aes8)
	\dynEO #'(0 . 1) ces8[(\p bes aes ges)]
	bes4( aes8 ges)
	ces4( bes)
% Bars 76 to 80
...
% Bars 81 to 85
	<d d'>16-\offset X-offset 0.8 \mf bes'8 bes16 r bes8 bes16
	r bes8_\crescendo bes16 r\< <bes f'>8 q16\!
	\beamDamping #5 bes32\f-. bes-. g-. g-. ees-. ees-. c'-. c-. bes-. bes-. ees-. ees-. c-. c-. g-. aes-. 
...
% Bars 86 to 90
	...
	g,-. bes-. f'( ees) ees,-. g-. c( bes) bes,-.\> ees-. aes( g) g,-. bes-. f'( ees)\! \clef alto \beamDampingRevert
	r16 c(-\offset X-offset -2 \brack\p\< aes f\! ees8.\> f32 ees)\!
...
% Bars 96 to 100
	...
	\beamDamping #5 f32-. ees-. d-. c-. bes16-. bes'-. c,32-. bes-. aes-. g-. f16-. bes-. 
% Bars 101 to 105
	bes32-\offset X-offset -1 \f bes g g ees ees c' c bes bes ees ees c c g aes
	bes bes g g ees ees c' c bes bes ees ees c c g aes
...
% Bars 121 to 125
	...
	\once \tupletUp \tuplet 6/4 4 {bes16-._\dimin c-. des-. c-. des-. f-. a,-. bes-. des-. bes-. c-. des-.}
	r4 \tuplet 3/2 4 {des16( aes f)} r8
% Bars 126 to 130
	\dynEO #'(-3.5 . 2.5) c4(\brack\pp des)
	bes'(\< c,8)\! r
	<<{
		ees'2->-\offset X-offset 2 ^\dolce~
		ees8[ des c f]
	} \\ {
...
% Bars 166 to 170
	...
	\beamDamping #5 g'32\f g e e c c a' a g g c c a a e f
...
% Bars 181 to 185
	...
	r\> f8.\! r16 bes8.
	r16 e,8.-\offset X-offset 0.8 \pp r16 aes8.
% Bars 186 to 192
	<<{
		aes4 ges~
		ges2
	...
	<ees g!>2
	<< <f aes>\f {s4 s-\offset X-offset -2 _\brackM\dimmarkup } >>
	<<{
		d2
		g~
		g
