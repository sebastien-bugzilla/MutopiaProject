...
% Bars 36 to 40
	...
	f16-. c'-. g-. c-. aes-. c-. bes32( aes g f)
% Bars 41 to 45
	g4.(-\offset X-offset -0.5 \mf fis8)
	g4.(_\dimin e8)
	f4.(\p e8)
	f4.(\> d8)\!
...
% Bars 121 to 125
		...
		ees'8[\mf-. \tuplet 5/4 8 {ees32( f g aes bes]} c8.)_\crescmarkup c16
		d,2
...
% Bars 141 to 145
	...
	a4( bes8) r
	\dynEO #'(-2.3 . 1) bes8.\pp(^\brackM\solo c16) bes4
% Bars 146 to 150
	c4.( bes8)
	bes8.(\< c16) bes4
	ees4.( d8)\!
...
% Bars 176 to 180
	...
	<bes ees>\< r <c fis> r\!
% Bars 181 to 185
	r d'16(-\offset X-offset -1 \mf^\arco d' cis8-> d16) r
...
% Bars 196 to 200
	q:
	<a a'>:\f
	\dynEO #'(0 . 2) b'8(->\ff a16) r gis8(-> a16) r
	b2:32
	cis8(-> b16) r a8(-> b16) r
% Bars 201 to 205
	c! r r8 f,,,!4->\mf
...
% Bars 231 to 235
	...
	g4.) d8
% Bars 236 to 240
	<bes g'>2-\offset X-offset 1.5 \pp~
