...
% Bars 56 to 60
	f!( e d c! b c a b)
	\dynEO #'(-2.7 . 2) <c, g' ees'!>8->\brack\f <c g' d'>-> <c g' ees'>-> r
...
% Bars 106 to 110
		...
		c8. c16 c8 bes
		r8 ees,16(-\offset X-offset -4.6 ^\brackM\arco bes') r8\< d16( a)
		r8 g16( d') r8 f16( c)\!
		f2:32->_\mfcrescendo
% Bars 111 to 115
		bes:->
...
% Bars 146 to 150
		...
		s2
% Bars 151 to 155
		\shape #'((0 . 0)(0 . -0.5)(0 . -0.5)(0 . 0)) Tie des2~
		des4 c8 ees
	}>>
	\dynEO #'(-3 . 2) <ees g>16\brack\mf^\brackM\tutti <g, bes> q q <aes c>8-> q16-. r
...
% Bars 196 to 200
	...
	cis8.->-\offset X-offset -1 \ff cis16 cis4:32
...
% Bars 235 to 240
		g,4.\p fis8
		<g bes>2-\offset X-offset 1.5 \pp~
		q8 s s s16 s
	}>>
	c8\f r b r
	c_\dimmarkup r r8. g16~
