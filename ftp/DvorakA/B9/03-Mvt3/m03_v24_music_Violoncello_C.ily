...
% Bars 6 to 10
	...
	ees r d r
	g, r r4\fermata
	c8-.\p-\offset X-offset -1.5 ^\arco c'-. c,-. r
% Bars 11 to 15
...
% Bars 71 to 75
	...
	R2
% Bars 76 to 80
	r8 f'8.->-\offset X-offset #-6 ^\brackM\arco\noBeam d8-> bes16->~
	bes g8-> ees-> c-> a16->
...
% Bars 156 to 160
	...
	bes8 r r4
	r \tuplet 3/2 8 {d16[-\offset X-offset -1 \brack\p d d] bes bes bes}
% Bars 161 to 165
...
% Bars 176 to 180
	...
	bes r ees r
% Bars 181 to 185
	g2-\offset X-offset -5 ^\arco_\mfespressivo~
	g~
	g4 ees(
	d2)
	d(~_\dimin
...
% Bars 241 to 245
	...
	g, r r4\fermata
% Bars 246 to 250
	c8-.\p-\offset X-offset -1 ^\arco c'-. c,-. r
	c16-. g'-. d-. g-. ees-. g-. f32( ees d c)
	f8-. f'-. f,-. r
	f,16-. c'-. g-. c-. aes-. c-. bes32( aes g f)
	ees'4->\mf d->
...
% Bars 311 to 315
	R2
	r8 f'8.->-\offset X-offset -7 ^\brackM\arco\noBeam d8-> bes16->~
	bes g8-> ees-> c-> a16->
	bes8->_\marcato[ f'->] c-> f->
	d->[ aes'->] ees-> aes->
% Bars 316 to 320
...
% Bars 331 to 335
	...
	R2
	f-\offset X-offset 1 \pp
% Bars 336 to 340
	R
	fis
	c'4(\brack\p des8.->) c16-.
	c4(-\offset X-offset 3 _\crescendo ees8.->) c16-.
	c4 f8.( c16)
% Bars 341 to 345
	f8(->\< c'16) r f8(-> c16) r\!
	e,,4\f f8-. g-.
