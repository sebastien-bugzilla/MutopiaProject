...
%###############################################################################
nameStaffIMvtI = {
	\set Staff.instrumentName = "Flauti I. II."
...
nameStaffVIMvtII = {
	\set Staff.instrumentName = \markup {
		\concat { \general-align #Y #CENTER { "Corni I. II. in E" \tiny \flat }}
	}
	\set Staff.shortInstrumentName = \markup {
		\center-column {
			\lower #1.5 "Cor. I. II."
...
nameStaffVMvtIII = {
	\set Staff.instrumentName = "Corni I. II. in Es"
	\set Staff.shortInstrumentName = \markup {
		\line {
			\hspace #5 \lower #1.5 "in Es"
			\center-column {
...
nameStaffVIMvtIV = {
	\set Staff.instrumentName = "Corni I. II. in C"
	\set Staff.shortInstrumentName = \markup {
		\line {
			\hspace #5 \lower #1.5 "in C"
			\center-column {
				"I." "II."
			}
		}
...
nameStaffVIIMvtIV = {
	\set Staff.instrumentName = \markup {
		\center-column {
			\lower #1 "Trombe" "I. II. in C"
		}
	}
	\set Staff.shortInstrumentName = "Tr. in C"
	\set Staff.midiInstrument = #""
}
nameStaffVIIIMvtIV = {
	\set Staff.instrumentName = \markup {
