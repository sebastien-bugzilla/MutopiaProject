...
cueVoiceTrombonoIMvtI = \relative c {
	...
	s2.*192
	% bar 279 - 282
	\voiceOne c''2.(-\offset X-offset -3.5 ^\markup {\column {\lower #1.5 "Fl." "Ob."}}
	ees,)
	g(
	d) \oneVoice 
	s2.*116 s2*20 s2.*41
...
cueVoiceTrombonoIIMvtI = \relative c {
	...
	s2.*116 s2*20 s2.*41
	% bar 460
	\voiceTwo ges,,,2.-\offset X-offset 1 _\markup {Trbne.III} \oneVoice 
}
...
cueVoiceTrombonoIIMvtIV = \relative c {
	...
	s2*123
	% bar 458 - 459
	\voiceOne f,8[-\offset X-offset -3 ^\markup {Fag.} e d r16 c'-.]
	c4( b8) r \oneVoice 
	s2*41
	% bar 501
	<>-\offset X-offset -1.5 ^\markup {Cor.}
	s2*152
	% bar 653 - 656
	\voiceOne e'4(-\offset X-offset -3 ^\markup {Viol.I} a8.) g16
	g4( f8) r
	d4( g8.) f16
	f4( e8) r \oneVoice 
}
cueVoiceTrombonoIIIMvtI = \relative c {
	...
	s2.*115
	% bar 201 - 204
	\voiceOne c'2~-\offset X-offset -5 ^\markup {Trb.I.II} c8 d
	ees4 r r
	c2~ c8 d
	ees4 r r \oneVoice 
	s2.*74
...
cueVoiceTrombonoIIIMvtIV = \relative c {
	...
	s2*53
	% bar 203 - 205
	\voiceOne b'4^\markup {Ob.I} e,
	e4. fis8
	g[ fis e b']
	s2*125
	% bar 331 - 332
	<c e>4^\markup {Ob.Fl.I II} <b d>
	q4.. <c e>16 \oneVoice
	s2*86
	% bar 419 - 422
	\voiceOne d,4-\offset X-offset -3.5 ^\markup {Trb.I} g,
	g4.. a16
	b4 g
	g4.. a16 \oneVoice 
	s2*35
	% bar 458 - 459
	\voiceOne f8[(-\offset X-offset -3.5 ^\markup {Fag.} e d) r16 c'-.]
	c4( b8) r \oneVoice 
	s2*41
	% bar 501
	<>-\offset X-offset -1.5 ^\markup {Cor.}
	s2*152
	% bar 653 - 656
	\voiceOne e'4(-\offset X-offset -4 ^\markup {Viol.I} a8.) g16-.
	g4( f8) r
	d4( g8.) f16-.
	f4( e8) r \oneVoice
}
...
cueVoiceTimpaniMvtII = \relative c {
	s2*8
	% bar 9
	<>-\offset X-offset -3 ^\markup {\column {\lower #1.5 "Ob.I" "solo" }}
	s2*43
	% bar 52
...
cueVoiceTimpaniMvtIII = \relative c {
	...
	s2*64
	% bar 202 - 204
	\voiceOne bes'''4->-\offset X-offset -3 ^\markup {Fl.} bes
	a!8.-> bes16 bes8 ges
	ges4-> ges-> \oneVoice 
}
