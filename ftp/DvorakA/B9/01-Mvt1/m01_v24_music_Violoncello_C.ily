...
% Bars 236 to 240
		...
		aes4 r r
		g r r
		r f''8-\offset X-offset -0.5 \brack\f-. ees-. ees-. d-. 
		d-. c-. c-. bes-. bes-. aes-. 
% Bars 241 to 245
		aes4 r r
		g r r8. aes16\f
...
% Bars 286 to 290
		bes' bes d, d bes bes bes' bes g g f f \beamDampingRevert
		\alternative {
			\volta 1 {
				ees4 r r
				R2.
...
% Bars 321 to 325
	b4( d8) r c4(
	ees8)\< r d4( f8)\! r
	ees4-\offset X-offset -0.8 _\fmarcato-> d-> c->
	c-> bes-> aes->
	ees'-> d-> c->
% Bars 326 to 330
	b-> a-> g->
...
% Bars 341 to 345
	...
	g,8. g16 g2
% Bars 346 to 350
	a2.\brack\p-\offset X-offset 2.8 _\dolce(
	bes)
	c(\<
	d)\!
	\dynEO #'(0 . 1) ees8.[->\p f16-. f8( ees)] ees4->
% Bars 351 to 355
	d8.->[ ees16-. ees8( d)] d4
	c8.->[ d16-. d8( c)] c4
...
% Bars 356 to 360
	f:\<
	\after 2.*5/6 \! f:
	d8.->-\offset X-offset -1 \f ees16-. ees8([ d]) d-. ees-.
	f r r8. bes,,16 bes8 r
	f''8.-> g16-. g8([ f]) f-. g-.
% Bars 361 to 365
	aes r r8. bes,,16 bes8 r
	\dynEO #'(0 . 1) d'8\fz-> d-> c4-. bes-.
	\dynEO #'(0 . 1) bes8->\fz bes-> a4-. g-.
	\dynEO #'(0 . 1) d'8->\fz d-> c4-. bes-.
	a8->\fz a-> g4-. f-.
% Bars 366 to 370
	g8->\fz g-> f4-. ees-.
...
% Bars 426 to 430
	bes->
	f8_\pp-\offset X-offset 2.7 _\brackM\marc-. des'-. aes-. f'-. des( aes')
	f,-. des'-. aes-. f'-. des( aes')
	f,-. des'-. aes-. f'-. des( aes')
	f,-. des'-. aes-. f'-. des( aes')
% Bars 431 to 435
...
% Bars 481 to 485
	...
	dis-> r r
	ais-> r r \section
	\key c \minor f'8->-\offset X-offset -1 \f g g-> a a-> f
	d-> e e-> f f-> d
% Bars 486 to 490
	f-> g g-> a a-> f
	c-> d d-> e e-> c
