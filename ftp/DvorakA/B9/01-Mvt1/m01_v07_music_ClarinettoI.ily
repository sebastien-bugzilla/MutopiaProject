...
% Bars 6 to 10
	...
	a4 r r2\fermata \bar "||"
	\time 3/4 a'2.\pp->
	\measureCountFrom 2 \startMeasureCount a->
% Bars 11 to 15
	\repeat volta 2 {
		a->
		a->
...
% Bars 21 to 25
		...
		\measureCountFrom 1 \startMeasureCount a2.->\pp
% Bars 26 to 30
		a->
		a->
		a->
...
% Bars 166 to 170
		...
		g,2\brack\f-\offset X-offset #3 _\diminuendo c4~
% Bars 171 to 175
		c2.~
		c
...
% Bars 206 to 210
		...
		r cis2(\p\<
		ees4)\! r r
		r \hairpinShorten #'(-0.3 . -0.3) c!2\p\<
% Bars 211 to 215
		a2.\pp~
		a~_\crescendo
		a~
...
% Bars 286 to 290
		...
		\alternative {
			\volta 1 {
				\startMeasureCount \noteHeadEsw #'(-2 . 0) a2.->\pp \revertNoteHeadEsw
				a-> \stopMeasureCount
			}
			\volta 2 {
				d,\ff~
...
% Bars 366 to 370
	...
	r4 b,2->\fz
	r4 b2->\fz
	d,2(-\tweak extra-offset #'(-0.9 . -9.2) ^\brack\f e4)
% Bars 371 to 375
	fis2(^\brackM\legato g4)
	a2( b4
	d cis b)
	a8 r r4 r8. d,16
	d8 r r4 r
...
% Bars 391 to 395
	c-. r r
	\afterGrace a!2.\startTrillSpan {gis16( a)\stopTrillSpan}
	bes4 r r
...
% Bars 456 to 460
	...
	aes~
	aes~\<
	<<aes {\hairpinShorten #'(0 . -1.5) s8\> s s s s s\!}>>
	aes2( bes4\<
% Bars 461 to 465
	c2 des4
	ees2\! f4\>
...
% Bars 496 to 500
	...
	\key b \minor \startMeasureCount d2\p r8. d16
	d2 r8. d16
% Bars 501 to 505
	d2 r8. d16
	d2 r8. d16
