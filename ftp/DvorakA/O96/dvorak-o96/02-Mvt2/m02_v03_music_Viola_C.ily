...
% bars 11 to 15
	d8-\tweak extra-offset #'(0 . 0.4) \pp r r d^\pizz r r
	<d a'> r r d r r
	d r r a' r r
	d, r r d_\crescmarkup r r
	d-\offset X-offset #-1.5 \fp\> r r d r r\!
% bars 16 to 20
	d\< r r d r r\!
	c-\tweak extra-offset #'(0 . 0.3) \mf r r <c g'> r-\offset X-offset #-1.5 _\crescmarkup r
	q\> r r q\p r r \mark \default
	e16\pp\(( g) g( bes) a( g)\) e16\(( g) g( bes) a( g)\)
	e16\(( g) g( bes) a( g)\) e16\(( g) g( bes) a( g)\)
% bars 21 to 25
	e16\(( g) g( bes) a( g)\) e16\(( g) g( bes) a( g)\)
	e16-\tweak extra-offset #'(0 . 2) _\moltocrescmarkup-\tweak extra-offset #'(0 . -0.8) \<\(( g) g( bes) a( g)\) e16\(( g) g( bes) b( f)\)\!
	f\f\(( a) a( c) c( f,)\) d\((\> f) f( d') d( f,)\)\!
	f\p\<\(( a) a( d) d( a)\) f\(( a) a( d) d( a)\)\!
	f\(( a) a( f')_\crescmarkup f( a,)\) f\<\(( a) a( f') f( a,)\)\!
% bars 26 to 30
...
% bars 31 to 35
	...
	cis8. r16 cis32_\crescmarkup cis cis cis cis8. r16 cis32\< cis cis cis\!
	f!8.\f r16 f32 f f f  bes8. r16 bes32 bes bes bes
% bars 36 to 40
	d,8.\> r16 d32 d d d b'8. r16 b32 b b b\!
	c8( c,16) r16 cis32_\crescmarkup cis cis cis d8. r16-\tweak extra-offset #'(0 . 0.5) \< dis32 dis dis dis\!
...
% bars 41 to 45
	...
	fis-\offset X-offset #-1 \mf\>\(( a) a( c) c( a)\) fis\(( a) a( c) c( a)\)\!
...
% bars 51 to 55
	...
	a-\offset X-offset #-0.5 \ff( c) c( e) e( c) e,( c') c( e) e( c)
% bars 56 to 60
	a( c) c( e) e( c) e,( c') c( e) e(_\dimmarkup c)
	a( c) c( e) e( c) a(-\offset X-offset #1.8 _\dimmarkup c) c( e) e( c)
...
% bars 86 to 90
	d^\arco d r d^\pizz d r
	d^\arco d r d^\pizz d r
	d4.-\tweak extra-offset #'(0 . -2) ^\arco\fp\>( des)\!
	c\p\>( cis)\!
	d4.:32\pp^\trem g4.:32
% bars 91 to 95
	d4.:32 g4.:32
