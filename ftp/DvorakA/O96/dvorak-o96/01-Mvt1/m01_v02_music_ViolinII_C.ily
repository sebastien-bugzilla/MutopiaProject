...
% bars 41 to 45
		e(\< f4~ f8\> g16 f e8 d)\!
		c4\p\>( d c-\tweak extra-offset #'(-2.5 . 4) _\dimmarkup b
		c d a b)\! \mark \default
		cis2\ppp^(~ <cis e>)
		<b fis'>1~
% bars 46 to 50
		\hairpinShorten #'(0 . -9) q2\< <e a>\!
		<fis d'>\fz\>( <e cis'>)\!
		e1\pp
		fis
		\hairpinShorten #'(0 . -9) f!2\< <e a>\!
% bars 51 to 55
...
% bars 56 to 60
		...
		d( fis ais-\tweak extra-offset #'(0.5 . 2.7) _\dimmarkup g b fis! a d,)
		\hairpinShorten #'(0 . -7) b2(\> gis)\!
		a8\p( cis4 e8) fis8.( a16 fis4)
% bars 61 to 65
		e8.\>( cis16^\dimmarkup a8. cis16 e2)
		a2.\pp g!8( e
...
% bars 66 to 70
	...
	\repeat tremolo 4 {aes(_\crescmarkup ees\!} \repeat tremolo 4 {aes ees)}
...
% bars 71 to 75
	...
	<gis, e'>1-\tweak extra-offset #'(1.3 . 0.7) \ff
	q16\fz\> q q4.~ q2\!
	gis'8\mf gis4 gis\> gis gis8~
	gis\p gis4 \hairpinShorten #'(-2 . 0) gis\> gis e8\!(
% bars 76 to 80
...
% bars 81 to 85
	...
	a-\offset X-offset #-1.5 \pp( d fis a) a8.( fis16 d4.) r8
...
% bars 86 to 90
	...
	<c, c'>1-\offset X-offset #-1 \ff^>
% bars 91 to 95
	<c' e>\ffz->
	c,16\f\<( e g c)\! c8.-> g16-. c,16(\< e g c)\! c8.-> g16-.
	c1\trill
	<g c e>8 r c16\fz_> c c e, g\fz^> g g c, e\fz^> e e g,
	c8 r r4 r2 \mark \default
% bars 96 to 100
	f4^>---\offset X-offset #-1 ^\sulG aes^>-- f^>-- ees^>--
...
% bars 106 to 110
	...
	<<{d4 \tuplet 3/2 {d4.:8-\tweak extra-offset #'(1.9 . 3.4) _\dimmarkup} d4 \tuplet 3/2 {d4.:8}}\\{\tuplet 3/2 4 {aes8( bes c) c4.:8 aes8( bes c) c4.:8} }>>
	f1\p\>
	f\pp
% bars 111 to 115
	b, \mark \default
...
% bars 121 to 125
	...
	<aes aes'>8( q4-- q---\tweak extra-offset #'(1 . 2) _\crescmarkup q-- q8)
% bars 126 to 130
	<aes ges'>8-\offset X-offset #-1.5 \mf( q4-- q-- q-- q8) 
	gis16( cis e gis gis8.-\tweak extra-offset #'(-1.3 . 3.2) _\dimmarkup e16-.)\! gis,16( cis e gis gis8. e16-.)
...
% bars 141 to 145
	...
	aes aes\< r \once \stemUp bes aes aes r \once \stemUp bes aes aes r \once \stemUp bes aes aes\! r g \mark \default
% bars 146 to 150
	\grace {s8} aes4.\f( c8) bes16\fz bes r aes! g g r bes
	aes4.\<( c8)\! bes16\fz bes r aes g g r bes
	a!8_\piuf( a' bes bes,) a( a' bes bes,)
	a( a') bes\<( aes) g( f ees des\!)
	aes4( \once \stemUp bes aes2)
% bars 151 to 155
	aes4( \hairpinShorten #'(0 . -8) \once \stemUp bes\> aes2)\!
	c4-\offset X-offset #0.5 \p( des c des)
	\hairpinShorten #'(0 . -1.2) c\<( des)\! \hairpinShorten #'(-1.2 . 0) ees8-\tweak extra-offset #'(-3.5 . 0.6) _\dimmarkup\>( des c bes)\!
...
% bars 166 to 170
	r8 <f d'>16 q r8 q16 q r8 <f c'>16 q r8 q16 q
	<f a>2.\ff \tuplet 3/2 {g8-\offset X-offset #-5 _\dimD\>( bes e,)\!} \mark \default
	<f a>1\>~
	<f a>4.\p r8 r2
	a8( c4 a8 f4.\p) r8
% bars 171 to 175
	e4\>( f8) r\! f2\pp(\!
	e1)
	f16-. f( a, f') f-. f( a, f') f-._\crescmarkup f(\! a, f') f-. f( a, f')
	a-.\< a( f a) a-. a( f a) a-. a( f a) a-. a( f a)\!
	c\ff\<( f a c) c8.\!( a16 f8) r r4
% bars 176 to 178
	c,16-\offset X-offset #-0.5 \f( f\< a c) c8.\fz->( a16 f8) r r4
