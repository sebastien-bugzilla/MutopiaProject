...
% bars 6 to 10
		...
		c8.( a16 f8 g16 a) c2
		c,8.->\fz\< d16-. f-. d-. r8 c8.->-\tweak extra-offset #'(-2.2 . 3.4) _\fzmarkup d16-. f-. d-.\! r8
...
% bars 16 to 20
		<< d,,1~^>\fz\> {s2 s-\tweak extra-offset #'(0 . 4.2) _\dimmarkup} >> \mark \default
		d4\! r4 r2
		f2\p( bes,)
		d8-.( d-. d-. d-.) d-.( d-. d-. d-.)
		d'4(~\< d16 e f a) a4(~ a16 g f d)\!
% bars 21 to 25
		c8(-\offset X-offset #1 _\crescD\< f4 a8) c8.( f16-. d4)\!
		c8\f( a f g16 a) c2
		c8\>( aes ees aes16 bes) c2\!
		c8-. aes16( c) c8-. aes16_\diminmarkup( c) c8-. aes16( c) c8-. aes16( c)
		<< dis1\trill {s4\pp\> s s s\!}>> \mark \default
% bars 26 to 30
		e16\fz-. e-. r d-.\p c-.-\offset X-offset #-0.4 \fz c-.\p r b( a8 g! e4)
		a8( g e4) a8( g e4)
...
% bars 41 to 45
		a4 bes!2\sfz(\> f4)\!
		e1\p\>(-\tweak extra-offset #'(4 . -2.5) ^\dimmarkup
		e)\! \mark \default
		a4\ppp--( b--) cis--( b8-. a-.)
		b( fis'16 b, a8-. fis-.) fis2
% bars 46 to 50
		b8( a4\< fis8) e16-. e-. a-. cis-. e4->\!
		\hairpinShorten #'(0 . -2) <d fis>4.\fz\>( <fis, d'>8)\! << {cis'16( e e4.)} \\ { e,2} >>
		a4--\pp( b--) cis8( d16 cis b8 a)
		\tuplet 5/4 {b16( fis' cis b a} fis8) fis-. fis2
		b8( a4\< f!8) e16-! e-! a-! cis-! e4->\!
% bars 51 to 55
		<d fis>4.\f( <fis, d'>8) \hairpinShorten #'(0 . 5) <eis cis'>2\>
		cis'4(\! d e!) d16( b) b8-.
...
% bars 56 to 60
		...
		<d b'>4(\> <g e'>)-\tweak extra-offset #'(0.5 . 3.5) _\dimmarkup <fis d'>8( <d b'>4) <d b'>8\!
		a'8\>( f!4 f8) f( e4 d16 b)\!
		a4\p r r2
% bars 61 to 65
		R1
...
% bars 66 to 70
	...
	<cis, gis'>8\mf r \hairpinShorten #'(0 . 2) <cis fis>\< r <cis e> r <gis dis'>\! r
...
% bars 76 to 80
	...
	gis4( b\f\> a gis)\!
	<<{\repeat tremolo 32 <a, fis'>32\>} {s2-\offset X-offset #-3 \ff s2_\dimmarkup}>>
...
% bars 111 to 115
	f f') \mark \default
	\repeat tremolo 4 {f16(\ppp a} \repeat tremolo 4 {f a)}
	\repeat tremolo 4 {f16( a} \repeat tremolo 4 {f a)}
	\repeat tremolo 4 {f16( a} \repeat tremolo 4 {f a)}
	\repeat tremolo 4 {f16(\< a)} f16( a f c a f a c) 
% bars 116 to 120
	f8\mf( a4 c8)\< d8.( f16-. d4)
	c8(\mf a f8\< g16 a\>) c2
...
% bars 131 to 135
	...
	gis8) e!( \hairpinShorten #'(0 . -8) b\> e16 fis gis2)\!
% bars 136 to 140
	aes16\p-. aes-. f!( aes) aes8 r aes16-.\> aes-. f( aes-.) aes8\! r
	b1\trill\pp \mark \default
	c16-\tweak extra-offset #'(0 . 1) \fp c r bes aes( f) r f f8(\p ees c4)
...
% bars 151 to 155
	f4( g\> f ees8 c)\!
	f1\p~
	\hairpinShorten #'(0 . -2.7) f4\< \hairpinShorten #'(4.3 . 0)  ges2->-\tweak extra-offset #'(3 . 0.5) _\dimmarkup\>( des4)\!
	\hairpinShorten #'(0 . 5) c1\>
...
% bars 166 to 170
	<d, bes'>2 <c a'>~
	q8\ff c'4 f8(~ \hairpinShorten #'(-0.5 . -5) f_\dimD\> a, g4)\! \mark \default
	f2-\offset X-offset #-0.5 _\dolce( a8\> g f d\!)  
	c8( a~ a16\> c a f) d4(~ d16 c f g\!)
	a8( c f d) d4\p( a8) r
% bars 171 to 175
	\hairpinShorten #'(0.6 . -2) c4\>( f,8)\! r8 a2\pp~(
	a2 g)
