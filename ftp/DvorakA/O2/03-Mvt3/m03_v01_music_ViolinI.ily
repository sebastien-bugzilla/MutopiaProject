%Fichier : /media/Documents/Partitions/lilypond/12-Quatuor_1/03_Dvorak_Quatuor_1_Mvt3_Voix1.ly
...
% mesures 1 à 5
	r4 fis''(\f\> e \bar "||" \mark \markup { \musicglyph #"scripts.segno" }
...
% mesures 16 à 20
	...
	e\p d)^\pocoritardando a(
% mesures 21 à 25
	cis2->\pp) b4->~
	b a2->~
	a r4
	\repeat volta 2 {
	    a,4.\p(^\atempo gis16 a b8)[ r16 a-.]
	    a4.( gis16 a b8)[ r16 a-.]
% mesures 26 à 30
...
% mesures 66 à 70
	    a) cis( fis~
	    fis) b,(\> cis
	    e_\dimmarkup^\pocoapocoritmarkup d a)\p
	    cis2\> b4~
	    b\pp a2\>~
% mesures 71 à 75
	    a4\! r r^\fine
...
% mesures 106 à 110
	...
	R2. \bar "||"
% mesures 111 à 115
	d16(\pp^\pocosostenuto a' d a') a2_\leggiero
	d,,16( b' g' b) b2
	d,,16( a' fis' cis') cis2\<
	d,,16( d' g d') d2
	d,,16( d' g d') d2\!
...
% mesures 126 à 130
	e,,16(\p b' e b') b2
	a16\pp^\intempo a a a e e a, a gis' gis a a
...
% mesures 146 à 148
	g8(\p fis e4) g8( fis
	e4) g8( fis e4)
	a8( g)_"D.S. al Fine" fis4\f->( e) \bar "||"
}
