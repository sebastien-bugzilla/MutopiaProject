...
% Bars 191 to 195
	...
	\startVoltaII d8\ff r r \tweak direction #-1 \textEndMark \finemarkup \section \endVolta \break
% Bars 196 to 200
	\repeat volta 2 {
		\removeTimeSignatureEoL \time 3/8 \key des \major \sectionLabel "TRIO" \tempoXoffset #4 \mmrLength #25 R4.*18
% Bars 201 to 205
...
% Bars 296 to 300
	...
	<< a-> {s8 s s\!}>>
	bes4.->\fz
	\hairpinShorten #'(-0.7 . 0) bes4->(\dimD\> bes8
% Bars 301 to 305
	aes!4)\p r8
	aes4\pp\> aes8-.
	aes-.\! r r
