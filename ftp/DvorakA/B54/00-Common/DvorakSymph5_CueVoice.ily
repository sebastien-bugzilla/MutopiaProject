...
cueVoiceCornoIMvtI = \relative c {
	...
	\transpose f c' {
		\relative c {
			\voiceOne f'2\p\<-\offset X-offset -1.5 ^\markup {Fl.}
			g4..( a16)\! \oneVoice
		}
	}
	s2*126
	...
	\transpose f bes {
		\relative c {
			\oneVoice r4^\markup {Cl.} a'''16(-\offset X-offset -2 ^\mp g fis) r
	...
	s2*102
	% bars 497 - 498
	\voiceTwo c,2~-\offset X-offset -1 \p^\markup {Cor.IV}
	c4. r8 \oneVoice
}
cueVoiceCornoIMvtII = \relative c {
	...
	\transpose f c' {
		\relative c {
			\voiceOne r8-\offset X-offset -1 ^\markup {Viol.} r16 e''(-\offset X-offset -1 ^\pp c b)
			a8.( b32 c b16 a)
			gis8( e) r16 e \oneVoice
		}
	}
	...
	\transpose f c' {
		\relative c {
			\voiceOne r8^\markup {Oboe} r16 e''(-\offset X-offset -1.5 ^\pp c b
			a8) r a-. \oneVoice
		}
	}
}
cueVoiceCornoIMvtIII = \relative c {
	...
	\transpose f c' {
		\relative c {
			\voiceTwo ees'16^(\pp-\offset X-offset 0.5 ^\markup {Viol.} d c b c ees
			g f ees d ees g
			bes a g f a bes
	...
	s4.*87
	% bars 266 - 271
	\voiceTwo <ees g>8-\offset X-offset -1.5 \pp(^\markup {Fg.} <g bes>) <f aes>-.
	<ees g>( <g bes>) <f aes>-.
	<ees g>( <g bes>) <f aes>-.
	<ees g>( <g bes>) <f aes>-.
	<ees g>( <g bes>) <f aes>-.
...
cueVoiceCornoIMvtIV = \relative c {
	...
	s1*56
	% bars 147 - 154
	\voiceTwo r2^\markup {Trbni I,II} bes'->-\offset X-offset -1.5 \f
	bes'-> r
...
cueVoiceCornoIIMvtI = \relative c {
	...
	s2*13
	% bars 82 - 83
	\voiceOne r8^\markup {Cor.I.} ees'4->-\offset X-offset -1.5 ^\fz r8
	...
	\transpose f bes {
		\relative c {
			\oneVoice r4 a'''16(-\offset X-offset -2 ^\mp^\markup {Cl.} g fis) r
			fis( e d) r d( a fis) r \oneVoice
		}
	}
	s2*44
...
cueVoiceCornoIIMvtII = \relative c {
	...
	s4.*55
	% bars 70 - 75
	\voiceOne d4.->-\offset X-offset #-1.5 ^\fp^\markup {Cor.I.}
	a4~ a16. fis32
	fis4.->~
	fis4 gis8(
	a4.~
	...
	s4.*37
	% bars 183 - 184
	\voiceOne e4.->-\offset X-offset -2 ^\pp-\offset X-offset -3 ^\markup {Cor.I.}
	b4~ b16 gis \oneVoice
	s4.*9
	% bars 194 - 197
...
cueVoiceCornoIIMvtIII = \relative c {
	...
	\transpose f c' {
		\relative c {
			\voiceTwo ees'16^(-\offset X-offset -2 \pp-\offset X-offset 0.5 ^\markup {Viol.} d c b c ees
			g f ees d ees g
			bes a g f a bes
			\voiceOne c d ees f g a) \oneVoice
		}
	...
	f8) c-. f-.
	a-. f-. a-.
	\voiceOne f'[-.-\offset X-offset -1 ^\fp^\markup {Cor.I.} r d-.]
	c4.~
	c8 r r \oneVoice
	s4.*9
	% bar 191
	<>-\offset X-offset -1.5 ^\markup {Cor.I.}
	s4.*31
	% bars 222 - 223
	\voiceOne r8. d16-.-\offset X-offset -1 ^\p^\markup {Cor.I.} des8-.
	des8-> r r \oneVoice
	s4.*3
	% bars 227 - 231
	\voiceOne r8. c16-.-\offset X-offset -2 ^\pp^\markup {Cor.I.} c8-.
	c4 r8
	r8. ees16 ees8
	ees8[ r16 c c8]
	c4. \oneVoice
	...
	s4.*28
	% bars 266 - 271
	\voiceTwo <ees, g>8-\offset X-offset -2 \pp(^\markup {Fg.} <g bes>) <f aes>-.
	<ees g>( <g bes>) <f aes>-.
	<ees g>( <g bes>) <f aes>-.
	<ees g>( <g bes>) <f aes>-.
	<ees g>( <g bes>) <f aes>-.
	...
	s4.*29
	% bars 301 - 302
	\voiceOne r8. ees'16-.-\offset X-offset -1 ^\p^\markup {Cor.I.} ees8-.
	ees4. \oneVoice
}
cueVoiceCornoIIMvtIV = \relative c {
	s1*5 s2*1 s1*32
	% bars 39 - 42
	\voiceOne d''1^\fz-\offset X-offset -4.5 ^\markup {Cor.I.}
	d->^\fp~
	d~-\dimmarkup
	d
	s1*46
	...
	s1*10
	% bars 165 - 166
	\voiceOne r8.^\markup {Fg.Vla.} c16(-\offset X-offset -0.5 ^\p des2.)
	d!( ces4)
	<>^\markup {Cor.III.IV.}
	s1*4
	% bar 171
	...
	\transpose f c' {
		\relative c {
			\voiceOne \stemDown eis''8(-\offset X-offset -2 ^\ff^\markup {Viol.} fis16) r gis8( a16) r b8( c16) r \set stemLeftBeamCount = 0 d8[ s] \oneVoice \stemNeutral
		}
	}
	s1*14
	% bar 228
...
cueVoiceCornoIIIMvtI = \relative c {
	...
	\transpose f c' {
		\relative c {
			\oneVoice \clef bass f4(^\pp-\offset X-offset -3.5 ^\markup {\column {\lower #1.5 "Vc." "Cb."}} a16 g f8)
			f4( e8) r
			f4( a16 g f8)
	...
	\transpose f bes  {
		\relative c {
			\voiceOne d''2~-\offset X-offset -1 ^\fz^\markup {Cl.}
			d8 r b-. r
			\voiceTwo gis-. r e-. r
			d-. r e8. b16 \oneVoice
		}
	...
	\transpose f c' {
		\relative c {
			\voiceOne g''2-\offset X-offset -1 ^\p^\markup {Fl.}
			a4..( b16)
			<< b2~\< {s8 s s s\!}>>
			b4.\> r8\! \oneVoice
		}
	...
	s2*101
	% bars 401 - 402
	\voiceOne b2->-\offset X-offset -1.5 ^\f^\markup {Cor.I.}
	e-> \oneVoice
	s2*28
	% bars 431 - 435
	\voiceTwo \stemUp g,,2~\f^\markup {Cor.IV.}
	g
	g~
	g~
	g4 r \oneVoice \stemNeutral
}
cueVoiceCornoIIIMvtII = \relative c {
	...
	s4.*62
	% bars 140 - 141
	\voiceOne b'4.~^\pp-\offset X-offset -4.5 ^\markup {Cor.I.}
	b8 r r \oneVoice
	s4.*3
	% bar 145
	\voiceOne b8.^\f-\offset X-offset -4.5 ^\markup {Cor.I.} cis16~ cis8 \oneVoice
	s4.*47
	% bars 193 - 197
	\voiceTwo e,4.~\pp^\markup {Cor.IV.} 
	e8 r r
	\voiceOne b'8(-\offset X-offset -3.5 ^\markup {Cor.I.} cis dis16 e
	b8 cis dis16 e
	b8) r r \oneVoice
}
cueVoiceCornoIIIMvtIII = \relative c {
	...
	s4.*11
	% bar 77
	\voiceOne e''8-.-\offset X-offset -1.5 ^\mf^\markup {Cor.I.} b-. e-. \oneVoice
	s4.*1
	% bar 79
	<>^\markup {Archi}
	s4.*4
	...
	s4.*65
	% bar 159
	<>-\offset X-offset -1 ^\markup {Cor.IV.}
	s4.*45
	% bars 204 - 205
	...
	s4.*21
	% bars 227 - 229
	\voiceOne r8. c16-.-\offset X-offset #-1 ^\pp-\offset X-offset 1 ^\markup {Cor.I.} c8-.
	c4 r8
	...
	s4.*30
	% bars 272 - 275
	\voiceOne r8. des16-.-\offset X-offset #-1.5 ^\pp^\markup {Cor.I.} des8-.
	des4 r8
	r8. des16-. des8-.
	des4 r8 \oneVoice
	s4.*1
...
cueVoiceCornoIIIMvtIV = \relative c {
	...
	s1*1
	% bar 156
	\voiceOne r8. b16[(-\offset X-offset -1 ^\mp^\markup {Cor.I.} c8.) d16] b4( c) \oneVoice
	s1*8
	% bars 165 - 166
	\voiceOne r8.-\offset X-offset -1 ^\markup {Fg.} c16(^\p des2.)
	d!( ces4)
	s1*10
	% bar 177
	<>-\offset X-offset -2.8 ^\markup {Cor.I.}
}
cueVoiceCornoIVMvtI = \relative c {
	...
	s2*36
	% bar 59
	\voiceOne r8 dis''-.^\mf-\offset X-offset -6 ^\markup {Cor.III.} b-. cis-. \oneVoice
	s2*13
	% bars 73 - 76
	\transpose f c' {
		\relative c {
			\voiceOne \stemDown \clef bass f4(-\offset X-offset -2 ^\pp^\markup {Vlc.Cb.} a16 g f8)
			f4( e8) r
			f4( a16 g f8)
			f4( e8) r \clef treble \oneVoice \stemNeutral
		}
	}
	s2*27
	% bar 104
	...
	\transpose f c' {
		\relative c {
			\voiceOne \stemDown e''2~-\offset X-offset -1.5 ^\fz^\markup {Viol.}
			e8. cis16( a cis e g)
			g2->~
			g8. e16( cis e g cis) \oneVoice \stemNeutral
		}
	}
	s2*41
	% bars 298 - 299
...
cueVoiceCornoIVMvtII = \relative c {
	s4.*12
	% bars 13 - 14
	\voiceOne b''4(^\p-\offset X-offset -4.6 ^\markup {Cor.I.} cis8
	d4.) \oneVoice
	s4.*36
	% bar 51
	<>^\markup {Cor.III.}
	...
	s4.*6
	% bar 70
	\voiceTwo \stemUp d,4.->\fp^\markup {Cor.III.} \oneVoice \stemNeutral
	s4.*5
	% bars 76 - 77
	\voiceTwo \stemUp b4.~\fp^\markup {Cor.II.}
	b8\< b\> b\! \oneVoice \stemNeutral
	s4.*2
	% bar 80
	...
	s4.*39
	% bar 145
	\voiceOne b8.^\f-\offset X-offset -4.2 ^\markup {Cor.I.} cis16~ cis8 \oneVoice
	s4.*18
	% bars 164 - 167
	\voiceOne a32-.\fp-\offset X-offset 0.5 ^\markup {Cor.III.} c-. c-. c-. c4:32
	c4.:
	b:^\markup {Cor.II.}
	b8: cis4: \oneVoice
	s4.*15
	...
	s4.*8
	% bars 191 - 192
	\voiceOne b4-\offset X-offset -1.5 ^\pp^\markup {Cor.I.} b8~
	b4 b8\laissezVibrer
}
cueVoiceCornoIVMvtIII = \relative c {
	...
	s4.*14
	% bars 59 - 60
	\voiceOne c''4->-\offset X-offset -1.7 ^\pp^\markup {Cor.III.} c8-. 
	c4 r8 \oneVoice
	s4.*5
	% bar 66
	<>^\markup {Viol.I.}
	...
	s4.*4
	% bar 83
	\voiceOne cis4->-\offset X-offset -1.5 ^\p^\markup {Cor.I.} cis8 \oneVoice
	s4.*9
	% bar 93
	\voiceTwo \stemUp  b,4^\markup {Fg.} fis16( ais) \oneVoice \stemNeutral
	<>^\markup {Cor.I.}
	s4.*5
	% bars 99 - 102
	...
	s4.*13
	% bar 227
	<>-\offset X-offset -1 ^\markup {Cor.I.}
	s4.*11
	% bars 238 - 241
	\voiceOne b'!4.~^\p^\markup {Cor.I.}
	b8[ r16 b-. b8-.]
	...
	<ees g>( <g bes>) <f aes>-.
	<ees g> r r
	\voiceOne r8.^\markup {Cor.III.IV.} <bes' des>16-.-\offset X-offset -1 ^\pp q8-.
	q4 r8
	r8. q16-. q8-.
	q4 r8 \oneVoice
	s4.*9
...
cueVoiceCornoIVMvtIV = \relative c {
	...
	s1*59
	% bar 102 - 104
	\voiceOne des'2.-\offset X-offset -1 ^\pp^\markup {Cor.I.} des8-. des-.
	des2( d4 ees)
	des4( c2.)
	s1*42
	% bars 147 - 154
	...
	s1*1
	% bar 156
	\voiceOne r8. <gis b>16[(^\mp^\markup {Cor.I.II.} <a c>8.) <b d>16] <gis b>4( <a c>) \oneVoice
	s1*8
	% bars 165 - 166
	\voiceOne r8.-\offset X-offset -2 ^\markup {\column { \lower #1.5 "Fg." "Vla."}} c16(^\p des2.)
	d!( ces4) \oneVoice
	s1*10
	% bars 177 - 178
	...
	s1*32
	% bars 211 - 212
	\voiceTwo r2 r4^\markup {Trbn.} r8. <a, dis fis>16-\offset X-offset -1.5 \f
...
cueVoiceTrombonoIMvtI = \relative c {
	s2*41
	% bars 42 - 43
	\voiceTwo r4 \tuplet 3/2 4 {c8-\offset X-offset -1 \mf^\markup {Trbn.III.} d e
	f dis e} s4 \oneVoice
	s2*29
	% bars 73 - 76
	\voiceOne \clef bass f4(-\offset X-offset -1 ^\pp^\markup {Vc.Cb.} a16 g f8)
	f4( e8) r
	f4( a16 g f8)
	...
	\transpose c bes, {
		\relative c {
			\voiceOne \clef treble r4 a'''16(-\offset X-offset -2 ^\markup {Cl.} g fis) r
	...
	\transpose c f {
		\relative c {
			\voiceOne \clef treble \tuplet 3/2 4 {\cutBeamEachBeat g''8(\p-\offset X-offset -3.5 ^\markup {Trbe.} a b~ b a g~
			g a b~ b a g~)} \revertCutBeam
			g( a4 b8~
			b a4 g8)
			c2~
	...
	\transpose c a, {
		\relative c {
			\voiceOne \clef treble fes''2->~-\offset X-offset -1.5 ^\p^\markup {Cl.}
			fes8. ces16( aes ces fes aes)
			aes2-\offset X-offset -1 ^\fz~
	...
	\transpose c f {
		\relative c {
			\voiceOne \clef treble f'8(\f-\offset X-offset -2.5 ^\markup {Cor.} c'4 f,8)~
			f bes4( f8)~
			f bes4( g8)
			f d'4( bes8)
	...
	\transpose c f {
		\relative c {
			\voiceOne \stemDown \clef treble b''8.->-\offset X-offset -1.3 ^\p-\offset X-offset -1 ^\markup {Cor.I.} g16 c8.-> a16
			d8.-> b16 f'8.-> c16
			f8.-> c16 f8.->^\fz c16
			f8-. r \clef alto \stemNeutral
		}
	} \voiceTwo \tuplet 3/2 4 {c,,8-.->^\markup {Trbn.III.} d-. e-.
	f-. dis-. e-. f[-. g-. s]} \oneVoice
	s2*83
	% bars 455 - 456
	\clef treble \voiceTwo f'4(-\offset X-offset 1.5 ^\markup {Viol.} fis)
...
cueVoiceTrombonoIMvtII = \relative c {
	s4.*54
	% bars 55 - 56
	\clef treble \voiceOne \stemDown r8^\markup {Fl.} r16 e'''(-\offset X-offset -1.5 ^\pp c b
	a8) r a-. \clef alto \oneVoice \stemNeutral
	s4.*59
	% bars 116 - 122
	\voiceOne \stemDown \clef treble f'4.->-\offset X-offset -1.5 ^\fz^\markup {Fl.}
	d4~ d16 bes
	bes4.(
	a8 bes c)
	b!( c d)
	c( d ees)
	d( ees f) \oneVoice \clef alto \stemNeutral
	s4.*29
	% bars 152 - 155
	\transpose c f {
		\relative c {
			\voiceOne \clef treble r8^\markup {Cor.III.} r b''~
			b4.
			d4~ d16 b
	...
	\transpose c f {
		\relative c {
			\voiceOne \clef treble \noteHeadEsw #'(-3 . 0) a''32-.-\offset X-offset -1 ^\fp^\markup {Cor.III.} \revertNoteHeadEsw c-. c-. c-.  c-. c-. c-. c-.  c-. c-. c-. c-.
	...
	\transpose c f {
		\relative c {
			\voiceOne \clef treble b''8(-\offset X-offset -1 ^\pp^\markup {Cor.I.} cis dis16 e
			b8 cis dis16 e
			b8 cis dis16 e
...
cueVoiceTrombonoIMvtIII = \relative c {
	...
	s4.*8
	% bar 53
	<>-\offset X-offset -2 ^\markup {\column {\lower #1.5 "Cl." "Fl."}}
	s4.*8
	% bar 61
	<>^\markup {Cl.}
	s4.*5
	...
	s4.*7
	% bars 84 - 85
	\clef treble \voiceOne fis'''8->-\offset X-offset -2.5 ^\markup {Fl.} b,-. fis'-.
	...
	s4.*5
	% bars 99 - 102
	\voiceOne \clef bass r8-\offset X-offset -5 ^\markup {Cor.III.} e'8-.-\offset X-offset -1 ^\f e,-.
	e'-. e,-. r
	r e'-. e,-.
	...
	s4.*57
	% bars 176 - 180
	\voiceOne bes'4(-\offset X-offset -1.5 ^\pp^\markup {Viola} f16 a
	bes8) f-. bes-.
	d-. bes-. d-.
	bes'16(-> a g fis g8)
	f!8 r r \oneVoice
	s4.*57
	% bars 238 - 241
	\clef treble \voiceOne r8.-\offset X-offset -1 ^\markup {Fl.Cl.} <aes ces>16-. q8-.
	q4.~
	q8[ r16 q-. q8-.]
	q( <ces! ees!>) <bes! des>-. \clef alto \oneVoice
	s4.*20
	% bars 262 - 265
	\clef bass \voiceOne c,8-\offset X-offset -1 ^\p(-\offset X-offset -2 ^\markup {Fg.} ees) des-.
	\clef treble c'(^\p^\markup {Cl.} ees) des-.
	c'(-\offset X-offset -1 ^\pp-\offset X-offset -1.5 ^\markup {Fl.} ees) des-.
...
cueVoiceTrombonoIMvtIV = \relative c {
	...
	s1*38
	% bars 131 - 134
	\voiceOne f'2..->-\offset X-offset -1.8 ^\ff^\markup {Cor.III.IV.} f8
	e2..-> e8
	f4.-> f8 e4.-> e8
	f1-^ \oneVoice
	s1*30
	...
	s1*14
	% bars 191 - 194
	\voiceOne \noteHeadEsw #'(-1.5 . 0) g2..->-\offset X-offset -1.5 ^\f^\markup {Cor.III.IV.} \revertNoteHeadEsw g8
	fis2..-> fis8
	g4-> fis-> g-> a->
	\transpose c f {
		\relative c {
			\clef treble a'8-.-\offset X-offset -1.5 ^\f^\markup {Trbe.I.II.} d16-. f-. a4~ a8 f-. d-. f-. \oneVoice \clef alto
		}
	}
	s1*33
	% bar 228
	<>-\offset X-offset -3.5 ^\markup {Viol.I.}
	s1*72
	% bars 300 - 303
	\voiceOne \stemDown \clef treble a'2.->-\offset X-offset -1.5 ^\fp^\markup {Fl.} a4
	aes2.^\pp aes4
	g2( d'4 c
	bes a g f) \clef alto \oneVoice \stemNeutral
	s1*18
	% bar 322
	<>^\markup {\center-column {\lower #1.5 "Archi,Legni" "Cor."}}
	s1*16
	% bars 338 - 341
	\voiceOne \stemDown \clef treble c'2.^\markup {Fl.} c4~
	c c-.( a-. c-.)
	f2.-> c4~
	c a-.( f-. a-.) \clef alto \oneVoice \stemNeutral
	s1*7
	% bar 349
	<>-\offset X-offset -1 ^\markup {Cor.}
	s1*19
	% bars 368 - 371
	\voiceOne \clef treble r2-\offset X-offset -1 ^\markup {\column {\lower #1.5 "Ob.I" "     II."}} a8(^\f g16 f e8 f)
	r2 a8( g16 f e8 f)
	r2 a8( g16 f e8 f)
	a1 \clef alto
}
cueVoiceTrombonoIIMvtI = \relative c {
	...
	\transpose c bes, {
		\relative c {
			\voiceOne \clef treble r4^\markup {Cl.} a'''16(-\offset X-offset -0.5 ^\mp g fis) r
	...
	\transpose c f {
		\relative c {
			\voiceOne \clef treble \tuplet 3/2 4 {\cutBeamEachBeat g''8(\p-\offset X-offset -4 ^\markup {Trbe.I.} a b~ b a g~
			g a b~ b a g~)} \revertCutBeam
			g( a4 b8~
			b a4 g8)
			\voiceOne c2~
	...
	\transpose c f {
		\relative c {
			\voiceOne \clef treble f'8(\f-\offset X-offset -2 ^\markup {Cor.} c'4 f,8)~
			f bes4( f8)~
			f bes4( g8)
			f d'4( bes8)
	...
	\transpose c f {
		\relative c {
			\voiceOne \stemDown \clef treble b''8.->\p^\markup {Cor.I.} g16 c8.-> a16
			d8.-> b16 f'8.-> c16
			f8.-> c16 f8.->^\fz c16
			f8-. r \clef tenor \stemNeutral
		}
	} \voiceTwo \tuplet 3/2 4 {c,8-.->-\offset X-offset -1.5 \f^\markup {Trbn.III.} d-. e-.
	f-. dis-. e-.} s4 \oneVoice
	s2*83
	% bars 455 - 456
	\clef treble \voiceTwo f'4(-\offset X-offset 1.2 ^\markup {Viol.} fis)
...
cueVoiceTrombonoIIMvtII = \relative c {
	s4.*54
	% bars 55 - 56
	\clef treble \voiceOne \stemDown r8^\markup {Fl.} r16 e'''(-\offset X-offset -1.2 ^\pp c b
	a8) r a-. \clef tenor \oneVoice \stemNeutral
	s4.*59
	% bars 116 - 122
	\voiceOne \stemDown \clef treble f'4.->-\offset X-offset -1.5 ^\fz^\markup {Fl.}
	d4~ d16 bes
	...
	b!( c d)
	c( d ees)
	d( ees f) \oneVoice \stemNeutral \clef tenor
	s4.*20
	% bar 143
	<>-\offset X-offset #-2 ^\markup {\column {\lower #1.5 "Fl." "Ob."}}
	s4.*9
	% bar 152
	<>^\markup {Cor.}
	s4.*4
	...
	\transpose c f {
		\relative c {
			\voiceOne \clef treble b''8(-\offset X-offset -1.5 ^\pp^\markup {Cor.I.} cis dis16 e
			b8 cis dis16 e
			b8 cis dis16 e
...
cueVoiceTrombonoIIMvtIII = \relative c {
	...
	s4.*13
	% bars 99 - 102
	\voiceOne \clef bass r8^\markup {Cor.III.} e,,8-.-\offset X-offset -1 ^\f e,-.
	e'-. e,-. r
	r e'-. e,-.
	...
	s4.*10
	% bar 124 - 126
	\voiceOne \clef bass r8^\markup {Fg.} r f'16(-\offset X-offset -1 ^\f ees
	d c bes a g f
	...
	s4.*5
	% bars 176 - 180
	\voiceOne bes'4(-\offset X-offset -1 ^\pp^\markup {Viola} f16 a
	bes8) f-. bes-.
	d-. bes-. d-.
	bes'16(-> a g fis g8)
	f!8 r r \oneVoice
	s4.*57
	% bars 238 - 241
	\clef treble \voiceOne r8.^\markup {Fl.Cl.} <aes ces>16-.-\offset X-offset -1 ^\p q8-.
	q4.~
	q8[ r16 q-. q8-.]
	...
	% bars 262 - 265
	\clef bass \voiceOne c,8-\offset X-offset -1 ^\p(-\offset X-offset -2 ^\markup {Fg.} ees) des-.
	\clef treble c'(-\offset X-offset -1 ^\p^\markup {Cl.} ees) des-.
	c'(-\offset X-offset -1.5 ^\pp-\offset X-offset -1.5 ^\markup {Fl.} ees) des-.
	c,(^\markup {Ob.} ees) des-. \oneVoice
	<>^\markup {Fg.}
	s4.*6
	% bar 272
	<>-\offset X-offset -2 ^\markup {\column {\lower #1.5 "Cl." "Cor."}}
	s4.*3
	% bars 275 - 276
...
cueVoiceTrombonoIIMvtIV = \relative c {
	...
	s1*24
	% bars 67 - 68
	\voiceOne bes'1->-\offset X-offset -1 \ff^\markup {Trbn.I.}
	b-> \oneVoice
	s1*24
	% bar 93
	<>^\markup {Clar.}
	s1*38
	% bars 131 - 134
	\voiceOne f'2..->-\offset X-offset -1.7 ^\ff^\markup {Cor.III.IV.} f8
	e2..-> e8
	f4.-> f8 e4.-> e8
	f1-^ \oneVoice
	s1*30
	...
	\transpose c f {
		\relative c {
			\clef treble \voiceOne \noteHeadEsw #'(-1.5 . 0) d''2..->-\offset X-offset -1.5 -\tweak extra-offset #'(0.5 . 0) ^\f^\markup {Cor.III.IV.} \revertNoteHeadEsw d8
			cis2..-> cis8
			d4-> cis-> d-> e->
			\voiceTwo \clef treble a,,8-.-\offset X-offset -1.7 \f^\markup {Trbe.I.II.} d16-. f-. a4~ a8 f-. d-. f-. \oneVoice \clef tenor
		}
	}
	s1*33
	% bar 228
	...
	s1*41
	% bars 269 - 270
	\voiceOne bes,!1-\offset X-offset -1 \ff^\markup {Tbrn.I.}
	b\ffz \oneVoice
	s1*29
	% bars 300 - 303
	\voiceOne \stemDown \clef treble a''2.->-\offset X-offset -1.7 ^\fp^\markup {Fl.} a4
	aes2.^\pp aes4
	g2( d'4 c
	bes a g f) \clef tenor \oneVoice \stemNeutral
	s1*34
	% bars 338 - 341
	\voiceOne \stemDown \clef treble c'2.-\offset X-offset 0.5 ^\pp^\markup {Fl.} c4~
	c c-.( a-. c-.)
	f2.-> c4~
	c a-.( f-. a-.) \clef tenor \oneVoice \stemNeutral
	s1*7
	% bar 349
	<>^\markup {Corni}
	s1*19
	% bars 368 - 371
	\voiceOne \clef treble r2-\offset X-offset -2 ^\markup {Ob.I.II.} a8(^\f g16 f e8 f)
	r2 a8( g16 f e8 f)
	r2 a8( g16 f e8 f)
	a1 \clef tenor
	s1*8
...
cueVoiceTrombonoIIIMvtI = \relative c {
	...
	s2*30
	% bars 73 - 76
	\voiceOne f4(-\offset X-offset -1 ^\pp^\markup {Vc.Cb.} a16 g f8)
	f4( e8) r
	f4( a16 g f8)
	f4( e8) r \oneVoice
	s2*60
	...
	\transpose c f {
		\relative c {
			\voiceTwo \clef treble <d' gis b>2-\offset X-offset 0.5 \p~^\markup {Cor.III.IV.}
	...
	\transpose c f {
		\relative c {
			\voiceOne \clef treble \tuplet 3/2 4 {\cutBeamEachBeat g''8(\p-\offset X-offset -3 ^\markup {Trbe.I.} a b~ b a g~
			g a b~ b a g~)} \revertCutBeam
			g( a4 b8~
			b a4 g8)
			\voiceOne c2~
	...
	s2*28
	% bars 223 - 226
	\clef treble \voiceTwo g'2-\offset X-offset 0.5 \p^\markup {Fl.}
	a4..( b16)
	b2~
	...
	\transpose c f {
		\relative c {
			\voiceOne \clef treble f'8(\f-\offset X-offset -3.5 ^\markup {Cor.I.} c'4 f,8)~
			f bes4( f8)~
			f bes4( g8)
			f d'4( bes8)
			d( f4 ees8) \clef bass
	...
	\transpose c f {
		\relative c {
			\voiceOne \stemDown \clef treble b''8.->-\offset X-offset -1.5 ^\p^\markup {Cor.I.II.} g16 c8.-> a16
			d8.-> b16 f'8.-> c16
			f8.-> c16 f8.->^\fz c16
			\stemUp f8-. r \clef bass s4 \stemNeutral
		}
	}
	s2*84
	% bars 455 - 456
	\clef treble \voiceTwo f'4(\mf-\offset X-offset 1.2 ^\markup {Viol.} fis)
...
cueVoiceTrombonoIIIMvtII = \relative c {
	...
	% bars 55 - 56
	\clef treble \voiceOne \stemDown r8^\markup {Fl.} r16 e'''(-\offset X-offset -1.5 ^\pp c b
	a8) r a-. \clef bass \oneVoice \stemNeutral
	s4.*1
	% bar 58
	<>-\offset X-offset -4 ^\markup {Ob.}
	s4.*58
	% bars 116 - 122
	\voiceOne \stemDown \clef treble f'4.->-\offset X-offset -2 ^\fz^\markup {Fl.}
	d4~ d16 bes
	bes4.(
	a8 bes c)
	b!( c d)
	c( d ees)
	d( ees f) \oneVoice \clef bass \stemNeutral
	s4.*20
	% bar 143
	<>^\markup {\column {\lower #1.5 "Fl." "Ob."}}
	s4.*9
	% bar 152
	<>^\markup {Cor.}
	s4.*4
	...
	\transpose c f {
		\relative c {
			\voiceOne \clef treble a''32-.\fp-\offset X-offset 0.5 ^\markup {Cor.III.} c-. c-. c-.  c-. c-. c-. c-.  c-. c-. c-. c-.
			c-. c-. c-. c-.   c-. c-. c-. c-.  c-. c-. c-. c-.
			b-.^\markup {Cor.II.} b-. b-. b-.  b-. b-. b-. b-.  b-. b-. b-. b-.
...
cueVoiceTrombonoIIIMvtIII = \relative c {
	...
	s4.*8
	% bar 53
	<>-\offset X-offset -1.5 ^\markup {\column {\lower #1.5 "Cl." "Fl."}}
	s4.*8
	% bar 61
	<>^\markup {Cl.}
	s4.*5
	...
	s4.*13
	% bars 99 - 102
	\voiceOne r8^\markup {Cor.III.} e,,8-.-\offset X-offset -2 ^\f e,-.
	e'-. e,-. r
	r e'-. e,-.
	e'-. e,-. r \oneVoice
	<>^\markup {Trbe}
	...
	s4.*10
	% bar 124 - 126
	\voiceOne r8^\markup {Fg.} r f'16(-\offset X-offset -1 ^\f ees
	d c bes a g f
	ees d c bes a f)
	s4.*49
	% bars 176 - 180
	...
	s4.*20
	% bars 262 - 265
	\voiceOne c,8-\offset X-offset -1 ^\p(-\offset X-offset -1 ^\markup {Fg.} ees) des-.
	\clef treble c'(-\offset X-offset -1 ^\p^\markup {Cl.} ees) des-.
	c'(-\offset X-offset -1.5 ^\pp-\offset X-offset -1.5 ^\markup {Fl.} ees) des-.
	c,(^\markup {Ob.} ees) des-. \oneVoice
	<>^\markup {Fg.}
	s4.*5
	% bars 271 - 276
	\voiceOne r8-\offset X-offset -2 ^\markup {Viol.II.} aes( a
	bes) bes( b
	c) c\(( des)
	d( ees)\) e[(
	...
	des!4 r8
	r8. des!16-. des8-.
	<>^\markup {\column {\lower #1.5 "Corni." "Cl.Fg."}}
}
cueVoiceTrombonoIIIMvtIV = \relative c {
	...
	s1*38
	% bars 131 - 134
	\voiceOne \clef tenor f'2..->-\offset X-offset #-2 ^\ff^\markup {Cor.III.IV.} f8
	e2..-> e8
	f4.-> f8 e4.-> e8
	f1-^ \oneVoice \clef bass
	s1*30
	% bars 165 - 166
	\voiceOne \clef tenor r8.^\markup {Fg.Vle.} f16-\offset X-offset #-1.5 ^\f( ges2.)
	g!2.( fes4) \clef bass
	s1*10
	% bar 177
	<>-\offset X-offset -1.5 ^\markup {\column { \lower #1.5 "Fl." "Cl."}}
	s1*14
	% bars 191 - 194
	\transpose c f {
		\relative c {
			\clef treble \voiceOne \noteHeadEsw #'(-1.5 . 0) d''2..->-\offset X-offset -1.5 ^\f^\markup {Cor.III.IV.} \revertNoteHeadEsw d8
			cis2..-> cis8
			d4-> cis-> d-> e->
			\voiceTwo \clef treble a,,8-.-\offset X-offset -1.8 \f^\markup {Trbe.I.II.} d16-. f-. a4~ a8 f-. d-. f-. \oneVoice \clef bass
		}
	}
	s1*33
	% bar 228
	...
	s1*38
	% bars 338 - 341
	\voiceOne \stemDown \clef treble c''2.-\offset X-offset 0.5 ^\pp-\offset X-offset 0.5 ^\markup {Fl.} c4~
	c c-.( a-. c-.)
	f2.-> c4~
	c a-.( f-. a-.) \clef bass \oneVoice \stemNeutral
	s1*7
	% bar 349
	<>^\markup {Corni}
	s1*19
...
cueVoiceTimpaniMvtI = \relative c {
	s2*81
	% bars 82 - 87
	\voiceOne r4^\markup {Trbni} <des f aes>8->-\offset X-offset -1.5 ^\fz r
	r4 <c ees aes>8-> r
	r4 q8 r
	r4 <ces ees aes>8 r
	r4 <b! b'! d!>8-> r
	...
	s2*16
	% bars 104 - 110
	\voiceOne r4^\markup {Cor.III.} b'8-\offset X-offset -1 ^\p cis
	d2
	d4.( cis8)
	d2
	d4.( cis8)
	...
	\transpose c bes, {
		\relative c {
			\clef treble \voiceOne r4 a'''16(-\offset X-offset -1.5 ^\markup {Cl.} g fis) r
			fis( e d) r d( a fis) r \clef bass \oneVoice
		}
	}
	s2*32
	% bars 171 - 176
	\voiceOne d2-^~-\offset X-offset -1.5 ^\f^\markup {Trbn.}
	d4 c-> 
	a-> fis->
	d-> a8. d16
	fis2^\p^\>~
	...
	s2*50
	% bars 227 - 228
	\voiceOne \noteHeadEsw #'(-1.5 . 0) <e g b>2-\offset X-offset -1 ^\pp^\markup {Trbni} \revertNoteHeadEsw
	<d fis d'> \oneVoice
	s2*44
	% bars 273 - 276
	\voiceOne ees4->-\offset X-offset -1.7 ^\ff^\markup {Trbni} ees8.-> bes16-.
	ees4-> r
	<cis gis' cis>2~
	q8 r r4 \oneVoice
	s2*26
	% bars 303 - 304
	\voiceOne ees8->-\offset X-offset -1.8 ^\ff^\markup {Trbni} g-> bes-> b->
	c-> ces-> bes-> aes-> \oneVoice
	s2*98
	% bars 403 - 405
	\voiceOne e2->-\offset X-offset -1.5 ^\fz-\offset X-offset -1 ^\markup {Cor.III.IV.}
	a->^\fz
	r8 e'4.-\offset X-offset -1 ^\f \oneVoice
	s2*43
	% bars 449 - 454
	\voiceOne c8(-\offset X-offset -1 ^\pp^\markup {Cor.I.} g'4 c,8)
	c( g'4 c,8)
	c( f4 c8)
	c( f4 bes,8)
	c2~
...
cueVoiceTimpaniMvtII = \relative c {
	s4.*24
	% bars 25 - 28
	\voiceOne e4.(~-\offset X-offset -0.8 ^\f-\offset X-offset 0.8 ^\markup {Fg.}
	e8 f16) r f'16.( e32)
	dis4 e16( d)
	d8( c b16 a) \oneVoice
	s4.*16
	...
	s4.*27
	% bars 74 - 75
	\voiceOne \stemDown \clef treble fis''4.-\offset X-offset -3 ^\pp^\markup {Viol.I.}
	d4(~ d16. cis32) \oneVoice \clef bass \stemNeutral
	s4.*40
	% bars 116 - 118
	\voiceOne \stemDown \clef treble f4.->-\offset X-offset -1.5 ^\fz^\markup {Fl.}
	d4(~ d16 bes-.)
	bes4.\laissezVibrer \oneVoice \clef bass \stemNeutral
	s4.*37
	% bars 156 - 158
	\voiceOne c,,4(-\offset X-offset -1 ^\p^\markup {Trbni} cis8)
	d16.( bes32 c!8 a16 d)
...
cueVoiceTimpaniMvtIII = \relative c {
	s4.*105
	% bars 106 - 110
	\clef treble \voiceOne \stemDown c'''16(-\offset X-offset -1.5 ^\fz^\markup {Viol.} b! a gis a c)
	d( c! b! ais b d)
	e!(-> d! c! b! c e)
	f(-> e! d cis d e) \clef bass \oneVoice \stemNeutral
	s4.*66
	% bars 176 - 180
	\clef alto \voiceOne bes,,4(-\offset X-offset -1.5 ^\pp^\markup {Viola} f16 a
	bes8) f-. bes-.
	d-. bes-. d-.
	bes'16(-> a g fis g8)
	f!8 r r \clef bass
	s4.*85
	% bars 266 - 271
	\voiceOne <aes, c>8(-\offset X-offset -1.5 ^\pp^\markup {Fg.} <c ees>) <bes des>-.
	<aes c>( <c ees>) <bes des>-.
	<aes c>( <c ees>) <bes des>-.
	<aes c>( <c ees>) <bes des>-.
	<aes c>( <c ees>) <bes des>-.
...
cueVoiceTriangoloMvtIII = \relative c {
	s4.*65
	% bars 66 - 69
	\voiceOne ees'16(\pp-\offset X-offset 0.5 ^\markup {Viol.} d c b c ees
	g f ees d ees g
	bes a g f a bes
	c d ees f g a) \oneVoice
	s4.*7
	% bar 77
	\voiceOne a8->-\offset X-offset -2 ^\mf^\markup {Ob.} e-. a-. \oneVoice
	s4.*21
	% bars 99 - 102
	\voiceOne \clef bass r8-\offset X-offset -1 ^\markup {\column {\lower #1.5 "Vc." "Cor."}} e,!-.-\offset X-offset -1 ^\mf e,!-.
	e'!-. e,!-. r
	r e'!-. e,!
	...
	\transpose c f {
		\relative c {
			\voiceOne bes''4->-\offset X-offset -2 ^\ff^\markup {Cor.} g16-. a-.
			bes8-. g-. bes-.
			<bes d>-. <g bes!>-. <bes d>-.
			q8.-> <f bes!>16 q8
			<f bes d>4.~
	...
	s4.*9
	% bars 191 - 195
	\voiceOne \stemDown \shape #'((0 . 0)(0 . -0.5)(0 . -0.5)(0 . 0)) Slur aes'8(-\offset X-offset -4.7 ^\markup {Viol.} ees aes
	aes ees aes)
	aes( ees aes
	aes ees aes) \stemNeutral
	...
	s4.*15
	% bars 308 - 321
	\voiceOne \clef bass r8. des,16-.-\offset X-offset -1.5 ^\pp^\markup {Timp.} des8-.
	des4 r8
	r8. des16-. des8-.
	des r16 \clef treble % /!\ half measure
	\transpose c f {
		\relative c {
			<aes'' c ees>16-.-\offset X-offset -1.5 ^\p^\markup {Corni} q8-.
			q8. q16-. q8-.
			q8 r r
			r8. <aes c e!>16-. q8
			q8. q16-. q8-.
...
cueVoiceViolinoIIMvtI = \relative c {
	s2*160
	% bars 161 - 164
	\voiceOne r4 r8-\offset X-offset -2.5 ^\markup {Viol.I.} bes''!8^\p(~
	bes e!4 bes8~
	bes) fis'4( ais,8~
	ais) g'!4( ais,8) \oneVoice
	s2*188
	% bars 353 - 357
	\voiceOne c'2->-\offset X-offset -1.5 ^\f~-\offset X-offset -5 ^\markup {Viol.I.}
	c8[ r16 c,]( g c d e)
	<d f>2->~
	q8. d16( a bes d f)
	g4-> g8.( e16) \oneVoice
	s2*35
	% bars 393 - 396
	\voiceTwo \stemUp \clef bass f,,,4(-\offset X-offset -1.5 \p^\markup {Vlc.} a16 g f8)
	g4( bes16 a g8)
	a( c4)->\< bes8~\!
	bes a4(\> f8)\! \clef treble \oneVoice \stemNeutral
	s2*24
	% bar 421 - 425
...
cueVoiceViolinoIIMvtII = \relative c {
	s4.*6
	% bars 7 - 10
	\voiceOne \stemDown \clef bass f8(-\offset X-offset -1.5 ^\fz -\offset X-offset -1 ^\markup {Vlc.} f' e)
	dis4( e16 d)
	d8( c) b16( a) 
	c16-.( b-. a8-.) \clef treble s \oneVoice \stemNeutral
	s4.*47
	% bars 58 - 59
	\voiceOne \noteHeadEsw #'(-2 . 0) e''4.-\offset X-offset -1.5 ^\fp^\markup {Ob.} \revertNoteHeadEsw
	cis4~ cis16. a32-. \oneVoice
}
