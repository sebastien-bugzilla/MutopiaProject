...
% Bars 26 to 30
	...
	\shape #'((0 . -2)(0 . 0.8)(0 . 0.5)(0 . 0)) Slur g4\f( g'->~\fz g8 f!16 ees) d8-. ees-.
	cis-. d-. r d-. r d-. r d-.
	R1*5
% Bars 31 to 35
...
% Bars 146 to 150
	...
	r8. a16-.[\ff b8-. c]-. fis,8.[-> fis16-. gis8-. a-.]
	dis, r r4 r2
	r4 a'(~\fz a8 b16 a) gis8-. a-.
	r4 c\fz(~ c8 d16 c) b8-. c-.
% Bars 151 to 155
	r8. e!16[-.\ff fis8-. g]-. b,!8.[-> b16-. b8-. b]-.
...
% Bars 176 to 180
	...
	c2.\pp c4~
	c c-.(\< c-. c-.)\!
	\hairpinShorten #'(-0.5 . -0.5) c2.\fz\> c4\p~
	c c-.(\> aes-. c-.)\!
% Bars 181 to 185
	aes2.\pp aes4~
	aes aes-.(\< aes-. aes-.)\!
...
% Bars 246 to 250
	...
	r8 g-.\f c,-. d-. e4 r
	R1
	r8 e,-.\mf\> r g-. r bes-. r cis-.\! \mark \default
% Bars 251 to 255
	R1*3
...
% Bars 311 to 315
	\mmrPos #-4 R \no
	r2 \hairpinShorten #'(0 . -1) fis4(\p\< a\!~
	a\> g f!4. e8)\!
	e2(\p c'~
	c) c
% Bars 316 to 320
...
% Bars 326 to 330
	...
	r b-\crescmarkup r b
	r c r c
	<< \hairpinShorten #'(-0.5 . -0.5) c1~-\offset X-offset -2 \pp\< {s4 s \hairpinShorten #'(0.5 . 0) s\> s}>>
% Bars 331 to 335
	c1\pp~
	<< c~\< {s4 s s\> s}>>
	c1\pp~
