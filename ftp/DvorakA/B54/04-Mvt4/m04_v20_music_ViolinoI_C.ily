...
% Bars 6 to 10
	...
	\hairpinShorten #'(-0.3 . -1) a''4(\ff\< a')\! r8. e16-.[ a,8.-> a'16-.]
...
% Bars 21 to 25
	e,4-. e'-. e,8-. e'-. e,-. e'-.
	e,-. e'-. e,-. e'-. e,-. e'-. e,-. e'-.
	e,-.-\offset X-offset -1 \f e'-.\p e,-. e'-. e,-. e'-. e,-. e'-.
	R1*4
	
% Bars 26 to 30
	
	
	\shape #'((0 . -2)(0 . 0.5)(0 . 0.5)(0 . -1)) Slur g,4(\f \dynEO #'(0 . 2) g'->\fz~ g8 f16 ees) d8-. ees-.
...
% Bars 61 to 65
	...
	\dynEO #'(0 . 2) a(\ff bes) fis8:16 g: dis: e: b: c: \revertCutBeam
...
% Bars 116 to 120
	...
	des'2\pp r
	R1
	r2 r8 ges,,(-\offset X-offset 0.5 \pp\< bes ees
	ees des)\! r4 r2
% Bars 121 to 125
	R1*2
	\section
...
% Bars 131 to 135
	...
	<< \tremoloPosition #1 aes:\f\< {s4 s s s\!}>>
	\dynEO #'(0 . 2) aes8(\ff b, d aes') aes( g) r g-.
% Bars 136 to 140
	g( fis) r fis-. fis( f) r f-.
	\dynEO #'(0 . 2) aes(\ff b, d aes') aes( g) r g-.
	g( fis) r fis-. fis( f) r f-.
	\dynEO #'(0 . 2) aes(\ff g) g( f) f( ees) ees( d)
	d( c) c( bes) bes( aes) aes( g)
% Bars 141 to 145
	g( f) f( ees) ees( d) d( c)
	c b-> b-> b-> b-> b-> b-> b-> \mark \default
	c r r4 \shape #'((0 . -1.5)(0 . 0.5)(0 . 0.5)(0 . -0.5)) Slur g8(\ff c16 ees g4~
...
% Bars 156 to 160
	...
	r8. \dynEO #'(0 . 1) g,32(\mf bes des8) r r8. bes32(\< des f8)\! r
...
% Bars 161 to 165
	...
	c( des \markEO #'(0 . 2) d-\fmarkup ees\!
% Bars 166 to 170
...
% Bars 191 to 195
	...
	<< \tremoloPosition #1 bes:\f\< {s4 s s s8 s\!}>>
	\dynEO #'(0 . 2) bes8(\ff cis, e g) bes( a) r a-.
% Bars 196 to 200
	a( gis) r gis-. gis( g) r g-.
	bes( cis, e g) bes( a) r a-.
	a( gis) r gis-. gis( g) r g-.
	\cutBeamEachBeat \dynEO #'(0 . 2) bes(\ff a) a( g) g( f) f( e)
	e( d) d( c) c( bes) bes( a)
% Bars 201 to 205
...
% Bars 246 to 250
	...
	R1 \mark \default
% Bars 251 to 255
	\hairpinShorten #'(-0.5 . -0.5) a,4(-\offset X-offset -1 \p\< a'~-\offset X-offset 1 \fz a8) a16( g fis8-.) g-.
	r2 d'->\fz
...
% Bars 261 to 265
	...
	\dynEO #'(0 . 2) a([\ff bes)] fis8:16 g: dis: e: b: c!:
% Bars 266 to 270
	a: bes!: fis: g: dis: e: cis: d:
	b: c!: fis,: g: a: bes!: cis: d:
	e: fis: g: a: bes: e:\< fis: g:\!
	\dynEO #'(0 . 2) \tremoloPosition #1 bes1:->\ff
	\dynEO #'(0 . 2) \tremoloPosition #1 b:->\ffz
% Bars 271 to 275
	c4-. r r2
...
% Bars 301 to 305
	...
	des2.(\< des4--)\!
% Bars 306 to 310
	c2(\< \markEO #'(0 . 2) bes'4-\mfmarkup a~
	a)\! g(\> f e!)\!
	ees2.(\pp ees4--)
	d2.( d4--)
	c2(\< \markEO #'(0 . 2) c'4-\mfmarkup bes~
% Bars 311 to 315
	bes)\! a(\> g4. fis8)\!
	fis2\p\< d'\!~
	d << d\> {s8 s s s\!}>>
...
% Bars 356 to 360
	r8 \shape #'((-0.4 . -1.5)(0 . 0.5)(0 . 0.5)(0 . 0)) Slur c,(\pp d f d c a g
	f) r r4 r2
	R1*2
