...
% Bars 26 to 30
	...
	\shape #'((0 . -2)(0 . 0.8)(0 . 0.5)(0 . 0)) Slur g,4\f( g'->~\fz g8 f!16 ees) d8-. ees-.
	cis-. d-. r d-. r d-. r d-.
	R1*5
% Bars 31 to 35
...
% Bars 91 to 95
	e,4(\pp f e f
	e f e f) \section \markXoffset #-0.2 \mark \default
	\key des \major R1*9
% Bars 96 to 100
...
% Bars 141 to 145
	g r r4 r2
	r8 b-. b-. b-.  b-. b-. b-. b-. \markXoffset #-0.2 \mark \default
	c4 r r2
	R1*3
...
% Bars 146 to 150
	...
	fis, r r4 r2
	r4 c'(~\fz c8 b16 a) gis8-. a-.
	r4 ees'\fz(~ ees8 d16 c) b8-. c-.
% Bars 151 to 155
	r8. g'16[-.\ff a8-. b]-. e,!8.[-> e16-. fis8-. g]-.
	r8. e!16[-. fis8-. g]-. b,8.[-> b16-. dis8-. e]-.
	R1*14
% Bars 156 to 160
...
% Bars 221 to 225
	...
	\mmrLength #18 \tempoXoffset #-2 \mmrnDown R1*5
% Bars 226 to 230
...
% Bars 246 to 250
	...
	r8 g'!-.\mf c,!-. d!-. e!4-. r
	r8 g-.\f c,-. d-. e4 r
	r8 g16-.\mf g-. cis,8-. d-. e-. g,-. a-. bes-.
	cis,-. r r4 r2 \mark \default
% Bars 251 to 255
	R1*3
...
% Bars 301 to 305
	...
	g\< g\!
% Bars 306 to 310
	c2.\mf c4(-\offset X-offset -1.5 -\crescmarkup\<
	f2.\f\> g4)\!
	g2(\p\> bes,)\!
	a( f'
	ees)\< ees\!~
...
% Bars 326 to 330
	...
	r b-\crescmarkup r b
	r c r c
	<< \hairpinShorten #'(-0.5 . -1) c1~-\offset X-offset #-1.5 \pp\< {s4 s \hairpinShorten #'(1 . 0) s\> s}>>
% Bars 331 to 335
	c1\pp~
	<< \hairpinShorten #'(0 . -0.5) c~\< {s4 s \hairpinShorten #'(0.5 . 0) s\> s}>>
	c1\pp~
	c4 r r2
	R1*3
% Bars 336 to 340
...
% Bars 351 to 355
	a
	<< a~\< {s4 s s s8 s\!}>>
	<< \hairpinShorten #'(0 . -1.5) a2\> {s8 s s s\!}>> r2
	f1(\pp
	g2.. a8)
% Bars 356 to 360
	a1\pp
...
% Bars 376 to 380
	...
	f4 r r2
	R1
	r2 d16(\f\< bes g a bes c d e)\! \mark \default
	f8\f r f2.\p
% Bars 381 to 385
	r4 f4.(->-\pocoapococresc e16 d cis8-.) d-.
	r4 a'4.(-> g16 f e8-.) f-.
	r4 a4.(-> g16 f e8-.) f-.
