...
% Bars 51 to 55
	r4 e( f2)
	r4 \hairpinShorten #'(0 . -2.5) g(\f\< a2)\!
	r4 g-^ r-\crescmarkup a-^
...
% Bars 146 to 150
	...
	r4 c(~-\offset X-offset 0.5 \fz c8 d16 c) b8-. c-.
% Bars 151 to 155
	r8. e!16-.[\ff fis8-. g-.] g,8.[-> b16-. b8-. b-.]
	R1
	r4 e(~\fz e8 fis16 e) dis8-.( e-.)
	r4 g(~\fz g8 a16 g) fis8-.( g-.)
	R1*12
% Bars 156 to 160
...
% Bars 211 to 215
	dis( e! dis e)
	eis8(\< fis16) r gis8( a16) r b8( c16) r d8( ees16)\! r
	r2 r4 r8 dis-.\f
	e-. r r4 r f!8-.\ff r
	r2 r4 f8-. r
% Bars 216 to 220
...
% Bars 221 to 225
	...
	\mmrLength #18 \tempoXoffset #-2 R1*5
% Bars 226 to 230
	
	
	\mmrLength #10 \tempoXoffset #-1 R1*4
% Bars 231 to 235
	
	e,4\p \once \stemUp b'(~ b8 a16 g fis8-.) g-.
...
% Bars 246 to 250
	...
	r8 g-.\f c,-. d-. e4 r
	R1
	r8 g,-.\mf\> r bes-. r bes-. r cis-.\! \markXoffset #-0.2 \mark \default
% Bars 251 to 255
	r4 a2(\p g4)
	c2.(-\crescmarkup bes4)
	e2.( d4)
...
% Bars 301 to 305
	...
	<< \hairpinShorten #'(-0.3 . -2) g1\pp\<( {s4 s s s\!}>>
	f2\> g4 a)\! \mark \default
	bes r r2
	R1*7
% Bars 306 to 310
...
% Bars 311 to 315
	...
	\ni \mmrPos #-4 R1
	\mmrPos #-4 R \no
	r2 \hairpinShorten #'(0 . -1.5) e4(\p\< g\!~
	g\> f e4.\! d8)
% Bars 316 to 320
	bes2\p r
	R1*5
...
% Bars 326 to 330
	...
	r c r c
	<< {f,2( g)} {\hairpinShorten #'(-0.5 . 0) s8-\offset X-offset -1 \p\< s s s\! \hairpinShorten #'(-0.3 . 0.3) s\> s s s\!}>>
% Bars 331 to 335
	f2(-\pbrackp g)
	<< {f2( g)} {s8\< s s s\! s\> s s s\!}>>
	f2(\brack\pp g
	f4) r r2
	R1*3
% Bars 336 to 340
...
% Bars 351 to 355
	c
	<< c\<~ {s4 s s s\!}>>
	<< \hairpinShorten #'(0.5 . -2) c2\> {s8 s s s\!}>> r2
	a1\pp(
	c)
% Bars 356 to 360
	c\pp
...
% Bars 401 to 405
	...
	r c-.\f\< b-. c-. cis-. d-. dis-. e-.\! \mark \default
	a,1\ff~
	a
	f'~
% Bars 406 to 410
