...
% Bars 146 to 150
	...
	r8.d16-.[\ff e8-. f-.] b,8.->[ b16-. cis8-. d-.]
	r8. gis,16-.[ ais8-. b-.] eis, r r4
	R1*3
	
% Bars 151 to 155
	
	r8. fis'!16-.[\ff gis8-. a-.] cis,8.->[ cis16-. eis8-. fis-.]
	r4 a,(~\fz a8 gis16 fis) eis8-.( fis-.)
	r4 cis'(~\fz cis8 b16 a) gis8-.( a-.)
	R1*2
% Bars 156 to 160
...
% Bars 171 to 175
	...
	e4(-\crescmarkup f) r8. f16[(\< g8. aes16)]\!
	bes2.\fz g4(~->
	g ees2\> d4)\!
	c1(\p
% Bars 176 to 180
...
% Bars 316 to 320
	...
	fis2.(\fz e4~
	e2\> c4 b\!
	a2.)-\offset X-offset -1 -\dimmarkup a4\pp
% Bars 321 to 325
	g2( fis) \mark \default
	g4\pp g r g
	r g r d'\<
...
% Bars 326 to 330
	...
	r e-\crescmarkup r g!
	r a r a
	<< d,1~ {\hairpinShorten #'(-0.5 . -2) s8\p\< s s s\! \hairpinShorten #'(2 . -2) s\> s s s\!}>>
% Bars 331 to 335
	d1-\offset X-offset 0.5 \pp
	<< d~ {s8\< s s s\! s\> s s s\!}>>
	d1\pp
	d4 r r2
	R1*3
...
% Bars 351 to 355
	b
	<< b\<~ {s4 s s s\!}>>
	<< \hairpinShorten #'(0 . -1) b2 {s8\> s s s\!}>> r2
	g1\pp(
	a)
% Bars 356 to 360
	b\pp~
