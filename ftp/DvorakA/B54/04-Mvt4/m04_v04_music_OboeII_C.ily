...
% Bars 26 to 30
	...
	g4\f g-\offset X-offset 0.5 \fz~ g8 r r4
	r r8 d'-. r d-. r d-.
	r bes!-. r bes-. r bes-. r bes-.
% Bars 31 to 35
	r bes-> r bes-> r bes-> r bes->
	r4 bes->-\tweak X-offset 0 \ff r bes->
	r a-> bes-> fis->
...
% Bars 121 to 125
	a1\fp\>~
	a4\! a-.(\< a-. a-.)\! \section
	\key f \major cis2.-\tweak X-offset 0 \fp a4~
	a a(-.\> a-. a-.)\!
	gis2.\p gis4
% Bars 126 to 130
	gis2. gis4
...
% Bars 246 to 250
	...
	r8 g-.\f c,-. d-. e4 r
	R1
	r8-\offset X-offset -1 \mf \hairpinShorten #'(1 . 0) g,-.\> r bes-. r bes-. r cis-.\! \mark \default
% Bars 251 to 255
	r4 a2(-\offset X-offset 1 \p g4)
	c2.(-\crescmarkup bes4)
	e2.( d4)
	g2.( f4)
	r4 g\f r a
...
% Bars 271 to 275
	...
	a2->-\offset X-offset -2.5 \ff a->
	a-> b->
	a'8-. r f4-.\p r c-.
% Bars 276 to 280
	r2 d,8( dis e c)
	a'2->-\offset X-offset -2.5 \ff a->
	a-> b->
	f'8 r f4-.\p r c-.
	b( c gis a)
% Bars 281 to 285
...
% Bars 301 to 305
	R1
	<< \shape #'((0 . 2)(0 . 0.5)(0 . 0.5)(0 . 0)) Slur g1\pp\<( {s4 s s s\!}>>
...
% Bars 376 to 380
	...
	des4 r c r
	e r r2 \mark \default
	a,8\f r f2.-\tweak X-offset 0.5 \p~
% Bars 381 to 385
	f8 r f2.~
	f8 r a'4.(-> g16 f e8-.) f-.
	r4 a4.->( g16 f e8-.) f-.
