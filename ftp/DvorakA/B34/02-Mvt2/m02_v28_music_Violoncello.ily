...
% Bars 1 to 5
	...
	\tupletBracketOn \tuplet 6/4 4 {r16 fis(\< gis a eis fis)} fis4\!
% Bars 6 to 10
	\tuplet 6/4 4 {r16 fis(\> gis a gis fis)} f4\!
	\tuplet 6/4 4 {r16 f(\pp g aes e f)} f4
	\tuplet 6/4 4 {r16 f( g aes e f)} f4 \tupletBracketOff
	f4->\< e->\!
...
% Bars 21 to 25
	fis4 \tupletBracketOn \tuplet 6/4 4 {r16 fis(\< gis a eis fis)\!}
	fis4 \tuplet 6/4 4 {r16 fis(\< gis a eis fis)\!} \tupletBracketOff
...
% Bars 56 to 60
	...
	<< \hairpinShorten #'(-0.5 . -1) cis2\p\>~ {s8 s s s\!}>>
	cis2~
% Bars 61 to 65
	<< \hairpinShorten #'(0 . -2) cis4\< {s8 s\!}>> e16.(\> d32 cis16. b32)\!
	a4(\> gis8-.) fis-.\!
...
% Bars 66 to 70
	...
	r8 gis''16.(\p^\espress fis32) fis8(\< e)\!
...
% Bars 91 to 95
	...
	gis-. fis-. \once \tupletBracketOn \tuplet 6/4 {r16 dis( e fis e dis)}
...
% Bars 156 to 160
	...
	ges\pp r r4
	R2
	r4 r8^\brackM\pizz \textEndMark "-de" \bar "!" a,\fz \mark \default
...
% Bars 166 to 170
	bes8(^\brackM\arco-\offset X-offset -2 _\espress ges'~\mf ges)\< f16( ges32 aes)\!
...
% Bars 176 to 180
	r des,16->(\< ees64 f ges aes\! bes!16-.) r r c!64(\< des ees f
...
% Bars 211 to 215
	...
	a'8.(_\p\<-\offset X-offset 1.5 ^\brackM\espress fis32 gis) a8( fis)\! \section \mark \default
...
% Bars 231 to 235
	...
	\hairpinShorten #'(-0.5 . -1) bis4(\brack\p\< cis)\!
% Bars 236 to 240
	fis(\< e)\!
...
% Bars 251 to 255
	b\< bis\!)
	<< {cis d8.( cis16)} \\ {cis4^\brackM\moltocresc eis,} >>
...
% Bars 256 to 260
	...
	cis4-\offset X-offset 1 _\div <fis, ais>4\fz\>~
	q\! <fis a>\pp(
% Bars 261 to 265
	<cis gis'>) r
	R2*2
...
% Bars 6 to 10
	...
	g r r aes\brack\pp
	g r r aes-\offset X-offset -0.5 ^\arco
	r gis!->\< r gis\!
...
% Bars 71 to 75
	...
	cis8[(\> fis, fisis gis)]\!
	r8 \tupletBracketOn \tuplet 3/2 8 {r16 a-.\pp a-.} r8 \tuplet 3/2 8 {r16 a-. a-.} 
...
% Bars 106 to 110
	...
	ces4\< bes8( ees)\!
% Bars 111 to 115
	<< aes,2\> {s8 s s s16 s\!}>> \clef bass
	ees4(\> ees,)\!
	aes8\pp r r4
	\markEO #'(0 . 0) aes8\p-\offset X-offset -4 ^\brackM\pizz[ aes16 r32 ees'] aes,8 r
	aes r r4
% Bars 116 to 120
...
% Bars 166 to 170
	...
	\divideBeam r32 des->\ff c-> ces-> ces( bes) bes( a) r16 a32( aes) r aes-> f-> ees->
% Bars 171 to 240
	r des'-> c!-> ces-> ces( bes) bes( a) r16 a32( aes) r aes-> f-> des-> \resetBeam
	s2*42 \key cis \minor
	s2*14 s4*1 s2*11 
	cis4(\< fis,)\!
% Bars 241 to 244
