...
% Bars 16 to 20
	...
	b8(\p\< a\!) << gis!4 {s8\> s\!}>>
	R2
	\hairpinShorten #'(-0.5 . 0) b8(\p\< a\!) gis4\fz~
% Bars 21 to 25
	gis8\< a-.\! gis4\fp~
	gis8 a-.\< gis8. gis16\!
	gis8\fz r r4
...
% Bars 61 to 65
	...
	fis8[\> r16 fis] gis8[ r16 gis]\!
	cis8-.[ cis-. cis-.] r
	a^\arco\p r a[ r16 a32 a]
	a8 r a[\< r16 a32 a]\!
% Bars 66 to 70
	ais8[ r16 ais32 ais] b8[\< r16 b32 b]\!
	fis8[\f\> r16 fis32 fis] gis8-. gis-.\!
	cis8\p r r4 \mark \default 
	cis8(\p[ bis cis bis])
...
% Bars 91 to 95
	cis2\pp~
	cis4 gis
	cis8-.\pp[ cis-. cis-._\brackM\dimmarkup cis-.]
	cis[-. cis-. cis-. cis-.]
	cis16\ppp r gis-> r cis r gis-> r
% Bars 96 to 100
	cis8 r cis r
...
% Bars 166 to 170
	...
	ges r r8\! \dynEO #'(0 . 1) aes16\f r r8
	\dynEO #'(0 . 2) des4->\ff des8-> des16.-> c32
% Bars 171 to 175
	des4-> \acciaccatura {\beamOffset #'(-0.5 . -0.5) aes32 bes c} des4
	\acciaccatura {aes32 bes c} des4-> des8-> des16.-> ees32->
	des4-> \acciaccatura {aes32 bes c} des8 r
	des-> des16. aes32 des8 r
	des-> des16. aes32 des8 r
% Bars 176 to 180
	r \beamOffset #'(0.5 . 0.5) des,16->(\< ees64 f ges aes\! bes16-.) r r c64(\< des ees f\!
	ges4)\fz ges8-> ges16.-> des32
	\acciaccatura {des32 ees f} ges2
	\acciaccatura {des32 ees f} ges4-> ges8-> ges16.-> des32
	\acciaccatura {des32 ees f} ges2
% Bars 181 to 185
...
% Bars 191 to 195
	...
	ges16 r bes( aes!32 ges) ges16-. r des-. r
% Bars 196 to 200
	ges,\< r bes'( aes32 ges) ges16-. r des-.\! r
	bes\ff r d'(-> c32 bes) bes16 r f(-> ees32 d)
	g,16 r d''(-> c32 b) b16[(-> a32 g]) f16->( e32 d)
...
% Bars 211 to 215
	...
	<< d,2(\p\<-\offset X-offset -5.5 ^\brackM\arco {s8 s s s\!}>> \section \mark \default
...
% Bars 221 to 225
	a8 r a16 r a\< a
	ais r ais ais b r b b\!
	fis\> r r fis32 fis gis8-. gis-.\!
	cis2(\pp
	b)
% Bars 226 to 230
	<< a( {s4 s\< }>>
...
% Bars 251 to 255
	r4 \hairpinShorten #'(-0.5 . -0.5) bis(-\offset X-offset -2 \brack\pp\<
	cis)\!-\offset X-offset -2 _\brackM\moltocresc eis,
	fis8\f << gis4.->\> {s8 s s\!}>>
	r4 gis\pp
	cis8 r r4
% Bars 256 to 260
	r8 \hairpinShorten #'(0 . 1.5) cis[(\p\< fis, \hairpinShorten #'(-1.5 . 1) gis)]\>
...
% Bars 261 to 265
	...
	R2*2
	\section
	\key des \major des4\pp des8 des16. aes32
	des4 des
% Bars 266 to 270
...
% Bars 171 to 175
	...
	\acciaccatura {aes32 bes c} des16 r \acciaccatura {aes32 bes c} des16 r \acciaccatura {aes32 bes c} des16 r r8
% Bars 176 to 180
	r des16(->\< ees64 f ges aes\! bes16-.) r r c,64(\< des ees f\!
	ges8)\fz r \acciaccatura {des32 ees f} ges16 r \acciaccatura {des32 ees f} ges16 r 
