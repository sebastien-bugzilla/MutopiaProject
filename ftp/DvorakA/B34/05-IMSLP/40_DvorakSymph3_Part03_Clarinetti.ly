...
\book {
	\header {
		subtitle = \markup { 
			...
			\center-column {
				"Part for Clarinetto I"
			}
		}
		subsubtitle = \markup { 
			"Antonín Dvořák — Symphony No. 3 in E-flat Major Op.10 (B.34) — Clarinetto I"
		}
		instrument = \markup {
			""
		}
	...
	\paper {
		output-filename = "Clarinette 1 (B)"
	}
}
\book {
	\header {
		subtitle = \markup { 
			\abs-fontsize #12 \sans
			\center-column {
				"Part for Clarinetto II"
			}
		}
		subsubtitle = \markup { 
			"Antonín Dvořák — Symphony No. 3 in E-flat Major Op.10 (B.34) — Clarinetto II"
		}
		instrument = \markup {
			""
		}
	...
	\paper {
		output-filename = "Clarinette 2 (B)"
	}
}
