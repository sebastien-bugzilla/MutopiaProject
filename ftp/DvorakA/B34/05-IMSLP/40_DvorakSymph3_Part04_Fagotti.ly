...
\book {
	\header {
		...
		subsubtitle = \markup { 
			"Antonín Dvořák — Symphony No. 3 in E-flat Major Op.10 (B.34) — Fagotto I"
		}
		instrument = \markup {
			""
		}
...
\book {
	\header {
		...
		subsubtitle = \markup { 
			"Antonín Dvořák — Symphony No. 3 in E-flat Major Op.10 (B.34) — Fagotto II"
		}
		instrument = \markup {
			""
		}
