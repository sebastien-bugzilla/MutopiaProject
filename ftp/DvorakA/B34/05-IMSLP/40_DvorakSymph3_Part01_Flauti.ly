...
\book {
	\header {
		...
		subsubtitle = \markup { 
			"Antonín Dvořák — Symphony No. 3 in E-flat Major Op.10 (B.34) — Flauto I"
		}
		instrument = \markup {
			""
		}
...
\book {
	\header {
		...
		subsubtitle = \markup { 
			"Antonín Dvořák — Symphony No. 3 in E-flat Major Op.10 (B.34) — Flauto II"
		}
		instrument = \markup {
			""
		}
...
\book {
	\header {
		...
		subsubtitle = \markup { 
			"Antonín Dvořák — Symphony No. 3 in E-flat Major Op.10 (B.34) — Piccolo"
		}
		instrument = \markup {
			""
		}
