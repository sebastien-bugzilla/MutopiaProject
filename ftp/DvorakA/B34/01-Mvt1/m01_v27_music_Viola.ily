...
%	\transposition a
% Bars 1 to 5
	\repeat tremolo 6 {ees16(\pp g}
	\repeat tremolo 6 {ees g)}
	\repeat tremolo 6 {ees( g} 
	\repeat tremolo 6 {ees g)}
	\repeat tremolo 3 {ees(\< g} \repeat tremolo 3 {ees c')\!}
% Bars 6 to 10
	\repeat tremolo 3 {ees,(\fp c'} \repeat tremolo 3 {ees, bes')} 
	g(\> ees g ees bes' g\! aes\pp ees aes ees aes ees)
	\repeat tremolo 6 {g( ees)\<} 
	\repeat tremolo 6 {aes(\> ees)\!}
	\repeat tremolo 6 {g( ees)\<} 
% Bars 11 to 15
	\repeat tremolo 6 {aes(\> ees)\!}
	\repeat tremolo 3 {des( f }  bes f des f des f)
	\repeat tremolo 3 { ees(_\brackM\crescmarkup ges} bes ges ees ges ees ges)
	\repeat tremolo 3 {ees(\fz ges} ees g ees g ees aes) 
	\repeat tremolo 3 {ges(\> bes \!} \repeat tremolo 3 {f\brack\p aes)}
% Bars 16 to 20
	<ees g!>4.-^\ff d16( ees f ees d ees)
	<bes' des>4.-^\brack\fz f16( ges aes ges f ges)
	\dynEO #'(0 . -8.5) <aes f'>4.-^^\brack\fz c16( des ees des c des)
	\time 3/8 <bes ges'>4.:32-^-\offset X-offset 0.8 \ff
...
% Bars 26 to 30
	\stemUp \repeat tremolo 3 {des(\> bes} \stemNeutral \repeat tremolo 3 {ces aes)\!} 
	ges4\p r8 r4 r8
	\repeat tremolo 3 {<ges bes>16(\pp <bes des>} \repeat tremolo 3 {<ges bes>  <bes des>) }
	\repeat tremolo 3 {<ges bes>16(\< <bes des>} \repeat tremolo 3 {<ges bes>  <bes des>)\! } 
	\repeat tremolo 3 {<ges bes>16(\fp <bes ees>} \repeat tremolo 3 {<ges bes>\< <bes des>)\! }
% Bars 31 to 35
	\repeat tremolo 3 {<ges ces>(_\crescmarkup <ces! ees> } \repeat tremolo 3 {<ges bes> <bes ees>)}
	<ees, ges>8\ff c!16( ees f ees) c( ees f ees des f)
...
% Bars 36 to 40
	...
	\time 6/8 ees16(\< des) ges( f) f( ees) \stemUp ees( des) des( ces) a( bes)\! \stemNeutral
	\time 3/4 <ges bes>8 r r4 ees'8( des16) r
% Bars 41 to 45
	\time 6/8 ees(\< des) aes'( ges) ges( f) f( ees) ees( des) des( ces)\!
	\time 3/8 ces'(\< bes) bes( aes) aes( ges)\! \mark \default
	\time 6/8 \tuplet 3/2 8 {f(-\offset X-offset -0.5 \fz e \liiri f} \liriii e32 f g f) e8-. r4 r8
	\tuplet 3/2 8 {f16(-\offset X-offset -0.5 \fz e \liiri f} \liriii e32 f g f) e8-. r4 r8
	\tuplet 3/2 8 {ges16(-\offset X-offset -1 \fz f \liiri ges} \liriii f32 ges aes ges) f8-. r4 r8
% Bars 46 to 50
...
% Bars 51 to 55
	...
	<ees g>(\ff bes g bes g bes  \repeat tremolo 3 {g bes)} 
	\repeat tremolo 3 {g( bes} \repeat tremolo 3 { g bes)}
	\repeat tremolo 3 {g(\< bes } \repeat tremolo 3 {ees, g)\!} 
...
% Bars 61 to 65
	\repeat tremolo 3 {des,(\< f)} des( f bes f des f)\!
	\repeat tremolo 3 {ees( ges)} ees( ges bes ges ees ges) 
...
% Bars 81 to 85
	...
	\repeat tremolo 3 {ges16(\pp bes} \repeat tremolo 3 {ges bes} 
	\repeat tremolo 3 {ges bes} \repeat tremolo 3 {ges bes)} 
% Bars 86 to 90
	\repeat tremolo 3 {f( aes} \repeat tremolo 3 {f aes}
	\repeat tremolo 3 {f aes} \repeat tremolo 3 {f aes)} 
	\repeat tremolo 3 {ges(\< bes} \repeat tremolo 3 {ges bes)\!} 
...
% Bars 121 to 125
	ges( bes ges bes ges bes  ges bes ges bes ges bes
	ges\< bes ges bes ges bes  ges bes ges bes ges bes)\! 
	<des, ges>(\p <ges! bes> <des ges> <ges bes> <des ges> <ges bes>   <des ges> <ges bes> <des ges> <ges bes> <des ges> <ges bes>)
	<des aes'>(\< <aes' ces> <des, aes'> <aes' ces> <des, aes'> <aes' ces>\!   <des, aes'>\> <aes' ces> <des, aes'> <aes' ces> <des, aes'> <aes' ces>)\!
	<ges bes>4 r8 r4 r8
% Bars 126 to 130
	R2.
	des4\pp r8 r4 r8
	R2.
	r4 r8 b'16(\p\< gis e' b gis' e
	b e gis e b' gis e'8)\! r r
% Bars 131 to 135
	R2.
	r4 r8 c,,16(\p\< e g e c' a)\!
	<< \hairpinShorten #'(-0.5 . -0.5) b2.\fp\>~ {s8 s s  s s s}>>
	b2.~-\offset X-offset 1.7 _\dimD
	b8 <e g>\pp q  q q q
% Bars 136 to 140
	q q q  q q q
	<fis a> q q  q q q
...
% Bars 151 to 155
	...
	ees'( aes, ees' aes, ees' aes,  ees' aes, ees' aes, ees' aes,
% Bars 156 to 160
	ees' aes, ees' aes, ees' aes,  ees' aes, ees' aes, ees' aes,)
	<ees' ges>4. <des f>4(\<^\brackM\pococresc <f aes>8)\!
...
% Bars 166 to 170
	...
	e,(\brack\fp a c \liiri a \tuplet 3/2 8 {\lirii e' c a)} r4 r8
...
% Bars 181 to 185
	...
	r4 r8 <b' fis'>\pp^\brackM\pizz q q
	r4 r8 q q q
	r4 r8 q q q
% Bars 186 to 190
...
% Bars 191 to 195
	...
	\tuplet 3/2 8 {g8.:16\< aes!: a: bes: c: des:\!}
	<f, des'>8\ff \tuplet 3/2 8 {q16 q q} q8 des'8-^ \tuplet 3/2 8 {bes16( c des)} des8-^
...
% Bars 201 to 205
	...
	<cis, e>2.\<~
	<< q {s8 s s  s s s\!}>>
	<d f>8^\pizz r r r4 r8
% Bars 206 to 210
	r8 bes'16(\brack\pp^\arco f bes f a8) r r
	r8 bes16( f bes f a8) r r
	r8 bes16( f bes f a8) r r
	<< <d, f>2.~\< {s8 s s  s s s\!}>>
	<< q2.\> {s8 s s  s s s\!}>>
% Bars 211 to 215
	<ees ges>8^\pizz r r^\arco r <ces ces'>16(\brack\pp <ges ges'> <ces ces'> <ges ges'>
	<bes bes'>8) r r r <ces ces'>16( <ges ges'> <ces ces'> <ges ges'>
	<a a'>8) r r r4\< r8
	r <c! c'!>16( <g! g'!> <c c'> <g g'> <b b'>8) r r
	<cis cis'>16( <b b'> <d d'> <gis, gis'> <b b'>) r <cis cis'>( <b b'> <d d'> <gis, gis'> <b b'>)\! r \mark \default
% Bars 216 to 220
	<g! b g'!>2.:32\ff-^
	q:
	<c d a'>:
...
% Bars 226 to 230
	...
	q4 r8 r4 r8
	\time 3/8 << \hairpinShorten #'(-0.5 . -2.5) <f aes>4.\pp\> {s8 s s\!}>>
...
% Bars 231 to 235
	...
	g(\p ees g ees g ees  g ees g ees g ees
% Bars 236 to 240
	aes ees aes ees aes ees  aes ees aes ees aes ees) 
	g(\pp ees g ees g ees  g ees g ees g ees 
	aes ees aes ees aes ees  aes ees aes ees aes ees) 
	<< {
...
% Bars 239 to 240
		bes,(_\pocoapococrescendo g bes g bes g  bes g bes g bes g) 
		bes(\fp ges bes ges bes ges  bes ges bes ges bes ges) 
% Bars 241 to 245
		a( f a f a f  a f a f a f)
		bes(\fz ges bes ges bes ges  bes ges bes ges bes ges) 
		bes(\fz g! bes g bes g  bes\< g bes g bes g)
		c(_\fzmarkup aes c aes c aes  c aes c aes c aes)\!
	} >>
	<a fis'>2.:32\fp\<
% Bars 246 to 250
	<< q: {s8 s s  s s s\!}>>
...
% Bars 294 to 295
		...
		<f aes!>2.:\brack\fz\<
% Bars 296 to 300
		ces'4:^\pocoapoco_crescendo bes: aes:\!
	} >>
	\tuplet 3/2 8 {ces8.:16\fz bes: bes: aes: aes: ces:
	c!:\fz bes: bes: a: a: c:
	\stemUp des:\fz c: c: \stemNeutral bes: bes: des:
	ees:\fz d!: d: c: c: ees:}
% Bars 301 to 305
	<f aes!>2.:32
	<< q:\< {s8 s s  s s s\!}>>
...
% Bars 306 to 310
	...
	<fis a>2.:32\ff
	q:
	\stemUp \tuplet 3/2 8 {\setSextolet bes,16(\fz des bes des bes des bes des bes  des bes des bes des bes des bes des)
% Bars 311 to 315
	b(\fz d! b d b d b d b  d b d b d b d b d)
...
% Bars 321 to 325
	...
	<bes, ges'>: <aes f'>8 r r
	<g! ees'>-^ r r <bes d>-^ r r
	g16( bes ees \liiri bes \once \tupletUp \tuplet 3/2 8 {\lirii g' f ees)} d( f aes \liiri f \tuplet 3/2 8 {\lirii ces' bes aes)}
	<aes, d ces'>8-^\arpeggio r r q-^\arpeggio r r
% Bars 326 to 330
	q-^\arpeggio r r q-^\arpeggio r r
	<< {
		bes'16(-\offset X-offset -3 ^\div des bes des) \once \oneVoice r8 bes16( des bes des) \once \oneVoice r8
		bes16( des bes des) \oneVoice r8 <d,! bes'!>16-^\f q-^ q-^ q-^ q-^ q-^
	} \\ {
		f8(\p ges) s f( ges) s
		f( ges) s s4.
	} >>
...
% Bars 331 to 335
	...
	<d d'>:^\brackpocoapococresc <ees ees'>: <bes bes'>:} <g' bes>4.:32
	q2.:
	q:\mf\<
	<< q: {s8 s s  s s s\!}>>
% Bars 336 to 340
...
% Bars 77 to 80
	<des' ges>8\pp ges,16( bes ges bes \repeat tremolo 3 { ges bes) }
	\repeat tremolo 3 {ges( bes} \repeat tremolo 3 {ges bes)} 
	\repeat tremolo 3 {f( aes} \repeat tremolo 3 {f aes)} 
	\repeat tremolo 3 {f( aes}  f aes f aes des aes) 
% Bars 81 to 85
	\repeat tremolo 3 {ges(\< bes} \repeat tremolo 3 {ges bes)\!}
	ees,(_\crescmarkup ges ces ges ees ges  ees ges ees ges ees ges)
	des(_\dimmarkup ges bes ges bes ges  des f aes f aes f)
...
% Bars 99 to 170
	s2.*72
% Bars 171 to 175
	<c, aes'!>8-^\f \tuplet 3/2 8 {q16 q q} q8 r4 r8
...
% Bars 176 to 180
	...
	dis16( fis b \liiri fis \tuplet 3/2 8 {\lirii dis' b fis)} r4 r8 
% Bars 181 to 185
	<bes! d!>8\f \tuplet 3/2 8 {q16 q q} q8 r4 r8
	<bes! d>8\> \tuplet 3/2 8 {q16 q q} q8\! r4 r8
	ees,!\pp^\pizz ges ces ges'[ r ces]
...
% Bars 211 to 215
	ges8\p r r \tuplet 3/2 8 {<bes,, ges'>8.:16\brack\pp <ces ees>: <ges ces!>:
	<bes ges'>: <ces ees>: <ges ces!>: <bes ges'>: <ces ees>: <ges ces>: 
	<b ges'>: <c! ees>: <fis, c'!>: <b ges'>:\< <c ees>: <fis, c'>:
	<b g'!>: <c e>: <g! c>: <b g'>: <c e>: <g c>:
	<cis aes'!>: <d f>: <gis, d'>: <cis aes'>: <d f>: <gis, d'>:\!}
% Bars 216 to 220
	\stemDown d'16(\ff \liiri cis \tuplet 3/2 8 {\lirii d cis \liiri d \lirii cis d cis  \setSextolet d cis d cis d c b a g) \stemNeutral
	d'( cis d cis d cis d cis d  cis d cis d cis d} \unsetSextolet c32[ b a g])
	\tuplet 3/2 8 {\setSextolet \stemDown d'16( cis d cis d cis d cis d  cis d cis d cis d c b a) 
