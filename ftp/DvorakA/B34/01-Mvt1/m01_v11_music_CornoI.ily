...
% Bars 11 to 15
	...
	des_\crescmarkup
	bes\fz
	bes4.(-\offset X-offset #-1 _\dimmarkup a)\p
% Bars 16 to 20
	d!-^\ff r4 r8
	des4.-^ r4 r8
	c4.-^ r4 r8
...
% Bars 36 to 40
	...
	\time 6/8 c->\< des-> des-> ees->( e f)\! % d => des based on Simrock conductor
...
% Bars 161 to 165
	\textMark "Vi-" \time 6/8 c-> d-> ees-> d-> c-> bes->
	\time 3/4 ees-> r d-> r c-> r \textEndMark "-de"
...
% Bars 171 to 175
	<< \hairpinShorten #'(-0.5 . -1.5) ees2.\fz\>~ {s8\> s s  s s s\!}>>
	ees2._\dimmarkup
	r4 r8 r4 e!8-.\p
	r4 r8 r4 e8-.
	r4 r8 r4 e8-.
...
% Bars 201 to 205
	R2.
	r8 e-.\p b-. dis-. r r
	e-.^\solo f!-. d!-. << d4.~ {\hairpinShorten #'(0 . -1.5) s8\< s s\!}>>
	<< d2. {s8\> s s  s s s\!}>>
...
% Bars 206 to 210
	...
	f8-^^\solo\brack\p ges-^ ees-^~ << ees4.~ {\hairpinShorten #'(0 . -1.5) s8\< s s\!}>>
	<< ees2. {s8\> s s  s s s\!}>>
% Bars 211 to 215
...
% Bars 226 to 230
	...
	\time 6/8 << c2.~ {\hairpinShorten #'(0 . -1.5) s8\> s s  s s s\!}>>
	c4 r8 r4 r8
	\time 3/8 R4.
	\time 6/8 R2.*3
% Bars 231 to 235
...
% Bars 236 to 240
	...
	bes\brack\pp~
	bes
	c->\fp^\pocoapococrescendo
	bes\fp
% Bars 241 to 245
	bes\fp
	bes\fp
	b!\fp
	<< \hairpinShorten #'(-0.5 . -1) c\fp\< {s8 s s  s s s\!}>>
	cis2.~\f\<
% Bars 246 to 250
	<< cis {s8 s s  s s s\!}>>
	cis8-.\fz r r r4 r8
...
% Bars 271 to 275
	...
	d'4.->~_\pocoapoco_cresc d4 g,16-. a-.
% Bars 276 to 280
	b8-.\< c-. d-. e-.[ fis-. r16 g]\!
	g2.\fz
	R2.*2
...
% Bars 326 to 330
	...
	R2.
	r4 r8 ees\f-^ ees-^ ees-^
	r des-.\p aes-. r des-. aes-.
	r des-. aes-. ees'-^\f ees-^ ees-^
% Bars 331 to 335
	R2.
