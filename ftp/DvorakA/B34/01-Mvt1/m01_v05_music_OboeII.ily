...
% Bars 11 to 15
	...
	bes_\crescmarkup
	ges4.\fz g4( aes8)
	ees4.-\offset X-offset -1 _\brackM\dimmarkup d\p
% Bars 16 to 20
...
% Bars 76 to 80
	<< R2. {s8 \tempoXoffset #-2.5 s4 s4.} >> \mark \default
	ges,2.\pp~
...
% Bars 91 to 95
	ces4.(->_\brackpppocoa_pococresc bes)
	aes( ges4 ees8)\<
	des4( ges8 f4 aes8)\!
	f'4.( ees4\< ces8)
	bes4. aes4( ces8)\!
...
% Bars 146 to 150
	d
	c^^-\offset X-offset #-1.5 \brack\f~
	<< c {s8\< s s s s s\!}>>
	ees!4(\f\< d8 des4.\brack\fz~
	des4) r8 r4 r8
% Bars 151 to 155
	R2.*7
% Bars 156 to 160
...
% Bars 171 to 175
	<< \hairpinShorten #'(-0.5 . -0.5) c2.(~\fz\> {s8 s s s s s\!}>>
	c4._\dimmarkup b)
	e,2.-\offset X-offset -2 _\fpdim~
	<< e~ {s8\> s s  s s s\!}>>
	e8 r r r4 r8
% Bars 176 to 180
	c'2.(\fz\>~
...
% Bars 206 to 210
	...
	<< d2. {s8\> s s  s s s\!}>>
% Bars 211 to 215
	dis2.-\offset X-offset #-1 _\ppcrescpocoapoco~
	dis~
	dis
	\hairpinShorten #'(1.5 . 0) e(\<
...
% Bars 236 to 240
	...
	ees2.(~\brack\pp
	ees4\< aes16)\![ r32 g-.] f4(\> ees8)\!
	\hairpinShorten #'(-0.5 . -0.5) f2.\fp\<^\pocoapococrescendo
	bes-\offset X-offset 0.5 \fz
% Bars 241 to 245
	a\fz
	bes\fz
	bes\fz\<
	<< \markEO #'(0 . 2.3) c_\fzmarkup {s8 s s  s s s\!}>>
	fis,2.\fz\<~
% Bars 246 to 250
	<< fis { s8 s s  s s s\!}>>
	fis\fz-. r r r4 r8
