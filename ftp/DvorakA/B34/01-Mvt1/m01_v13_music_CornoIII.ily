...
% Bars 76 to 80
	...
	aes4 r8 r4 r8
% Bars 81 to 85
	r4 r8 << \hairpinShorten #'(-0.5 . -3) aes4.\p\< {s8 s s\!}>>
	bes2.
	<< aes~ {s8\> s s  s s s\!}>>
...
% Bars 136 to 140
	...
	<< fis2.->-\offset X-offset -0.5 \brack\mf~ {s4. s\< }>>
	fis4.\! << g {s8\> s s\!}>>
% Bars 141 to 145
...
% Bars 161 to 165
	\textMark "Vi-" \time 6/8 c-> bes-> a-> bes-> a-> bes->
	\time 3/4 a-> r bes-> r c-> r \textEndMark "-de"
	\time 6/8 c-> bes-> a-> bes-> c-> bes->
	bes4.-^\ff r4 r8
	bes4.\ff r4 r8
% Bars 166 to 170
	aes4.\brack\fz r4 r8
	g4.\brack\fz r4 r8 \mark \default
	g8\brack\fz r r r4 r8
	R2.*2
	
% Bars 171 to 175
	<< \hairpinShorten #'(-0.3 . -2) a2.\fz\>~ {s8\> s s  s s s\!}>>
	a2._\dimmarkup
	b8\pp-. b-. b-. r4 r8
	b-. b-. b-. r4 r8
	b-. b-. b-. r4 r8
...
% Bars 201 to 205
	b4. r4 r8
	gis4. r4 r8
	<<\hairpinShorten #'(-0.5 . 0.3) b2.\brack\pp\<~ {s8 s s  s s s}>>
	<< \hairpinShorten #'(-0.3 . 0) b2. {s8\> s s  s s s\!}>>
...
% Bars 206 to 210
	...
	<< c2. {s8\> s s  s s s\!}>>
% Bars 211 to 215
	r8 bes4_\brackpcrescpocoapoco r8 bes4
	r8 bes4 r4 r8
	r8 bes4 r8 bes4
	r8 b!4\< r4 r8
	r c4 r8 c4\! \mark \default
% Bars 216 to 220
	a2.\ff-^
	d-^
	d4.-^ cis-^
...
% Bars 236 to 240
	...
	aes'2.\fp^\pocoapoco_crescendo
	f\fp
% Bars 241 to 245
	g\fp
	f\fp
	g\fp
	<< \hairpinShorten #'(-0.5 . -1.5) g\fp {s8\< s s  s s s\!}>>
	bes2.~\f\<
% Bars 246 to 250
	<< bes {s8 s s  s s s\!}>>
	bes8-.\fz r r r4 r8
...
% Bars 256 to 260
	b4.~ b4 b8\pp
	b8-.\< b-. b-. b-. b-. b-.\!
	\hairpinShorten #'(-0.5 . -1) b4.->~\fp\> b4\! b8-.
	b4.-!\> b-!\!
	b4.\pp~ b4 b8-.
% Bars 261 to 265
	b4.-! b-!
...
% Bars 291 to 295
	f8)-. r r r4 r8
	\marcatoUpperSlur \shape #'((0 . 1)(0 . 0.6)(0 . 0.5)(0 . 0)) Slur f2.-^(
	g8-.) r r r4 r8
	g2.\fz(
	\marcatoUpperSlur aes8)-^ r r r4 r8
% Bars 296 to 300
	aes2.\fz^\pocoapoco_crescendo
	ges4->\mf f->\< ees->\!
	g!-> f->\< e!->\!
	aes-> g->\< f->\!
	bes-> a!->\< g->\!
