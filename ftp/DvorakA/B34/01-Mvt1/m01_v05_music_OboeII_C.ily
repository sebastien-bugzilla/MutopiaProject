...
% Bars 6 to 10
	...
	\shape #'((0.5 . 2.5)(0 . 1)(0 . 0.5)(0 . 0)) Slur ees'4.(\brack\pp d16 ees f ees\< d ees)
	<< ees4( {s8 s\!}>> aes16)[ a32\rest g-.] f4(\> ees8)\!
	ees4.( d16 ees f ees d ees)
% Bars 11 to 15
	ees4(^\brack\fz aes16)[ a32\rest g-.] f4(\> ees8)\!
	f2.
	bes
	ges4.\fz g4( aes8)
	ees4. d\p
% Bars 16 to 20
	...
	ges4.-\offset X-offset 0.5 \fz f16( ges aes ges f ges)
	f4.-\offset X-offset 0.5 \fz c'16( des ees des c des)
	\time 3/8 ges4.->\ff
...
% Bars 36 to 40
	d!4.(\ff des)
	c( ces)
	\time 3/4 bes8 r f r ges r
	\time 6/8 ees'16(\< des) ges( f) f( ees) ees( des) des( ces) a( bes)\!
	\time 3/4 bes8 r f r ges r
% Bars 41 to 45
	\time 6/8 ees'16(\< des) aes'( ges) ges( f) f( ees) ees( des) des( ces)\!
	\time 3/8 ces(\< bes) bes( aes) aes( ges)\! \mark \default
	\time 6/8 des'4\fz des16.-. c32-. c4->( bes8)
...
% Bars 51 to 55
	...
	\dynEO #'(-0.5 . 0) ees4.\ff d16( ees f ees d ees)
	ees4.~ ees4 ees,16 f
...
% Bars 56 to 60
	...
	c'4.\fz~ c
	bes4. d16(\< ees f ees d ees)\!
	c2.\brack\fz
% Bars 61 to 65
	f,4(\< des'16)[ c32\rest c-.] c4( bes8)\!
...
% Bars 91 to 95
	ces4.(-> bes)
	aes ges4 \once \stemUp \omitFlag ees8\<
	des4( ges8 f4 aes8)\!
	f'4. ees4\< ces8
	bes4. aes4( ces8)\!
% Bars 96 to 100
...
% Bars 106 to 110
	...
	\markEO #'(0.5 . 0.5) des,2.~_\brackfppocoapococresc
	des
	d!~
	d
% Bars 111 to 115
...
% Bars 121 to 125
	...
	des2.\fp(
	<< f,) {\hairpinShorten #'(1 . 0) s8\< s s\! s\> s s\!}>>
	ges4 r8 r4 r8
% Bars 126 to 130
	R2.*3
	
	
	e2.-\offset X-offset 0.8 \fp~
	<< e {s8\< s s  s s s\!}>>
% Bars 131 to 135
	<< e2.\>~ {s8 s s  s s s\!}>>
	e4 r8 r4^\soli e'16(\p dis 
	e8)\< fis-. g-.\> g\! r r
	R2.
	R2.*8
% Bars 136 to 140
...
% Bars 146 to 150
	...
	c-^\brack\f~
	<< c {s8\< s s  s s s\!}>>
	\shape #'((0 . 0.5)(0 . 0.5)(0 . 0.5)(0 . 0)) Slur ees!4(-\offset X-offset -1 \f\< d8 des4.\brack\fz~
	des4) r8 r4 r8
% Bars 151 to 155
	R2.*9
% Bars 156 to 160
	...
	\time 3/4 a'16(\f bes c bes) a( bes c bes) a( bes c bes)
% Bars 161 to 165
	\time 6/8 a( bes) c( bes) bes( aes) aes( g) g( f) f( ees)
	\time 3/4 a( bes c bes) a( bes c bes) a( bes c bes)
	\time 6/8 a( bes) c( bes) bes( aes) aes( g) g( f) f( ees)
...
% Bars 176 to 180
	...
	e dis
% Bars 181 to 185
	d!4) \tuplet 3/2 8 {cis16(\< d e)\!} d4.-\tweak X-offset 0.5 \fz(~
	<< d\> {s8. s}>> cis4.)\!
	fis2.\pp~
	fis4 r8 r4 r8
	R2.
...
% Bars 201 to 205
	...
	<< cis'~ {s8\< s s s s s\!}>>
	<< cis2. {s8\> s s s s s\!}>>
	d8 r r f,4.-\tweak X-offset 0.5 \pp~
% Bars 206 to 210
	f2.~
	f~
	f
...
% Bars 216 to 220
	...
	g-^ fis-^
	e-^ d-^
	\hairpinShorten #'(0 . -3.5) a'4->(\< g8)\! f!4->( e8)
% Bars 221 to 225
	\hairpinShorten #'(0 . -4.5) b'4(->\< a8)\! g4->( fis8)
	c'4(->\< b8)\! a4->( gis8)
	a4(->\< gis8)\! a4->( gis8)
	d2.\fff
	d8 r r bes r r
% Bars 226 to 230
	...
	\time 6/8 << d,2.~ {s8\> s s  s s s\!}>>
	d4 r8 r4 r8
	\time 3/8 R4.
	\time 6/8 ees2.~-\offset X-offset 1.5 \pp
% Bars 231 to 235
	ees~
	ees
	ees~-\offset X-offset 1 _\fpsempredim
	ees
	ees2.\brack\p(~
% Bars 236 to 240
	...
	ees2.(~\brack\pp
	ees4\< aes16)\![ r32 g-.] f4(\> ees8)\!
	f2.-\offset X-offset 1.5 _\fppocoa_pococresc
	bes-\offset X-offset 0.5 \fz
% Bars 241 to 245
	a-\offset X-offset 0.5 \fz
	bes-\offset X-offset 0.5 \fz
	bes-\offset X-offset 0.5 \fz\<
	<< \markEO #'(0.5 . 2) c_\fzmarkup {s8 s s  s s s\!}>>
	fis,2.\fz\<~
% Bars 246 to 250
	<< fis { s8 s s  s s s\!}>>
	fis\fz-. r r r4 r8
...
% Bars 256 to 260
	<< cis2. {s4. s\!}>>
	a8-.\< a-. a a-.[ a-. r16 a-.]\!
	a4.-\offset X-offset 0.5 \fp\>~ a4\! a8
	a4.\> << a {s8 s s\!}>>
	a4.\pp~ a4 a8
% Bars 261 to 265
	a4.-! a-!
...
% Bars 281 to 285
	bes4.-^ bes-^
	<< ees2. {s8\< s s  s s s\!}>>
	ees8\ff r ees16.-. d32-. d4( c8)
	r4 aes'16.-. g32-. g4( f8)
	r4 d16.-. c32-. c4( b8)
% Bars 286 to 290
	r4 g'16.-. fis32-. fis4( e8)
...
% Bars 316 to 320
	f4. f8-.\f r r
	ees4.\ff-^ d16( ees f ees d ees)
	ges4 des16-. ees-. f8-.-^ ges-.-^ aes-.-^
	ges4-^ bes,16-. c-. bes8-.-^ c-.-^ d!-.-^
	ees2.-^
% Bars 321 to 325
	des
	des4.( d8) r r
