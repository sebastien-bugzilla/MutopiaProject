...
% Bars 86 to 90
	bes'4(-\offset X-offset -1.5 _\fzbrackcresc g8) r
	c4(\fz aes8) r
	des4(\fz bes8) r
	ees4(\fz c8) r
	R2
% Bars 91 to 95
	f,8.[\fp-\offset X-offset -1.5 ^\solo bes16( f8) r16 ees](
	f8.)[ bes16( f8) r16 ees](
	f8.)[ bes16( f8) r16 ees](
	f4)\fz r8. bes16(
	f8.)[ bes16( f8) r16 ees](
...
% Bars 366 to 370
	\restPattern fis'8\fp b16( fis8) e16(
...
% Bars 471 to 475
	bes\!
	\tuplet 3/2 2 {ges4\brack\p\< ges ges
	ges ges ges\!}
	R2*2
...
% Bars 476 to 480
	...
	\tuplet 3/2 2 {e4\p\< b' a
% Bars 481 to 485
	gis fis e\!}
	R2*2
	\mark \default
	\scaleDurations 2/3 {
		\tempoXoffset #4 \timeSignature 3/4 gis2.\ff~
		gis
% Bars 486 to 490
		\key e \major a~
		a
...
% Bars 586 to 590
	eis4..)-> cis!16\!
	<< \hairpinShorten #'(-0.5 . -1) ais'2-\offset X-offset #-0.5 \fz\>~ {s8 s s s\!}>>
	ais2~
	ais4 r
	R2
% Bars 591 to 595
...
% Bars 606 to 610
	...
	e
	fis)\!
	<< \hairpinShorten #'(-0.5 . -0.5) gis-\offset X-offset -1 \f\<~ {s8 s s s\!}>>
	gis2~\>
% Bars 611 to 615
	<< gis~ {s4 s\!}>>
