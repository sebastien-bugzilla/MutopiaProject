...
cueVoiceTrombeIMvtI = \relative c {
	...
	\transpose f c' {
		\relative c'' {
			\ottava #1 f4(-\offset X-offset -3 ^\markup {Fl.I.} des'16)[ r32 c-.] c4( bes8)
			bes4( ges'16)[ r32 f-.] f4( ees8)
			ees4.(~ ees16 d f ees ces aes)
			ges4. f4( bes8) \ottava #0
		}
	}
	...
	\transpose f c' {
		\relative c''' {
			\ottava #1 aes4.^\markup {Viol.I.} ges4( bes8)
			bes4. aes4( c8) \ottava #0
		}
	}
	s2.*23
	% bars 183 - 185
	\transpose f c' {
		\relative c''' {
			b4.(-\offset X-offset #-6 ^\markup {Viol.I.} ais)
			gis( fis)
			e( dis) 
		}
	}
...
cueVoiceTrombeIMvtII = \relative c {
	...
	\transpose f c' {
		\relative c''' {
			bes2-\offset X-offset -4 ^\markup {Fl.I.}
			b
		}
	}
	s2*25
	...
	\transpose e c {
		\relative c {
			\voiceTwo \clef bass r4^\markup {Timp.} r8 r16 \tuplet 3/2 16 {gis32-\offset X-offset -1.5 \f-^ gis-^ gis-^}
...
cueVoiceTrombeIMvtIII = \relative c {
	...
	\transpose f c' {
		\relative c''' {
			\voiceOne \stemDown r4^\markup {Viol.I.} r8. \ottava #1 bes16(
			\restPattern f'8) e16( g8) e16\laissezVibrer \ottava #0 \oneVoice \stemNeutral
		}
	}
	s2*46
	% bars 61 - 64
	...
	s2*134
	% bars 456 - 460
	\ottava #-1 \voiceTwo r4^\markup {Cor.III.IV.} <c, c'>~
	q2~
	q~
	q~
	q \oneVoice \ottava #0
	...
	\transpose f c' {
		\relative c''' {
			\voiceOne \stemDown r8.-\offset X-offset -2 ^\markup {Fl.I.} \ottava #1 fis16[(\f dis8) r16 b](
			cis4) r
			r8. gis'16[( e8) r16 cis-.] \ottava #0 \oneVoice \stemNeutral
		}
	}
	s2*45
	% bar 569
...
cueVoiceTrombeIIMvtI = \relative c {
	...
	s2.*28
	% bars 214 - 215
	\voiceTwo <b d>2.(^\markup {Cor.}-\tweak extra-offset #'(2 . 2.5) _\crescmarkup
	<c ees>) \oneVoice
	s2.*13 s4.*1 s2.*46
	% bars 276 - 277
	\voiceTwo b8-.^\markup {Cor.I.II.} c-. d-. e-.[ fis-. r16 g-.]
	g2.\fz \oneVoice
}
cueVoiceTrombeIIMvtII = \relative c {
	...
	\transpose f c' {
		\relative c''' {
			bes2-\offset X-offset -3.8 ^\markup {Fl.I.}
			b
		}
	}
	s2*25
	...
	\transpose e c {
		\relative c {
			\voiceTwo \clef bass r4^\markup {Timp.} r8 r16 \tuplet 3/2 16 {gis32-\offset X-offset -1.6 \f-^ gis-^ gis-^}
			cis8 r r8. \tuplet 3/2 16 {gis32-^ gis-^ gis-^} \oneVoice \clef treble
		}
	}
}
cueVoiceTrombeIIMvtIII = \relative c {
	...
	\transpose f c' {
		\relative c''' {
			\ottava #1 \voiceOne \stemDown r4^\markup {Viol.I.} r8. bes16(
			\restPattern f'8) e16( g8) e16\laissezVibrer \oneVoice \stemNeutral \ottava #0
		}
	}
	s2*46
	% bars 61 - 64
	...
	s2*82
	% bars 456 - 460
	\voiceTwo \ottava #-1 r4^\markup {Cor.III.IV.} <c, c'>~
	q2~
	q~
	q~
	q \oneVoice \ottava #0
	...
	\transpose f c' {
		\relative c''' {
			\ottava #1 \voiceOne \stemDown r8.-\offset X-offset -4 ^\markup {Fl.I.} fis16[(\f dis8) r16 b](
			cis4) r
			r8. gis'16[( e8) r16 cis-.] \oneVoice \stemNeutral \ottava #0
		}
	}
	s2*45
	% bar 569
...
cueVoiceTrombonoIMvtI = \relative c {
	s2.*11
	% bars 12 - 15
	\clef treble f''4(\p-\offset X-offset #-4 ^\markup {Fl.I.} des'16)[ r32 c-.] c4( bes8)
	bes4( ges'16)[ r32 f-.] f4( ees8)
	ees4.(~ ees16 d f ees ces aes)
	ges4. f4( bes8) \clef alto
	s2.*3 s4.*1 s2.*22 s4.*1 s2.*51
	% bars 94 - 95
	\stemUp aes,4.(-\offset X-offset -3 _\markup {Tr.I.} ges4 ees!8
	des4 ges8 f4 aes8) \stemNeutral
	s2.*47
	% bars 143 - 146
	\stemUp g4.-\offset X-offset -3 ^\markup {Cor.} fis
	e d
	g fis
	e d \stemNeutral
	s2.*82 s4.*1 s2.*15
...
cueVoiceTrombonoIMvtII = \relative c {
	...
	s2*43
	% bar 89
	<>-\offset X-offset -2.5 _\markup {Cor.I.}
	s2*31
	% bars 120 - 123
	...
	s2*27
	% bars 197 - 198
	\clef treble \voiceOne bes'2-\offset X-offset -2 ^\markup {Fl.}
	b \clef alto \oneVoice
	s2*29 s4*1 s2*14
	% bars 243 - 244
	\clef bass \voiceTwo r4 r8^\markup {Timp.} r16 \tuplet 3/2 16 {gis,,,32-\offset X-offset -1.5 \f gis gis}
...
cueVoiceTrombonoIMvtIII = \relative c {
	...
	s2*34
	% bars 99 - 102
	\voiceOne \clef treble <ees ees'>4-^-\offset X-offset -4 ^\markup {Trbe} r
	q r
	q r 
	...
	s2*84
	% bars 252 - 254
	\voiceOne <f a c>2~-\offset X-offset -3 ^\markup {Cor.}
	q~
	q \oneVoice
	s2*11
	% bars 266 - 271
	...
	s2*47
	% bars 319 - 321
	\voiceOne aes2-\offset X-offset -4 ^\markup {Cor.I.}
	f
	ees \oneVoice
	s2*134
	% bars 456 - 460
	...
	ees4.. bes16
	ees4.. bes16
	ees4..-\offset X-offset -1 ^\markup {Cor.III.IV} bes16 \clef alto \oneVoice \stemNeutral
	s2*37
	% bars 521 - 523
	\clef treble \voiceOne \stemDown r8.-\offset X-offset -1.5 ^\markup {Fl.I.} fis'''16([ dis8) r16 b](
	cis4) r
	...
	s2*48
	% bars 680 - 685
	\clef treble \voiceOne <e e'>4(-\offset X-offset #-3 ^\markup {\column {\lower #1.5 "Cor." "Tbe."}} <ees ees'>
	<d d'> <cis cis'>)
	s2
	<e e'>4( <ees ees'>
	<d d'> <cis cis'>)
...
cueVoiceTrombonoIIMvtI = \relative c {
	s2.*11
	% bars 12 - 15
	\clef treble f''4(\p-\offset X-offset -3 ^\markup {Fl.I.} des'16)[ r32 c-.] c4( bes8)
	bes4( ges'16)[ r32 f-.] f4( ees8)
	ees4.(~ ees16 d f ees ces aes)
	ges4. f4( bes8) \clef tenor
	s2.*3 s4.*1 s2.*22 s4.*1 s2.*51
	% bars 94 - 95
	aes,4.(^\markup {Tr.I.} ges4 ees8
	des4 ges8 f4 aes8)
	s2.*47
	% bars 143 - 146
	g4.^\markup {Cor.III.IV.} fis
	e d
	g fis
	e d
	s2.*82 s4.*1 s2.*15
...
cueVoiceTrombonoIIMvtII = \relative c {
	...
	s4*1 s2*9
	% bars 44 - 45
	r8^\markup {Cl.} fis'~ \tuplet 6/4 4 {fis16 eis fis a gis fis}
	fis8 fis(~ \tuplet 3/2 8 {\once \tupletUp fis16 eis fis} a32[ gis r gis]) \clef tenor
	s2*43
	% bar 89
	<>-\offset X-offset -2 _\markup {Cor.I.}
	s2*31
	...
	s2*29 s4*1 s2*14
	% bars 243 - 244
	\clef bass \voiceTwo r4 r8^\markup {Timp.} r16 \tuplet 3/2 16 {gis,,,32-^-\offset X-offset -1.7 \f gis-^ gis-^}
...
cueVoiceTrombonoIIMvtIII = \relative c {
	...
	s2*24
	% bar 374
	<>-\offset X-offset -3 ^\markup { "Cor.I.II. Tbrne I."}
	s2*82
	% bars 456 - 460
	r4^\markup {Cor.III.IV.} \voiceOne <f f'>4~
	q2\<~
	...
	ees4.. bes16
	ees4.. bes16
	ees4..-\offset X-offset -1 ^\markup {Cor.III.IV} bes16 \clef tenor \oneVoice
	s2*37
	% bars 521 - 523
	\clef treble \voiceOne \stemDown r8.-\offset X-offset -1.5 ^\markup {Fl.I.} fis'''16([\f dis8) r16 b](
	cis4) r
...
cueVoiceTrombonoIIIMvtI = \relative c {
	s2.*11
	% bars 12 - 15
	\clef treble \ottava #1 f''4(\p-\offset X-offset -4 ^\markup {Fl.I.} des'16)[ r32 c-.] c4( bes8)
	bes4( ges'16)[ r32 f-.] f4( ees8)
	ees4.(~ ees16 d f ees ces aes)
	ges4. f4( bes8) \ottava #0 \clef bass
	s2.*3 s4.*1 s2.*22 s4.*1 s2.*51
	% bars 94 - 95
	\clef treble aes,4.(^\markup {Tr.I.} ges4 ees8
	des4 ges8 f4 aes8) \clef bass
	s2.*47
	% bars 143 - 146
	...
	% bars 276 - 277
	\clef treble \voiceTwo e8-.^\markup {Cor.I.} f-. g-. a-.[ b-. r16 c-.]
	c2.\fz \clef bass \oneVoice
}
cueVoiceTrombonoIIIMvtII = \relative c {
	s2*29
	% bars 30 - 33
	cis'8^\espr-\offset X-offset -1 ^\markup {Cor.I.} gis'16. fis32-. fis8( e)
	r8 gis16. fis32-. fis8( e)
	r gis16. fis32-. fis8( e)
	...
	s2*31
	% bars 120 - 123
	\clef treble \voiceTwo a,4.^\markup {Cor.I.} gis8
	a4. a8
	bes4. bes8
	...
	s2*27
	% bars 197 - 198
	\clef treble \voiceOne bes'!2-\offset X-offset -3.5 ^\markup {Fl.}
...
cueVoiceTrombonoIIIMvtIII = \relative c {
	...
	ees4.. bes16
	ees4.. bes16
	ees4..-\offset X-offset -1 ^\markup {Cor.III.IV} bes16 \clef bass \oneVoice
	s2*37
	% bars 521 - 523
	\clef treble r8.-\offset X-offset -1.5 ^\markup {Fl.I.} fis'''16([\f dis8) r16 b](
	cis4) r
	r8. gis'16[( e8) r16 cis]-. \clef bass
	s2*104
	% bars 628 - 631
	\voiceOne fis,,2-\offset X-offset #-6 ^\markup {Cor.I.II.}
	e
	ees
	des \oneVoice
	s2*48
...
cueVoiceTubaMvtIII = \relative c {
	s2*60
	% bars 61 - 64
	\clef treble \voiceTwo aes''!2^\markup {Cor.I.}
	f
	ees~
	...
	s2*63
	% bars 456 - 460
	r4-\offset X-offset -6 ^\markup {Cor.III.IV.} <f f'>4~
	q2\<~
	q~
	q~
	q\!
	...
	s2*37
	% bars 521 - 523
	\clef treble r8.-\offset X-offset -2 ^\markup {Fl.I.} fis'''16([\f dis8) r16 b](
	cis4) r
	r8. gis'16[( e8) r16 cis]-. \clef bass
	s2*104
	% bars 628 - 631
