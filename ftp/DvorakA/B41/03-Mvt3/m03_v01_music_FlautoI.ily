...
% Bars 136 to 140
	...
	\keyExtraSpace #'(extra-space . 2.5) \key c \major \time 2/4 \newSpacingSection \mmrLength #20 R2*15
% Bars 141 to 145
...
% Bars 171 to 175
	...
	a4_\fzf\startTrillSpan~ a8[\stopTrillSpan r16 g-.]
	a4\fz~\startTrillSpan a8[\stopTrillSpan r16 g-.]
	a4-> c->
	b-> a->
% Bars 176 to 180
	\dynEO #'(0 . 1) g4\fz\startTrillSpan~ g8[\stopTrillSpan r16 fis-.]
...
% Bars 181 to 185
	...
	f4-> a-> \mark \default
	g8\fz r r4^\mutainfligrande
	R2*7
	
% Bars 186 to 190
	
% Bars 191 to 195
	e'4\ff~\startTrillSpan e8[\stopTrillSpan r16 d-.]
...
% Bars 201 to 205
	b4-> c->
	b-> g->
	d'4\f\startTrillSpan~ d8[\stopTrillSpan r16 c-.]
	d4\f\startTrillSpan~ d8[\stopTrillSpan r16 c-.]
	d4-> e->
% Bars 206 to 210
	d-> b16-.\< b32( c d e f g)\!
	a4\fz\startTrillSpan~ a8[\stopTrillSpan r16 gis-.]
	a4\brack\fz\startTrillSpan~ a8[\stopTrillSpan r16 gis-.]
	a4-> c->
	b-> a8-.\< c,32( d e f)\!
% Bars 211 to 215
	...
	g4-> b->
	a-> g->
	f4..\brack\fz\startTrillSpan e16-.\stopTrillSpan
% Bars 216 to 220
	f4..\brack\fz\startTrillSpan e16-.\stopTrillSpan
	f4-^ aes-^
	g-^ f-^ \mark \default
...
% Bars 326 to 330
	...
	\markEO #'(0 . 1.45) fes->_\fzmarkup \markEO #'(0 . 1.7) ees->_\fzmarkup\!
% Bars 331 to 335
	r2 e!4-._\pcresc f!2-> e4-.
	r2 e4-. f2-> e4-.
	r2 e4-.\< f2-> e4-.
...
% Bars 341 to 345
	\key d \major \time 2/4 d,4->~_\fffz d8[ r16 cis-.]
	d4->\fz~ d8[ r16 cis-.]
	d4-> fis->
	e-> d->
	cis4.->\fz r16 bis-.
...
% Bars 361 to 365
	...
	\mmrLength #20 \tempoXoffset #-3 R2*10
% Bars 366 to 370
