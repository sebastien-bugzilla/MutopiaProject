...
% Bars 26 to 30
	<c f> <f a> q <c f> <f a> q 
	<c f> <f a> q_\crescmarkup <bes, e> <e g> q 
	<a, c> <a f'> q <a c> <a f'> q 
	<a c> <a f'> q <c f> <f a> q
...
% Bars 31 to 35
	...
	<c f> <f a> q <c f> <f a> q 
	<c e> <e a> q <c e> <e a> q 
	<c e> <e g> q_\crescmarkup <c e> <e g> q 
	<c e> <e g> q <b d> <b g'> q
% Bars 36 to 40
	<c e> <e g> q <c e> <e g> q 
...
% Bars 51 to 55
	...
	<c e>( <e a>) q-. c( e) e-.
	d( e) e-. d( e) e-. \mark \default
% Bars 56 to 60
	<e cis' a'>\f r d-.\< cis( e) a,-.\!
	bes-.\fz r r r2 r4
	R1.
	<e a e'>4\f r d-.\< cis( e) a,-.\!
	bes->\fz r r r2 r4
% Bars 61 to 65
	r2 e4-.\< e( g) bes,-.\!
	c-.\fz r r r2 r4
...
% Bars 76 to 80
	\key d \major <d, d'>4-\offset X-offset -2 \ff r r r2 r4
...
% Bars 86 to 90
	...
	<d a' fis'>\arpeggio r r r2 r4
	<fis a fis'>\arpeggio r r r2 r4
	<e b' gis'>\arpeggio r r r2 r4
	<e cis' a'>\arpeggio r r r2 r4
% Bars 91 to 95
	q\arpeggio r r r2 r4
	<g,! g'! d'>\arpeggio r r r2 r4
	<d' b' g'>\arpeggio r r r2 r4
	<d a' fis'>\arpeggio r r r2 r4
	q\arpeggio r r r2 r4
% Bars 96 to 100
	<fis a fis'>\arpeggio r r r2 r4
...
% Bars 101 to 105
	<d b' g'>\arpeggio r r r2 r4
	<d a' fis'>\arpeggio r r r2 r4
	<fis cis' fis>\arpeggio r r r2 r4
	<eis cis' gis'>\arpeggio r r r2 r4
	<fis cis' a'>\arpeggio r r r2 r4
% Bars 106 to 110
	<fis d' b'>\arpeggio r r r2 r4
	<d b' g'>\arpeggio r r r2 r4
	<fis a fis'>\arpeggio r r r2 r4
	<gis b gis'>\arpeggio r r r2 r4 \mark \default
	<fis ais fis'>-\offset X-offset 0.5 \ff  r r q r r
% Bars 111 to 115
	q r r q r r
	q r r q r r
	eis( fis) cis-. a'!( ais) fis-.
...
% Bars 151 to 155
	...
	\mark \default
% Bars 156 to 160
	\tuplet 3/2 4 {c8(-\offset X-offset -8 _\pdolce e g)} g4(~
	\tuplet 3/2 4 {g8 fis g)} g4(~
	\tuplet 3/2 4 {g8 fis g) r gis(\< a)
	r ais( b) r \stemUp b( c)\! \stemNeutral
	b(\p cis d)} d4(~
% Bars 161 to 165
	\tuplet 3/2 4 {d8 cis d)} d4(~
	\tuplet 3/2 4 {d8 ais b) r gis(\< a)
	r fisis( gis)\! r gis(\> a)
	fis(\! b\< d)} d4(~
	\tuplet 3/2 4 {d8 cis d)} d4(~\!
% Bars 166 to 170
	...
	r cis( d!) r ais( b)
	b(-\offset X-offset -3 _\crescmarkup d fis)} fis4(~
...
% Bars 181 to 185
	...
	g,8_\fzmarcatobrackpocoapococresc \dynEO #'(-0.8 . -1.5) f->[^\mf a-> g->]
	f[-> c'-> b-> a]->
	e'[-> d-> c-> a']->
% Bars 186 to 190
	...
	r4 a'16->\f g-> f-> e->
	d-> c-> b-> a-> g(\< fis g a
	\tupletUp \tuplet 5/4 {b a b c d)} \tuplet 7/4 {\shape #'((0 . 0)(0 . -0.3)(0 . -0.3)(0 . 0)) Slur e( f! g <a, a'> <b b'> <c c'> <d d'>\!)} \tupletNeutral
% Bars 191 to 195
	\dynEO #'(0.5 . 2) <e c'>4\ff\startTrillSpan~ q8[\stopTrillSpan r16 <d b'>]-.
	<e c'>4\startTrillSpan~ q8[\stopTrillSpan r16 <d b'>]-.
	<e c'>4(\< <a f'>8 <g e'>)\!
	<f d'>4-> <e c'>->
...
% Bars 196 to 200
	...
	<d b'>4-> <f a!>->
	<e gis>-> <c a'>->
	\dynEO #'(0.5 . 1) <b d>4\fz\startTrillSpan~ q8[\stopTrillSpan r16 <a c>-.]
	<b d>4-\offset X-offset 0.5 \fz\startTrillSpan~ q8[\stopTrillSpan r16 <a c>-.]
% Bars 201 to 205
	<b d>4-> <c e>->
	<b d>-> <g b>->
	<d' b'>4\fz\startTrillSpan~ q8[\stopTrillSpan r16 <c a'>-.]
	<d b'>4\fz\startTrillSpan~ q8[\stopTrillSpan r16 <c a'>-.]
	<d b'>4-> <e c'>->
% Bars 206 to 210
	<d b'>-> <b g'>16-.\< q32( <c a'> <d b'> <e c'> <f d'> <g e'>)\!
	<a f'>4\fz\startTrillSpan~ q8[\stopTrillSpan r16 <gis e'>-.]
	<a f'>4\fz\startTrillSpan~ q8[\stopTrillSpan r16 <gis e'>-.]
	<a f'>4-> <c a'>->
	<b g'>-> <a f'>8-.\< <c, a'>32( <d b'> <e c'> <f d'>)\!
% Bars 211 to 215
	<g e'>4\fz\startTrillSpan~ q8[\stopTrillSpan r16 <fis dis'>-.]
	<g e'>4\fz-\tweak extra-offset #'(0 . -0.5) \startTrillSpan~ q8[\stopTrillSpan r16 <fis dis'>-.]
	<g e'>4-> <b g'>->
	<a f'>-> <g e'>->
...
% Bars 251 to 255
	aes4.-> r8
	aes4(-- \markEO #'(1 . 2.5) aes--_\dimmarkup
	aes-- aes--)
	aes4.\brack\pp r8
	aes4. r8
% Bars 256 to 260
	\markEO #'(-3.5 . 2) aes4--(_\dimmarkup aes--
	aes-- aes--)
	\hairpinShorten #'(2 . 2) aes--(-\tweak extra-offset #'(0 . 2.5) \< aes--\!
	aes-- aes--)_\crescmarkup
	\shape #'((0 . 0)(0 . 0.8)(0 . 0.8)(0 . 0)) Slur aes(-- aes--
% Bars 261 to 265
	aes-- aes--)
	\tuplet 3/2 4 {f'!8-. gis-. a!-. ais(\< b) g-.
	gis-. b-. c-. cis( d) b-.
...
% Bars 341 to 345
	...
	\dynEO #'(0 . 0.5) <a' e'>4:->-\offset X-offset 1 \fz q8[ r16 <fis dis'>-.]
% Bars 346 to 350
	\dynEO #'(0 . 0.5) <a e'>4:->-\offset X-offset 1 \fz q8[ r16 <fis dis'>-.]
	<a e'>4-^\arpeggio <e a g'>-^\arpeggio
	<e a g'>-^\arpeggio q-^\arpeggio
	<fis d'>4:->\fz q8[ r16 <fis cis'>-.]
	<fis d'>4:->\fz q8[ r16 <fis cis'>-.]
% Bars 351 to 355
	<fis d'>4-^ <d b' fis'>-^\arpeggio
	<fis cis' fis>-^\arpeggio <d b' g'>-^\arpeggio
	<d a' fis'>-^\arpeggio r
	R2*11
% Bars 356 to 360
...
% Bars 376 to 380
	...
	r8. d16\mp \tuplet 3/2 4 {d8( f) cis-.}
% Bars 381 to 385
	d8[ r16 d] \tuplet 3/2 4 {d8(_\crescmarkup f) cis-.
	d( f) cis-. d( f) cis-.
	d( f) d-. gis( a) f-.}
