...
% Bars 26 to 30
		...
		d1
		d2( f)
		d4( \hairpinShorten #'(2 . 0) c2)\< \tuplet 3/2 4 {b8(\! c d}
		c4) e2( d4 
% Bars 31 to 35
		c4) ees!2( d4)
		ees2 d8[(-> c]-> f-> ees->)
...
% Bars 26 to 30
		...
		<< \hairpinShorten #'(-0.9 . -1.5) bes1-\offset X-offset -3 \pdimD\> {s4 s s s8 s\!}>>
		<< g1\pp\<~ {s4 s s s8 s\!}>>
		g1_\crescmarkup
		g2\mf \hairpinShorten #'(0 . 1) c4.(\< \hairpinShorten #'(-1 . 0) b8)\>
% Bars 31 to 35
		c4\! bes!2.\pp(~
		bes4 ees) d8([->_\crescmarkup c]-> f-> ees->)
		<< d1 {s4_\crescmarkup s \hairpinShorten #'(0.8 . -0.5) s\> s8 s\!}>>
...
% Bars 41 to 45
	...
	d!4( c) bes4.(\< a!8)\!
	\hairpinShorten #'(0 . 1) a4->\< a-> \hairpinShorten #'(-1 . 0) bes\>( d)\!
	d4.(_\ppdim bes8 g4) r8-\offset X-offset -0.8 _\dolce g(
...
% Bars 46 to 50
	...
	\hairpinShorten #'(0 . -0.5) ees(\< g)-\offset X-offset 1.5 \crescD f8(-> ees-> d-> c->)
	bes4( << d2\> {s4 s}>> \tuplet 3/2 4 {c8\! d a)}
% Bars 51 to 55
	c2.(~ c8 bes) \markXoffset #-0.2 \mark \default
	r16 f(\mf\< bes d) f4~ f8\> f( ees des)\!
	f4( ees2) g8.( f16) \clef treble
	ees4 c'4.(\f\< bes8)\! \tuplet 3/2 4 {ees8( des c)}
	\hairpinShorten #'(0 . 1) c2~\> c16\!_\crescmarkup d,!( fis a) c8.( b16)
% Bars 56 to 60
	b4 c~ c16\> g( c d) d8( ees)
	ees4( d2)\!^\dolcemaespress f8( ees16 d)
	d8( c g bes) aes4.( g8) \clef bass
	f4(\< \tuplet 3/2 4 {ees8 f ees)\!} d4.(_\crescmarkup ees8)
	ees4(\< e) f( fis)\! \clef tenor
% Bars 61 to 65
	<< g2~ {\hairpinShorten #'(-1 . 0) s4\dimD\> s }>> g8 d4(\! bes8)
	g4(~\p g16 g d' g,) g4(~ g16 g f' g,)
	g8(\< a'~ \tuplet 3/2 4 {a8 g e)\!} g4(~_\crescmarkup \tuplet 3/2 4 {g8 f d)}
	a'(\< g c e,)\! g(\> e d f\!~
	f-\offset X-offset -0.5 _\dimmarkup e \hairpinShorten #'(-0.3 . -0.5) ees4.)\pp\< g8\!( \hairpinShorten #'(0.5 . 0) f\> d)\!
% Bars 66 to 70
	bes4( ees!\crescD\< d8 c f ees)\!
	d4(\> g)\! f(\p\> d8. c16)\!
	f1\pp~^\ileggio
	f~_\dimmarkup
	f2(\< g4\> a8 bes)\! \mark \default
% Bars 71 to 75
	bes1\pp
	g2( ees)
	d4( c2 f,4~
	f) \hairpinShorten #'(0 . -2.5) ces'(\< bes ees,~\!
	ees c) \clef bass f(_\dimmarkup f,)
% Bars 76 to 80
	bes16\pp\< r bes' r bes, r bes'\! r bes,\> r bes' r bes, r bes'\! r
	bes,\< r bes' r bes, r bes' r bes, r bes'\! r g32(\f\< f) f( ees) ees( d) d( c)\! \markXoffset #-0.2 \mark \default
	\hairpinShorten #'(0 . -2) bes2(\fp\> f)\!
	\hairpinShorten #'(-1 . 0) bes4(\> ees)\pp ees,2
...
% Bars 91 to 95
	...
	\time 2/4 ees8\>-\offset X-offset -1 ^\div bes'4( aes8)\! \clef tenor \section \mark \default
	\tempoXoffset #1 \time 4/4 ees'4(_\ppmaespress d des) r8 des
% Bars 96 to 100
	aes'4(\< g2)\! \tuplet 3/2 4 {f8(\> g aes)\!}
	<< g1( {s4 s \hairpinShorten #'(0 . 1) s\< s}>>
	<< e2 {s8 s s s\!}>> << \hairpinShorten #'(-1 . 0) d!2)\> {s8 s s s\!}>> \clef bass
	ees,,16^\pizz\p\< g bes ees bes'8 r f,16 aes des f aes8\! r
	g,16\< ees' bes'8 aes,16 ees' c'8 bes,16 ees g bes des8\! r
% Bars 101 to 105
	c,,16\mf-^ aes'-^\< c-^ ees-^ aes c ees c aes ges ees c aes8\! r
	des'4(^\arco_\fespress c!) ces-- r8 ces(
	bes2\>) a!4 \tuplet 3/2 4 {ges'8( f ees)\!}
	des4(\p\< aes'2) ees8.( f16)
	ges2.\>\tuplet 3/2 4 {ges8( f ees)\!}
% Bars 106 to 110
	des8\pp r r4 des,8\mf^\pizz des' des, r
	des_\dimmarkup des' des, r des\> des' des,\! r
	des r r4 r des'~\p\>^\arco
	des8\! ces,4->\pp( bes16 a!) << a2 \\ {a8( << \hairpinShorten #'(-0.5 . -2) des,4.)-\offset X-offset -1.5 \pp\> {s8 s s\!}>> }>>
...
% Bars 116 to 120
	...
	bes,[ r bes' r bes,_\crescmarkup r bes'] r bes,[ r bes'] r g32(\f\< f) f( ees) ees( d) d( c)\! \markEsw #'(1 . -3) \mark \default
% Bars 121 to 125
	<< \hairpinShorten #'(-0.5 . -0.5) bes1-\offset X-offset -1.5 \fp\> {s4 s s s8 s\!}>>
	<< \hairpinShorten #'(-0.7 . -1) bes1-\offset X-offset -1.5 \pp\< {s8 s s s \hairpinShorten #'(1 . -1) s\> s s s\!}>>
	\tuplet 6/4 4 {bes16(-\offset X-offset 0.5 \pp a bes a bes a  bes a bes a bes a)} bes8 r r4
	R1
	\tuplet 6/4 4 {bes16\((\pp c) c( d) d( ees)} f8\) r bes->^\pizz r r4
% Bars 126 to 130
	R1
	ges'4_\mffz r r \tuplet 3/2 4 {r8 des_\pdim des}
	ges,4 r r \tuplet 3/2 4 {r8_\crescmarkup g-\alterBroken shorten-pair #'(()(0 . 2)) \< g}
...
% Bars 131 to 135
	...
	bes,\> f' r f bes, f' r ges-.\!
	f1\ppp^\arco~
	f2 \tuplet 3/2 4 {bes,8(\<-\offset X-offset -1 _\molto d c)\!} ees4-\offset X-offset 0.5 \fz(~
% Bars 136 to 140
	ees2\p\> d4 c)\!
...
% Bars 26 to 30
	c4(\< cis)\! d(\> d,)\!
	<< \hairpinShorten #'(-0.9 . -1.3) g1-\offset X-offset -3 \pdimD\> {s4 s s s8 s\!}>>
	b4(\pp\< c << d2) {s8 s s s\!}>>
	b4(_\crescmarkup c) e,(\< g)\!
	c2(\mf \hairpinShorten #'(0 . -1.5) e,4\< \hairpinShorten #'(1.5 . 0) g)\>
% Bars 31 to 35
	c\! g2\pp bes4(
	ees) << c2( {s4 s_\crescmarkup}>> ees,4)
	d2( << f) {\hairpinShorten #'(0.8 . -0.5) s8\> s s s\!}>>
...
% Bars 41 to 45
	c2\p f,4.(\> g8)\!
	aes2\pp bes4.(\< c8)\!
	\hairpinShorten #'(0 . 1) c4->\< cis-> << \hairpinShorten #'(-1 . 0.5) d2\> {s8 s s s\!}>>
	g,2.\pp r4
	b4(\pp c d2)
% Bars 46 to 50
	b4(\< c)\! e,( g)
	...
	c) g4.\pp g8( bes4)
	ees,4( c2)-\offset X-offset 1.5 _\crescmarkup ees4
	<< {d2( f)} {s4 s\> s s\!}>>
% Bars 51 to 55
	a4(\p\> d) c( f,)\pp
	s1*11 \clef tenor
...
% Bars 61 to 65
	...
	g'8(\< a'~ \tuplet 3/2 4 {a8 g e)\!} g4(~_\crescmarkup \tuplet 3/2 4 {g8 f d)}
	a'(\< g c e,)\! g(\> e d f\!~
	f-\offset X-offset -0.5 _\dimmarkup e \hairpinShorten #'(-0.3 . -0.5) ees4.)\pp\< g8\!( \hairpinShorten #'(0.5 . 0) f\> d)\!
% Bars 66 to 70
	bes4( ees!\crescD\< d8 c f ees)\!
	...
	\clef bass
% Bars 71 to 75
	bes,,8^\pizz\p[ f'] bes, f' bes,[ aes'] bes, aes'
...
% Bars 91 to 95
	...
	f,8\repeatTie r r4 ees'!2\pp\<~ \section
	\time 2/4 << ees2~\> {s8 s s s\!}>> \section
	\time 4/4 ees1\pp~
% Bars 96 to 100
	ees~
	ees4 r r2
	\once \ni \tweak extra-offset #'(1.5 . 0) R1
% Bars 101 to 105
