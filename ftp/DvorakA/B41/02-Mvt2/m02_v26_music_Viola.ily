...
% Bars 31 to 35
	...
	r2 c'16(\>_\pmolto g bes ees, a f c ees)\! \mark \default 
	<< { 
		f1(^\tranquillo
% Bars 36 to 37.25
		bes4 g2.
...
% Bars 35 to 40
	...
	<f a>4) <fis a>2(\< <a c>4)\!
	<< {b4( c2) c8--( ees--)} \\ {g,2.\mf~ g8 a} >>
	<a d>2._\dimmarkup <bes d>8--( q--)
% Bars 41 to 45
	<g c>2\p <aes ces>4(\> <aes b>8-- <g b>--)\!
	<ees! aes>2\pp << {bes'4( d,8-- g--)} \\ {d4(\< d8 ees--)\!} >>
...
% Bars 46 to 51
	<< {
		...
		c4_\< e->(~ e8[\! c]_\>~ c-\dimmarkup b)\!
		c4 ees!(~ ees8 bes! d4)
		ees4-- ees--( d8-- c g4)
		<d g>( <g bes>_\dimmarkup a2~
		a) g4( <f a>8 bes) 
	} \\ {
		g2. g4
		<g c>2. <g d'>4
		g bes!(~\pp bes8 g aes4)
		g g2(_\crescmarkup f8 ees)
		\hideNotes d4( g \unHideNotes f2~
		f)_\pdim ees!
	}>> \mark \default
% Bars 52 to 55
...
% Bars 56 to 60
	...
	r16 <c,! ees>( <ees aes> <aes! c!> <c ees>4) r16_\crescmarkup << {d,( g bes) d8( c)} \\ {d,16 d( g) bes8( a)} >>
	r16 <ees a>( <g c> <a ees'> <a e'>4) r16 <d, f>( <f bes> <bes d> <a d>4)
% Bars 61 to 65
	r16 <d, g>( <g bes>_\brackM\dimmarkup <bes d> q4) r16 <d, g>( <g bes> <bes d> q4)
...
% Bars 66 to 70
	r << {ees( g bes)} \\ {ees, ees g} >> \tuplet 6/4 4 {r c,(_\crescmarkup d ees f g} \tuplet 3/2 8 {a b \liiri c} \liriii d32 ees f g  f g f d ees c g ees)
...
% Bars 96 to 100
	...
	R1
	r16 <g bes ees>8\pp\<^\div q8 q q16 r <aes des ees>8 q q q16\!
...
% Bars 126 to 130
	...
	r \tuplet 3/2 4 {r8 ges,\mp\< ges} g4\!_\crescmarkup r
