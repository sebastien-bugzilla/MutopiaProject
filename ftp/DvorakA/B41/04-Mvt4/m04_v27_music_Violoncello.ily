...
% Bars 36 to 40
	d-. des-.
	c-. r
	\subdiviseBeam \tuplet 3/2 4 {c8(\p a' f-\offset X-offset -1.5 _\legato c' a f
	c bes' g c bes g)
	c,( a' f c' a f
% Bars 41 to 45
	e bes' g c bes g)
...
% Bars 56 to 60
	ees(\< a f c' a f\!
	d\> bes' f d'-\tweak extra-offset #'(0 . -10.6) ^\pocoapococresc bes f)\!
	ees( a f c' a f
	ees a f c' a f)
	ees( a f c' a f
% Bars 61 to 65
...
% Bars 106 to 110
	...
	\subdiviseBeam \tuplet 3/2 4 {d,,8(->-\offset X-offset -1 \ff e f-\offset X-offset -1.5 _\legato bes,-> c d)
	a->( b cis a b cis)
	bes!->( c! d bes-> c d)
% Bars 111 to 115
	a(-> b cis e cis a)
...
% Bars 121 to 125
	...
	\tuplet 3/2 4 {aes8(-\tweak extra-offset #'(-1 . -8.5) ^\ff bes! c)} r4
	\once \ni R2\fermata
% Bars 126 to 130
...
% Bars 166 to 170
	...
	<< a) {s8 s s s\!}>>
	b2\((\pp
	<< \hairpinShorten #'(0 . -1.5) a)\< {s8 s s s\!}>>
	g2~\>
% Bars 171 to 175
	<< g\) {s8 s s s\!}>>
	b2\((\pp
...
% Bars 191 to 195
	g
	a\fz-\alterBroken shorten-pair #'((-0.5 . 0)(0 . 2)) \>~
	a4 r\!
	R2*4
...
% Bars 196 to 200
	...
	\subdiviseBeam \tuplet 3/2 4 {fis'8\p( d fis a fis d'
	fis, d fis a fis d'
	fis, d fis a fis d'
% Bars 201 to 205
	fis, d fis ais fis d')
...
% Bars 401 to 405
	...
	ais b cis\> ais b cis\!
	ais-\offset X-offset -1 _\dimmarkup b cis ais b cis
% Bars 406 to 410
	ais b cis ais b cis)}
...
% Bars 506 to 510
	...
	fis,-^
% Bars 511 to 515
	f,!->-\tweak extra-offset #'(-2 . 0) _\ffmoltomarcato
	f->
	f4..-> e16
	g2->
	a->
