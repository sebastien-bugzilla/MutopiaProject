...
%###############################################################################
musicContrabassoMvtIV = \relative c {
	\clef bass
	\key d \minor
%	\transposition a
% Bars 1 to 5
...
% Bars 26 to 30
	\startMeasureCount f4-.-\offset X-offset -2 _\ppsempre f-. 
	f-._\staccato f-.
	f-. f-.
	f-. f-.
	f-. f-.
...
% Bars 71 to 75
	...
	g4-. c-.
% Bars 76 to 80
	<< \hairpinShorten #'(-0.5 . -0.5) g2-\offset X-offset -1.5 \fz\> {s8 s s s}>>
	c4\mp^\pizz bes-\offset X-offset 1 _\dimmarkup
	c r
	bes c
	bes r
% Bars 81 to 85
...
% Bars 106 to 110
	R2*2
	\mark \default
	\subdiviseBeam \tuplet 3/2 4 {d8(->-\offset X-offset -0.5 \ff-\offset X-offset 3.5 _\legato e fis bes,-> cis d)
	a->( b cis a b cis)
	bes!->( c! d bes-> c d)
% Bars 111 to 115
	a(-> b cis e cis a)
...
% Bars 136 to 140
	...
	a!4-.\p^\brackM\secco a-.
	a8.-. g16 bes4->--
	a-._\crescmarkup a-.
% Bars 141 to 145
	a8.-.-\tweak extra-offset #'(0 . -8.6) ^\< g16 e4^>--
	a-. a-.\!
	a8.-. g16 bes4->--
	a-. a-._\dimmarkup
	a8.-. g16 \hairpinShorten #'(2 . 0) e4->--\>
% Bars 146 to 150
	a8. g16 e4--
	a8. g16 e4--\!
	a8\pp r r4
...
% Bars 156 to 160
	...
	\key d \major \mmrnDown \tempoXoffset #-2 \mmrLength #18 R2*30
...
% Bars 211 to 215
	...
	g4-.~\> g-.\!
% Bars 216 to 220
	b2-\offset X-offset -1 _\crescmarkup
	b4-.~\< b-.\!
	a2\mf
	d4-.~\< d-.\!
	g,2~
...
% Bars 241 to 245
	d-. r
	\subdiviseBeam \clef tenor \tuplet 3/2 4 {e8-\offset X-offset -1 \ff e' e  e e e}
	e r r4
	R2*2
	\mark \default
% Bars 246 to 250
...
% Bars 346 to 350
	d!2->(\fz
	ees4.) r8
	\trillSpanPadding #-3 e!2(->_\crescmarkup\startTrillSpan
	f4.)\stopTrillSpan r8
	g4-.\f r
% Bars 351 to 355
	aes-. r
...
% Bars 401 to 405
	fis-> r
	g-> g->
	\startMeasureCount fis2:16
	<< fis: { \hairpinShorten #'(0 . -0.5) s8\> s s s\!}>>
	fis2:_\dimmarkup
% Bars 406 to 410
	fis:
	fis:\p\>
	<< fis: {s8 s s s\!}>> \stopMeasureCount
	\tempoXoffset #3 fis2~_\moltodim
	fis~
% Bars 411 to 415
	fis8\pp r r4
	R2
	\startMeasureCount f!4-._\ppsempresecco f-. 
	f-. f-.
	f-. f-.
% Bars 416 to 420
	f-. f-.
...
% Bars 491 to 495
	fis8\f r r4
	R2
	\beamOffset #'(0.5 . 0.5) g'8[->-.\f fis-.-> e-.-> d]-.->
	cis[-.-> b-.-> ais-.-> fis']-.->
	b,4\brack\ff r
% Bars 496 to 500
...
% Bars 536 to 540
	...
	e' e,
% Bars 541 to 545
	\startMeasureCount a,2:16_\pocoapococresc^\arco
	a:
	a:
	a:
	a:
...
% Bars 556 to 560
	...
	a-> a->\! \section
% Bars 561 to 565
	\key d \major \tempoXoffset #-2 \unSubdiviseBeam d2\f
	R
	d
	R
	d
