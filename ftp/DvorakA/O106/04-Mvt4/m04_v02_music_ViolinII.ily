...
% mesure 31 à 35
	...
	<c'! a'>\fz\downbow
% mesure 36 à 40
	<d, b' g'>8\arpeggio-\offset X-offset #1 \ff d''4( c8)
	b-. c16( b) b8-. a-.
	g-. a16( g) g8 g\fz
	fis f\fz e e\fz
	dis d\fz cis c\fz
...
% mesure 121 à 125
		...
		r4 ges\p\<-\offset X-offset #-3.2 ^\arco(
...
% mesure 126 à 130
	...
	ees8) r \hairpinShorten #'(0 . -1) bes'8.\p\<( bes16-.)\!
% mesure 131 à 135
	ces4\fp( bes)\>
	g!(\! ees)~
	ees2
	r4 \hairpinShorten #'(0 . -1) bes'8.\p\<( bes16-.)\!
	ces4\fz\>( bes)\!
% mesure 136 à 140
	g!( ees\p)~
	ees2
...
% mesure 141 à 145
	...
	aes(~ aes8. ces16-.)
	<<{\hairpinShorten #'(0.5 . 0) ces4(\> bes)\!}\\{g!2}>>
% mesure 146 à 150
...
% mesure 186 à 190
	...
	b8-\offset X-offset #-0.5 \p d4\fz( c8)
% mesure 191 à 195
	b8-. c16( b) b8-. a-.
	g-. a16( g) g8-. g-.
	fis4 r8 e\f\upbow
...
% mesure 251 à 255
	...
	dis4 e)
% mesure 256 à 260
	\once \tupletDown \tuplet 3/2 {r8 e^^-\offset X-offset #-1.5 \f d!^^} e8.( fis16-.)
	d4\<( e~\!
	<< e2) {\hairpinShorten #'(-1.3 . -0.5) s8\> s s s\!} >>
...
% mesure 261 à 265
	...
	d4(\< e~\!
	<< e2) {\hairpinShorten #'(-1.3 . -0.5) s8\> s s s\!} >> \mark \default
% mesure 266 à 270
...
% mesure 276 à 280
	a8\mf( \once \tupletDown \tuplet 3/2 8 {a16 c a f[ a f] c[ f c])}
	r8 \tuplet 3/2 8 {a'16[(_\dimmarkup c a] f[ a f] c[ f c])}
	r8 \tupletUp \tupletOffset #3.2 \tuplet 3/2 8 {b'16[(\pp dis b] \tupletDown fis[ b fis] dis[ fis dis])} \tupletNeutral
	r8 \tupletUp \tupletOffset #3.2 \tuplet 3/2 8 {b'16[( dis b] \tupletDown fis[ b fis] dis[ fis dis]} \tupletNeutral
	b8) r r4
% mesure 281 à 285
	\mmrnDown R2*2
...
% mesure 296 à 300
	<e ais>:\!
	<< <e ais>: {\hairpinShorten #'(-0.5 . -0.5) s8\f\> s s s\!} >>
	<< <ais, e'>2:32 {\hairpinShorten #'(-0.5 . -0.5) s8\p\> s s s\!} >> \bar "||" \mark \default
	<b e>8\pp r r4
	\mmrnDown R2*7
% mesure 301 à 305
...
% mesure 311 à 315
	d\>
	d,(\!
	g,8)\! r \hairpinShorten #'(0 . -1) d''8.\p\<( d16-.)\!
	ees4\>( d)\!
	b!( g~
% mesure 316 à 320
	g2)
	r4 \hairpinShorten #'(0 . -1) d'8.\p\<( d16-.)\!
	ees4\fz( d)
	\hairpinShorten #'(0.5 . 0) b!(\> g~
	g2)\!
% mesure 321 à 325
	r4 ees'8.\<( ees16-.)\!
	f4.\fz( ees8)
...
% mesure 341 à 345
	dis2\f
	e8[( dis e8. c16])
	b16( d! ais cis b_\dimmarkup d b d)
	c( ees c d b d a c!
	b g) r8 r4
% mesure 346 à 350
	r g'8.(\p\< g16-.)
...
% mesure 426 à 430
	g4( g~
	g2)
	\shape #'(() ((0 . 0)(0 . 0.6)(0 . 0.6)(0 . 0))) Slur bes-\offset X-offset #-1 \f(~
	bes4. a8
	g2~\>
% mesure 431 à 435
	g)\!
	...
	g\!
% mesure 436 à 440
	bes-\offset X-offset #-0.5 \pp(~
	bes4. a8
	g2~
	g)
	\beamOffset #'(0 . -0.5) b!8\p([ d b' g]
% mesure 441 à 445
	d[ b b' g])
	a,[( c a' fis]
	c[ a a' fis])
...
% mesure 471 à 475
	...
	cis8-\tweak extra-offset #'(0 . -8.9) ^\p([ e cis' a]
	e[ cis cis' a])
	b,[( d b' gis]
	d[ b b' gis])
% mesure 476 à 480
...
% mesure 491 à 495
	...
	d':->[ c: a: fis:]
% mesure 496 à 500
	\tuplet 3/2 4 {e'8 d c b a d} \mark \default
...
% mesure 521 à 525
	...
	b16-\tweak extra-offset #'(0 . 0.3) \ff b d d e e c'( b)
% mesure 526 à 530
	b, b d d e e c'( b)
	b, b d d e e c'( b)
	b, b d d e e c'( b)
