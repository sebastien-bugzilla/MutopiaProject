...
% mesure 21 à 25
	fis2~\fz\>
	fis8\! r r8. gis16(\f
	a4) r8. fis16(-\offset X-offset #-0.5 _\dimmarkup
	g!4\p) r8. eis16(
...
% mesure 36 à 40
	...
	gis8.(-^ dis32 b gis8)\noBeam e'!-.
	\beamOffset #'(1 . 0.7) fis8.(-^ cis32 a! fis8)\noBeam e'!-.
% mesure 41 à 45
	\beamOffset #'(0 . 0.5) fis8.(-^ cis32 a fis8)\noBeam d'!-.
	d-.[ r16 e-.] cis8-.[ r16 b]-.
	b8-.[ r16 a-.] a!8-. <e a>-.
	b'8(-> g16) r g8(-> b16) r
	g8(-> b16) r r8 d,-.
% mesure 46 à 50
	...
	d8-\offset X-offset #-1 \ff <g, d' b'> \arpeggio r <g d' b'>
	r <g d' b'> r \shape #'((0 . 0)(0 . -0.5)(0 . -1)(-0.5 . -1.7)) Slur \tuplet 3/2 8 {g'16[( b g]
	d[ g d] \stemDown b[ d b]} \stemNeutral g8)\noBeam \shape #'((0 . 0)(0 . -0.5)(0 . -1)(0 . -2)) Slur \tuplet 3/2 8 {g'16( b g
% mesure 51 à 55
...
% mesure 96 à 100
	f4\f( ees)
	d( c)
	f16( d' f,8-\offset X-offset #1 _\dimmarkup ees4)
	d16( bes' d,8 c4)
	bes'(\mp aes
% mesure 101 à 105
	g fis!)
	...
	g16( ees' g,8 fis!4)
	\hairpinShorten #'(0 . -15) \beamOffset #'(-0.5 . -0.5) g16(\> ees' g,8 fis!4)~
	fis2\!
% mesure 106 à 110
...
% mesure 116 à 120
	...
	\tupletUp cis8->-\tweak rotation #'(3 -1 0) \<( d ees16 e) f8( fis g16 gis)\!} \tupletDown
	\tuplet 6/4 4 {a-\tweak extra-offset #'(0 . 0.5) \ff( bes) bes( a bes d) bes( a bes d) bes( a
...
% mesure 136 à 140
	g!2(\!
	ges4..\mf)( f16
	e!4.. \hairpinShorten #'(0 . -19) ees16)(\>
	d2)(\!
	fis!8.)(_\dimmarkup g16 g4)
% mesure 141 à 145
	\tupletUp \tuplet 6/4 4 {d16-\offset X-offset #-0.5 \p( f d f d f d f d f d f) \tupletNeutral
...
% mesure 146 à 150
	...
	g( c g c g c g c g c g c)
	\repeat tremolo 3 {ees,(_\crescmarkup g)} ees(\< g c ees g bes)\!}
	bes8->\f bes,16 bes bes'8->\< bes,16 bes
	bes'8-> bes,16 bes c'8-> c,16 c\!
% mesure 151 à 155
	bes'16-\offset X-offset #-1 \ff bes,( c) c'( d) d,( e!) e'-.
	f8 r <bes,, fis'!> r
	<ees, bes' g'>-^ r r4
	<c' ees>8 r r4
...
% mesure 181 à 185
	...
	<e cis'>8-\offset X-offset #-0.5 \mf r <cis e> r
...
% mesure 186 à 190
	...
	r8 \tuplet 3/2 8 {cis'16[-\offset X-offset #-1.5 _\ffzdetache eis cis] eis,[ cis' eis,] cis[ eis cis]}
% mesure 191 à 195
	<d! f>2\fz->
...
% mesure 196 à 200
	<cis e>8-^ <b d>-^ r4
	dis,8-\offset X-offset #-0.5 \ff( eis16) r eis8( fis16) r
...
% mesure 216 à 220
	...
	r4 bes8( ees)
% mesure 221 à 225
	\tuplet 3/2 4 {ees(-\offset X-offset #-0.5 \ppp aes ees  aes ees bes'
	ees, c' bes c ees,! des')
	c( aes g aes c bes
	aes c bes} aes16 des c aes)
	\beamOffset #'(0.5 . 0.5) \tuplet 3/2 4 {ees8( c ees aes c, ees
% mesure 226 à 230
...
% mesure 236 à 240
	...
	\beamOffset #'(0.5 . 0.5) fis'->-\offset X-offset #-0.5 \fz d e cis e cis d b
	\beamOffset #'(0.8 . 0.5) e-\tweak extra-offset #'(0.8 . 0.1) \fz d d cis b'->\fz a a g!
	g->\fz fis fis e b'->\fz a a g
% mesure 241 à 245
	e,4.\ff \tuplet 3/2 8 {e16 e e
	fis8.:16[ g: a: b:]
	\tupletUp cis:[ d: dis: e:] \tupletNeutral
	fis:[ g!: gis: ais:]}
	ais,8\fz(-> cis16) r g'!8->\fz( e16) r
% mesure 246 à 250
	ais,8\fz(-> cis16) r g'!8->\fz( e16) r
	b8\fz(-> d16) r a'!8-\offset X-offset #-0.5 \fz(-> fis16) r
...
% mesure 256 à 260
	...
	b16( d, a' d, g_\dimmarkup d fis d)
	b'( d, a' d, g d fis d)
	<d fis>2\p\>~
	<d fis>\!
% mesure 261 à 265
	<d, c'>-\offset X-offset #-2 \pp~
	<d c'> \mark \default 
	<g d'>8-\offset X-offset #-2 \pp-.( <b d>-.) q-.( q-.)
	q-.( q-.) q-.( q-.)
	q-.( q-.) q-.( q-.)
% mesure 266 à 270
	q-.( <c d>-.) <b d>-.( <c d>-.)
...
% mesure 281 à 285
	...
	c)]\! f,[(\< ees)]\! f([
	ees]) r r4
	ces'4.-\offset X-offset #0.5 \fz bes8[\<(
% mesure 286 à 290
	aes])\! ges[\<( f)]\! r
...
% mesure 296 à 300
	...
	e!4_\dimD\> f
	des'4~( \once \tupletUp \tuplet 3/2 {des8 c! bes\!)}
	e,!4(\> f
...
% mesure 301 à 305
	...
	c~
	c)\!
	\tuplet 3/2 4 {r8 b-.(_\pespressivo a-. b4 \once \stemUp c8)
% mesure 306 à 310
	\tupletUp r8 d(-.\< cis-. d4 e8)\!
	r8 c!(\> b) c4( d8) \tupletNeutral
	b8( c b} a4)\!
...
% mesure 316 à 320
	...
	d-. d-. g( d) d-. d-. g( d) 
	d-. d-. g( d) b'( g) d'-. b-.
	\tuplet 5/4 4 {g-. c-. e-.-\offset X-offset #1 _\crescmarkup g-. c-. b( g f d b)
	g( c e g c) b( g f! d b)}
% mesure 321 à 325
	<c e>8\fz r \tupletUp \tuplet 3/2 4 {r b'-.-\offset X-offset #-0.5 _\piufmarcato a-.
	r g-. fis-. r e-. d-. \tupletNeutral
	c c,-. c-. c4\noBeam-> d16( dis)
...
% mesure 326 à 330
	...
	\once \tupletUp r8 g16-\offset X-offset #-0.5 \ff g b, b dis dis g,! g b b}
	<dis, g>2\fz\downbow
% mesure 331 à 335
	<dis gis>\fz\downbow
	<dis b'>-\tweak extra-offset #'(1.3 . 1) \fz\downbow-\tweak extra-offset #'(1.3 . 1) \>
	<dis a'>\downbow-\tweak extra-offset #'(1.3 . 1) _\dimD \mark \default
	fis(\mf
	<< <fis d'>2)~ {s4\< s8 s\!}>>
% mesure 336 à 340
	q8 r a'16\f( b) b( a)
	r4_\dimmarkup b16(\< c)\! c\>( b)\!
	r4 cis,16(-\offset X-offset #-1.5 \p\< d\!) d(\> cis)\!
...
% mesure 351 à 355
	...
	\tupletUp \stemDown a,(_\moltocresc e'\! a, e' a, e' a, e' a, e') \stemNeutral \tupletNeutral
	g,!(\< e' g, e' g,) \once \tupletUp c( g' c, g' c,\!)}
% mesure 356 à 360
	g'16-._\mfcresc d-. b-. r d-. b-. g-. r
	<b d>8 r r4
	b8->\f g16 g b8-> g16 g16
	c8-> g16 g16 a'8-> fis16 fis
	\beamOffset #'(0 . 0.3) g[ g,](_\crescmarkup \beamOffset #'(0.3 . 0) a[) a']( b)[ b,]( cis[) cis'](
% mesure 361 à 365
	d8)\ff r <g,, g'! dis'> r
	<c, g' g' e'> \arpeggio  r r4
	<c' fis a>8 r r4 \mark  \default
	<g g'>8 b'16 b \beamOffset #'(0.5 . 0) <g, g'>8 b'16 b
	<g, g'>8 r r4
% mesure 366 à 370
	e'8 g16 g e8 g16 g
	e8 r r4
	\once \tupletUp \tuplet 3/2 {d'16(\ff b fis } d8) r4
...
% mesure 371 à 375
	...
	e8) r <b' gis'> r
	cis,16-\tweak extra-offset #'(0.5 . 0.7) \f cis( gis') gis( cis,8) r
	a'16\ff a( b) b( dis) dis( e) e(
% mesure 376 à 380
	a,) a( e') e( a,) a( b) b(
	e!) e( d!) d( e) e( g) g~
	g8 r a r
	<g, g'>8-\offset X-offset #-1.5 \ff b'16 b <g, g'>8 b'16 b 
...
% mesure 386 à 390
	b8.-> b16 b8-. a-.
	a8. b16 \trillSpanPadding #-1 c4~\startTrillSpan
	c2\stopTrillSpan
	b8\noBeam <b, g'>[ q q]
	q-.[ q-. q-.] b'16[-. b]-.
% mesure 391 à 393
