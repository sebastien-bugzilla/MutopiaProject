...
% mesure 61 à 65
	b,4.\fz-- c8-. d4-.
	g,4.\fz-- a8-. b4-.
	\acciaccatura c8\fp( c'2)( g4)
	\acciaccatura c,8\fz( c'2)( g4)
	c2\fz r4
% mesure 66 à 70
	R2.*1
	\acciaccatura b,8_\fpsempredim( b'2)( fis4)
	\acciaccatura b,8\fz( b'2)( fis4)
	b2\fz r4
	R2.*1
% mesure 71 à 75
	a2(\f e4
...
% mesure 156 à 160
	...
	\grace {d16[\fz\> e]} fis2.(
	fis4) r\! b,-.\pp
	<gis b>8-. <gis b>-. r4 <gis b>-.
	<gis b>8-. <gis b>-. r4 <gis b>-.
% mesure 161 à 165
	\set doubleSlurs = ##t <gis b>2.(
	<gis b>4) r gis-. \set doubleSlurs = ##f
	gis r8 b-. dis4-.
	cis-. b-. ais-.
	gis2.(
% mesure 166 à 170
...
% mesure 196 à 200
	cis,4.--\fp d8-. e4-. 
	\acciaccatura e8 \mark \default a2(\fp e4) 
	a2(\fp e4)
	a2 r4
	R2.*1
% mesure 201 à 205
...
% mesure 231 à 235
    \repeat volta 2 {
	    \tempo "Un poco meno mosso." a'4.--\pp^( d8-- fis,4--)
	    a2(-- a4--)
	    a4.--( d8-- fis,4--)
	    a2--( a4--)
	    a2(-- a4--)
% mesure 236 à 240
	    a4.--( d8-- <a fis'>4--)
	    \set doubleSlurs = ##t <a e'>2.->(
	    <a e'>2.) \set doubleSlurs = ##f
	    R2.*2
% mesure 241 à 245
	    a'4--\mf\< b-- cis--
	    d-- e-- fis--
...
% mesure 246 à 250
	    d-+)\!
	    cis4-._\piup cis8( e cis4)
	    b4-. b8(\> d b4)
	    \times 3/4 {a( e' cis a\!\dim}
	    \times 3/4 {g\! e cis a)}
% mesure 251 à 256
	    <<{
		    a8-0\pp[( s a s a s]
...
% mesure 291 à 295
	    g2.->\<
	    \acciaccatura fis,8( d'4.)( e8-. fis4-.)\!
	    \acciaccatura d,8(\fz <b' g'>2.)_\crescmarkup
	    g8(\< b) d-. g-. b-. d-.
	    g2.\fz(-^
% mesure 296 à 300
	    g)
...
% mesure 321 à 325
	...
	g->( e cis b g e)
	b'( g e cis g') r
	r4 e8 cis\pocoapococrescendostringendo a g
	cis a g e cis' a
% mesure 326 à 330
	g e cis' a g e
	cis' a g e cis' a
...
% mesure 356 à 360
	...
	<b b'>-. r <b b'>-.
	<b b'>8-. <b b'>-. r4 <b b'>-.
	\set doubleSlurs = ##t <b b'>2.(->
	<b b'>4) r b' \set doubleSlurs = ##f
% mesure 361 à 365
	b r8 d-. fis4-.
	e-. d-. cis-.
	d8( e fis2)(
...
% mesure 401 à 405
	b,4.-- c8-. d4-.
	g,4.-- a8-. b4-. 
	\acciaccatura c8 \mark \default c'2\fp g4 
	c2( g4)
	c2-> r4
% mesure 406 à 410
	R2.*1
	b2(\fp fis4)_\sempredim
	b2(\fp fis4)
	b2-> r4
	R2.
% mesure 411 à 415
...
% mesure 426 à 430
	...
	<b b'>-. r <b b'>-.
	\set doubleSlurs = ##t <b b'>2.(
	<b b'>4)\! r b'\ff \set doubleSlurs = ##f
% mesure 431 à 435
	b r8 d-. fis4-.
	e-. d-. cis-.
	b r fis'
