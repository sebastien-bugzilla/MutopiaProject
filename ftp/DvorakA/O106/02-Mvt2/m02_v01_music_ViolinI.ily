...
% mesure 6 à 10
	...
	bes'4--(-\offset X-offset #-1.5 \p^\cantabileemoltoespressivo bes16.-- bes32--)
	ees4.-\tweak extra-offset #'(-12 . 5.2) _\sulG
% mesure 11 à 15
	ees8( g f16 c)
	bes4( g16 aes)
	bes4 bes16.--( bes32--)
	\hairpinShorten #'(1.5 . 0) <g ees'>4\< bes16.( ees32)
	f8(^\sulD f c'16 bes)\!
% mesure 16 à 20
	bes8^\(( g16) r \hairpinShorten #'(-0.3 . -1) bes\p\<( ees)\)\!
	d16.-\offset X-offset #-1 \fz\>([ bes32)]\! bes8 \hairpinShorten #'(-0.3 . -1) bes16(\p\< ees\!
	d16.)(-\offset X-offset #-1.5 \fz\>[ bes32)\! bes8]_\crescD bes16(\< ees\!)
...
% mesure 21 à 25
	...
	bes4-\offset X-offset #1.3 \pp\( bes16.( bes32-.)\)
% mesure 26 à 30
	ees4.
	f8(\< aes\> ces,\!)
	bes4.
...
% mesure 31 à 35
	...
	\hairpinShorten #'(-0.5 . 0) bes8-\offset X-offset #-0.8 \p\<( ces8.\> d,!16)\!
	d4.\p
	\hairpinShorten #'(-0.5 . 0) bes'8-\offset X-offset #-0.8 \p\<( ces8.\> d,!16)\!
% mesure 36 à 40
	d4.\p 
	\hairpinShorten #'(-0.5 . 0) c'8-\offset X-offset #-0.8 \p\<( des8.\> e,16)\!
	e4.\p
	c'8\<( des8.\> e,16)\!
	e4.\mf~
% mesure 41 à 45
...
% mesure 56 à 60
	...
	bes4(_\cantabileedespressivo \beamOffset #'(0.5 . 0.5) bes16.-- bes32--)
	ees4\( d32( ees f ees)\)
	ees8(\< g\> f16 c)\!
% mesure 61 à 65
	\once \stemUp bes4\!\( g16( aes)\)
	bes4( bes16.-- bes32--)
	ees4(_\crescmarkup d32 ees d ees)
	f8\< f c'16.( bes32)\!
	bes8( g) bes16([ ees)]
% mesure 66 à 70
	d16.\mf([ bes32)] bes8 bes16( ees)
	d16.([\< bes32)] bes8 b16( e)\!
	dis16.( b32)_\crescmarkup b8\noBeam b16( e)
	dis16.( b32) b8\noBeam c!16( f!)
...
% mesure 71 à 75
	...
	g4-> f16.(\> ees32)
	ees4\! ces16.\p( bes32)
	\once \stemUp bes4_\dimmarkup aes16-- ges--
% mesure 76 à 80
	fes^>^\< ees^> des^> ces^> bes^> a^>\!
	a8-\offset X-offset #-2.5 \f\>( bes8. bes16)\!
	\hairpinShorten #'(-0.5 . -0.5) bes4.\p~\>
...
% mesure 91 à 95
	...
	fis'32-\tweak extra-offset #'(0.8 . -9.3) ^\pp([ cis' fis, cis'] fis16 gis a fis)
	fis( gis a fis gis a)
% mesure 96 à 100
	b8.(_\crescmarkup e)
	e( a16 fis e)
...
% mesure 126 à 130
	...
	gis,8( dis') fis--
	fis16( dis) dis4
	gis,16-\tweak extra-offset #'(-0.5 . -9.8) ^\ff([ dis']) fis[( dis]) gis,[( dis'])
% mesure 131 à 135
	fis[( dis]) gis,-.[  dis']-. dis[ c!32-. c-.]
	r16 a32-. a-. r fis\downbow\ff r dis\downbow r c\downbow r a\downbow
	a4.^^\ffz~
	a16 r r8 r16 b64(\< c) c( c')\!
	\slashedGrace e,,8 <c' g'>4^\downbow_\fffgrandioso <c g'>16.^\downbow <c g'>32^\upbow
% mesure 136 à 140
	\slashedGrace g8 <e' c'>4.\downbow
	c'8-^\downbow[ e-^\downbow] \tuplet 3/2 {d16-^ c-^ a-^}
	<e, c' g'>4\arpeggio\downbow <e c' g'>8\downbow
	<g e' c'>8\downbow[\arpeggio <g e' c'>\downbow]\arpeggio \beamOffset #'(0.5 . 0) <g, d' f' d'>16\downbow(-\tweak rotation #'(12 -1 0) \<\arpeggio a'''32 g)\!
...
% mesure 151 à 155
	bes4.\ppp~
	bes
	bes4^\consentimentoemoltocantabile(_\sulG bes16. bes32
	ees4.)
	ees8( g f16 c
% mesure 156 à 160
	bes4)\> g16( aes
...
% mesure 161 à 165
	...
	d16.\fz->([ bes32 bes8)] bes16(\< ees)
	g4 bes8(~-\offset X-offset #-1.5 _\fzdimD\fermata \whiteoutRehearsalMark \mark \default
	bes[-\offset X-offset #1 \pp ees,]) bes16( ees)
	des16.([ aes32 aes8)] aes16( des)
% mesure 166 à 170
	c16.([ g32 g8]) g16( c)
	ces8.( bes16 aes fes
	ges4) \beamOffset #'(-0.5 . -1.5) \hairpinShorten #'(0.7 . -1) \stemUp ges16(-\tweak extra-offset #'(0 . 0.1) \< ges')\! \stemNeutral
...
% mesure 186 à 190
	ees8\> d-- c---\offset X-offset #-1.5 _\dimD
	...
	bes4 bes16.(-- bes32--)
% mesure 191 à 195
	<< ees4. {\hairpinShorten #'(0 . -1.5) s8\< s s\!} >>
	f8--\< aes8.\f\>^>( ces,16)\!
	<< bes4.~ {s8.\p s_\dimmarkup} >>
	bes4.~
	bes\pp
% mesure 196 à 200
	bes8( g16 aes bes g)
