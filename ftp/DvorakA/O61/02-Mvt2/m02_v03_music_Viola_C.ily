...
musicViolaMvtII = \relative c {
	...
	\clef alto
% mesures 1 à 5
	\tuplet 3/2 {r8 c(\pp f} a4~ \tuplet 3/2 {a8 d, f} d'4)~
	\tuplet 3/2 {d8(\< c f,} a4)\! \tuplet 3/2 {\hairpinShorten #'(0 . -11) r8\> d,( g} bes4)\!
	\tuplet 3/2 {r8 c,( a'_\dimmarkup} c4)~ \tuplet 3/2 {c8 a( f} g e)
	\tuplet 3/2 {r8 c\pp( f} a4~\< \tuplet 3/2 {a8 g c,} c'4)~\!
	\tuplet 3/2 {c8( a d,} d'4)~ \tuplet 3/2 {\hairpinShorten #'(-4 . -5) d8(\> g, d} bes'4\!)
% mesures 6 à 10
	\tuplet 3/2 {r8 d,(\pp bes'~} \once \stemUp <bes d>4~ \tuplet 3/2 {q8 d, bes'~} \once \stemUp <bes d>4)
	\tuplet 3/2 {r8 d,(\< bes'~} \once \stemUp <bes d>4~\! \tuplet 3/2 {q8\> d, bes'~} \once \stemUp <bes d>4\!)
	\tuplet 3/2 {r8 d,\pp( bes'~} \once \stemUp <bes d>4~ \tuplet 3/2 {q8 d, bes'~} \once \stemUp <bes d>4)
	\tuplet 3/2 {r8 d,\< bes'~} \once \stemUp <bes d>4~\! \tuplet 3/2 {q8 d,(\> bes'} \stemUp d bes\!) \stemNeutral
	\tuplet 3/2 {\stemDown c(\pp g ees'~} \stemNeutral <ees g>4)~ \tuplet 3/2 {q8 g,( ees'~} <ees g>4)~
% mesures 11 à 15
	\tuplet 3/2 {<ees g>8 g,( ees'_\crescmarkup~} <ees g>4)~ \tuplet 3/2 {q8 g,( ees'~\>} <ees g>4)~
	\tuplet 3/2 {q8-\offset X-offset -0.5 \pp g,( ees'~} <ees g>4)~ \tuplet 3/2 {q8 g,( ees'~} <ees g>4)~
	\once \tupletUp \tuplet 3/2 {q8\< g,( ees'~} <ees a>4~) \tuplet 3/2 {q8\! c,( ees~} <ees a>4) \mark \default
	<d bes'>8-.-\tweak extra-offset #'(0.8 . 1) \f r r4 r16 \clef treble bes''32(\p d f16-.) r \clef alto r8. f,,16->\f
...
% mesures 26 à 30
	\once \tupletDown \tuplet 3/2 {f8( des'! c} bes16 des aes des) \tuplet 3/2 {ges,8\<( aes beses\!} aes16\> des ges, des')\!
	\tuplet 3/2 4 {f,8(\< aes des ees, aes c) d,( aes' ces\! ees, g des')}
	\tuplet 3/2 {f,\pp( aes c} des16 f c f) \tuplet 3/2 {bes,8( c des} c16 f bes, f')
	\tuplet 3/2 {aes,8( c aes} ees16 c' aes ees')~ \tuplet 3/2 4 {ees8 aes,( des~ des c ees)~
	ees aes,(_\crescmarkup des~ des c ees~ ees) aes,( des~ des c ees)}
% mesures 31 à 35
	des8.( c16_\dimmarkup des8. c16) des8.( c16 des8. c16) \mark \default
	des4 r r \tuplet 3/2 {r8 des,^\pizz des}
	des-\tweak extra-offset #'(0 . 0.7) \< f ees c' d, ces' d,\! ees'
	f, f' r4\> f,8 f' r4\!
	f,8 r \tuplet 3/2 {c'(-\offset X-offset -4 ^\arco\pp c' bes)} a4 a16( c g c)
% mesures 36 à 40
	\shape #'((0 . -0.5)(0 . -0.5)(0 . -0.5)(0 . 0)) Slur a8( aes_\crescmarkup~ aes16 c g bes) a4( g16 c g bes)
	\shape #'((0 . 0)(0 . -0.5)(0 . -0.5)(0 . 0)) Slur aes!4( \tuplet 3/2 {aes,8 aes' ges!)} f4( fes8 ees)
...
% mesures 41 à 45
	...
	des(_\pdim bes4 c8) \shape #'((0 . 0.3)(0 . -1.2)(0 . -1.2)(0 . 0.3)) PhrasingSlur des\((-- c)-- des(-- c--)\)
...
% mesures 56 à 60
	...
	d,4(-\offset X-offset 1.3 \pp b8 a gis b d eis)
	gis2( c
	bes gis!~
	gis d')
% mesures 61 à 65
	...
	g4\! r8 <<{e4.~ e4} \\ {e4.-\offset X-offset -1.5 _\dimmarkup( c8 bes)}>> \bar "||" \key f \major
	r4 a(\p\> \once \stemUp c bes)\! \mark \default
% mesures 66 à 70
	\tuplet 6/4 4 {a16(-\offset X-offset -2.5 \pp c a c a f' a, c a c a f' g, bes g bes g g' \once \tupletDown g, bes g bes g bes)
	...
	\stemUp a(\< c a c a a' \stemNeutral a, c a c a c\! \stemUp g\> d' g, d' g, g' \stemNeutral g, d' g, d' g, d')\! 
% mesures 71 à 75
	d(\pp f c e bes d bes d bes d bes d bes d bes d bes d bes d bes d bes d) 
	bes(\< d bes d bes d bes d bes d bes d bes d bes d\! bes\> d bes d bes d bes d)\!
	\tupletUp d(\pp f c e bes d bes d bes d bes d bes d bes d bes d bes d bes d bes d) \tupletNeutral
	bes(\< d bes d bes d bes d bes d bes d bes d bes\! d\> bes d bes d bes d bes d)\!
...
% mesures 76 à 80
	...
	\shape #'((0 . -3)(0 . -1)(0 . 0)(0 . 0)) Slur a,( c ees a, c_\crescmarkup ees a, c ees a c a ees' c ees, a a, c \tupletOffset #-3 f, a f' a, f a)} \mark \default
	...
	f4 r r8 <f f'>8(---\offset X-offset -4 _\dimmarkup q-- q--)
% mesures 81 à 85
	q4--\p r r8 q8(---\offset X-offset -4 _\dimmarkup q-- q--)
...
% mesures 91 à 95
	...
	aes8(\f\< bes c d!)~\! << d2 {s8\> s s s\!}>>
% mesures 96 à 99
	\once \stemUp c2(\p\>~ c8 a! g8. f16)\!
	c1\pp
	c2-- c--
	c1\fermata \bar "|."
}
