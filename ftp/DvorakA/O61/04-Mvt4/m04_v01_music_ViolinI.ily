...
% mesures 41 à 45
	...
	\beamOffset #'(0.5 . 0.5) bes\((\pp e, bes bes')-. bes( e, bes bes')\)-.
	b!\(( e, b! b')-. b( e, b b')\)-.
	bes\(( e, bes bes')-. bes( e, bes bes')\)-.
% mesures 46 à 50
	b!\(( e, b! b')-. b( e, b b')\)-.
	\beamOffset #'(0.5 . 0.5) b\(( f!_\crescmarkup b, b')-. b( f b, b')-.\)
	b\(( f b, b')-. b( f b, b')-.\)
	\dynEO #'(0 . 2) b2\f\trill
	R2
% mesures 51 à 55
	\dynEO #'(0 . 2) cis16(\f e) d8-. d16( f) e8-.
	e16( g) f8-. e16( g) f8-.
	f16( a) g8-. f16( a) g8-. 
	f16( a) g8-. f16( a) g8-. 
...
% mesures 121 à 125
	...
	d\< a'\! d\> d,\!
	r4 <g,, d' b'>\arpeggio
	r-\tweak height #0.50 \< <g ees' bes'>\!\arpeggio
	r <g ees' a>\>\arpeggio
% mesures 126 à 130
	r\! <g d' b'!>\arpeggio
	r <a g' a>\pp\arpeggio
...
% mesures 136 à 140
	...
	b8 a16( g) fis8-. e-.
% mesures 141 à 145
	d r \markEO #'(0 . 1) d'4~_\fzmarkup 
	d8 c16( b) a8-. g-.
	fis r \markEO #'(0 . 1.) d'4_\fzmarkup~
	d8 c16( b) a8-. g-.\!
	fis\ff r ees'4~\fz
% mesures 146 à 150
	ees8 d16( c) b8-. a-.
	g\fz fis-. c'\fz a-.
	fis\fz ees-. c-\tweak extra-offset #'(-0.8 . 0.4) \fz a-.
	gis\fz f!-. d'\fz b-.
	gis\fz f-. d\fz b-.
% mesures 151 à 155
...
% mesures 181 à 185
	c\(( e, c c')-. c( e, c c')-.\)
	c\(( e, c c')-. c( e, c c')-.\)
	\beamOffset #'(0.5 . 0.5) b\((\pp e, b b')-. b( e, b b')\)-.
	bes\(( e, bes bes')-. bes( e, bes bes')\)-.
	bes\(( e, bes bes')-. bes( e, bes bes')\)-.
% mesures 186 à 190
	b!\(( e, b! b')-. b( e, b b')\)-.
...
% mesures 191 à 195
	b2\mf\trill
	R2
	cis16(-\offset X-offset -1 \mf\< e) d8-. d16( f) e8-.
	e16( g) f8-. e16( g) f8-.\!
	f16\f(\< a) g8-. f16( a) g8-. 
% mesures 196 à 200
	f16( a) g8-. f16( a) g8-.\!
...
% mesures 201 à 205
	...
	\dynEO #'(-2.2 . -7) g(^\f e') e( g,) a( fis') fis( a,)
	b( g') g( b,) g'( f!) e( d)
	d( c) c( d) d( e) e( d)
% mesures 206 à 210
	d( c) c( b) c(\< e g c)\!
...
% mesures 216 à 220
	...
	c-.-\tweak extra-offset #'(0 . 0.3) \pp d-. ees-. d-.
	c-. d-. ees-. d-.
	c-. r r4
	R2
% mesures 221 à 225
	...
	d2~
	d4 cis8-. d-.
	\shape #'((0 . 0)(0 . -0.3)(0 . -0.3)(0 . 0)) Tie e2~
% mesures 226 à 230
	e
	d16( f d f d f d f 
	d f d f d f d f)
...
% mesures 306 à 310
	...
	c'4( a'~)
	<< a2~ {s8\< s s s\! } >>
	a8 \ottava #1 d([_\crescmarkup f g)] 
% mesures 311 à 315
	a2(~\<
	a8 gis b a)\!
	\dynEO #'(0 . 1) bes16\f( a c bes) f( e g f) \ottava #0
	bes,( a c bes) f'( e) e( d)
	a'( gis b! a) e( dis f! e)
% mesures 316 à 320
	a,( gis b a) e'( d!) d( c)
...
% mesures 341 à 345
	g,,8-\offset X-offset -2.5 \pp^\pizz[ d' g] r
	g d' g g,
	r4 <g, e' c'>\arpeggio
...
% mesures 356 à 360
	...
	g r \markEO #'(0 . 1.5) e'4_\fzmarkup(~
	e8 d16 c) b8-. a-.
% mesures 361 à 365
...
% mesures 376 à 380
	...
	\beamOffset #'(0.5 . 0.5) g[(_\pocoapococresc g' f gis,]
	a) r r a
% mesures 381 à 385
	a( g' f a,
	bes) r r bes\((
	b!) g' f\) b,(
	c g' f) cis\fz(
	\beamOffset #'(0.5 . 0.9) d16)-\offset X-offset -1 _\fsemprecresc g( f) cis( d) c'!( b) e,(
% mesures 386 à 390
	f) d'( c) fis,( g) f'!( e) gis,(
	a) g'!( f) ais,( b) g'( f) cis(
...
% mesures 426 à 430
	...
	c'2(_\pespress~
	\hairpinShorten #'(2 . 0) c4\< d
	e g)~\!
% mesures 431 à 435
	\shape #'((0 . 0)( 0 . 0.5)(0 . 0.5)(0 . 0)) Slur g( fis~
	fis\> f~
	f e~\!
	e\p ees~
	ees d~
