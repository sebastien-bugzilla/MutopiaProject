...
% Bars 26 to 30
		\beamOffset #'(0.3 . 0.3) c16[ d32 ees] \beamOffset #'(0.3 . 0.3) d16[ c32 bes] \beamOffset #'(0.3 . 0.3) c16[ bes32 a]
...
% Bars 31 to 33
	...
	\alternative {
		...
		{
			g16[( e) f8]-\offset X-offset -10 _\menuetdacapo \markFermata \bar "|."
		}
	}
}
